...
CASES = [
    ...
    {'file': 'UnProse.docx', 'title': '', 'content': 'a report from the UN Secretary on road funding'},
    {'file': 'UnDataset.docx', 'title': '', 'content': 'behavior of events in the UN dataset'},
    {'file': 'UnBare.pptx', 'title': '', 'content': 'UN and APR events on branched routes'},
