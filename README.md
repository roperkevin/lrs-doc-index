...
| testplangen/CHANGES.md | Test-plan generation release notes | v2.31 |
...
| local/harness/check_testplangen.py | Generation-job gate (mock Graph + mock Predict + mock Anthropic; guard/lanes/caps/fail-closed/verifier/lookup/notify/grounding/auto/issue-trace/gap-report/pinned-lane legs incl. draftlint↔Python agreement + web-reference + case-lane + preview/help/trimmer-head + remote-files legs; 168 checks; CI) | — |
