...
| prompts/TestPlanFigures_Prompt.md | Test-plan FIGURES prompt (`testplangen.mjs --figures`, v2.32): a second pass over a verified draft that picks the cases worth a schematic by rule (R1–R5, X1–X6, cap 6) and emits grounded closed-vocabulary figure specs; `local/lib/figurespec.mjs` grounds and renders them in the SlideFigures palette — anthropic lane verbatim, no tenant paste yet | v0.1 |
