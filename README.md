...
| local/harness/check_caseindex.py | Case-parser gate (both case shapes via the presentation layer's own emission, issue refs incl. the digit floor + fenced-code trap, v1.1 metadata legs, replace-set planner; 53 checks; CI) | v1.1 |
