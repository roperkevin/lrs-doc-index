...
| testplangen/TestPlanGen_Setup.md | Generation flow build + deploy guide | current (component v2.5) |
...
| testplangen/agent/TestPlanGenAgent/ | Importable Copilot Studio agent (front-end) | v1.6 |
| testplangen/agent/Agent_Setup.md | Agent import + flow-wiring guide | v1.0 |
| testplangen/CHANGES.md | Test-plan generation release notes | v2.5 |
