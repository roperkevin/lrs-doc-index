...
| Issue Refs | `4d0e6561-80e3-49f4-aa20-e5889cc88414` (owner-verified on the tenant 2026-09-04 — never referenced by any flow; its feeder is the local job `pipeline/gantt.mjs`) |
