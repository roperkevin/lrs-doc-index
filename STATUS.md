...
| Suite | Last green |
|---|---|
| check_local_sweep.py incl. TC-1 case headings (146/146) + check_pad_runner.py (27/27) + standing suites (check_format, check_related, check_regex, check_figures) + render_sample.py | 2026-09-03 (sweep v1.25) |
