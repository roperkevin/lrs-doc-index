...
| check_testplangen.py (local/harness — testplangen.mjs v1.1: guard, lanes + G6 fallback, remaining-budget caps, fail-closed marker slice, verifier incl. draftlint↔check_draft_coverage agreement + grounding legs, lookup front door, notify; 82/82; CI fixture-free job) | 2026-09-04 (v2.17) |
