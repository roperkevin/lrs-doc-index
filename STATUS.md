...
Last updated: **2026-09-04v** — see "Current state" below.
...
| check_testplangen.py (local/harness — testplangen.mjs v1.2: guard, lanes + G6 fallback, remaining-budget caps, fail-closed marker slice, verifier incl. draftlint↔check_draft_coverage agreement + grounding legs, lookup front door, notify, auto mode + provider override; 93/93; CI fixture-free job) | 2026-09-04 (v2.18) |
