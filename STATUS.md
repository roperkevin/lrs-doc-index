...
| SlideFigures | **v1.5** (2026-09-03 — DF-1 slide diagrams as SVG; DF-2 multi-figure/graph lane; DF-3 routing, grid snap, legends, rotation, raster tracing; DF-4 one SVG per redraw diagram + table anchors; DF-5 label-collision fixes, degenerate splits, title boxes dropped; DF-6 arrowheads snapped to line tips; `check_figures.py` PASSED) | **N/A on the cloud flow** — a local-sweep-only step; a rollback simply keeps ZipTextExtract's `[figure: ...]` caption |
...
| Suite | Last green |
|---|---|
| check_local_sweep.py incl. TC-2 short-title/subheader headings (150/150) + check_pad_runner.py (27/27) + standing suites (check_format, check_related, check_regex, check_figures) + render_sample.py | 2026-09-03 (sweep v1.27) |
| check_figures.py (SlideFigures v1.5 / DF-6 — arrowheads snapped to line tips, drawn above the extents, solid heads; plus the DF-5 label-collision, degenerate-split and title-box contract) | 2026-09-03 |
