...
| check_testplangen.py (local/harness — testplangen.mjs v1.6: guard, lanes + G6 fallback, remaining-budget caps, fail-closed marker slice, verifier incl. draftlint↔check_draft_coverage agreement + grounding legs, lookup front door, notify, auto mode + provider override, issue trace, gap report, pinned lanes, figures incl. the link-absolutizing leg; 126/126; CI fixture-free job) | 2026-09-04 (v2.26) |
...
| check_draft2pptx.py (local/harness — draft2pptx.mjs v1.0: python-pptx read-back of a converted draft — slide walk, banner suppression, glance counts incl. the colon-flag rule, case-slide contract, amber VERIFY runs, native Coverage Map / Issue Trace tables, provenance, CLI contract; 28/28; CI full-format job) | 2026-09-04 (v2.23) |
