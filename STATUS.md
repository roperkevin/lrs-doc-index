...
Last updated: **2026-08-14 (TestPlanGen prompt v1.6 authored — granular one-behavior cases; 2026-08-13: live-export reconciliation: v2.6+v2.7 windows APPLIED on tenant with defects — §v2_7-fixes; flow v2.8 authored — hidden metadata + code fencing + products; r6 gate PASSED)**.
