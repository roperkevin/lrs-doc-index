...
| SlideFigures | **v1.4** (2026-09-03 — DF-1 slide diagrams as SVG; DF-2 multi-figure/graph lane; DF-3 routing, grid snap, legends, rotation, raster tracing; DF-4 one SVG per redraw diagram + table anchors; DF-5 label-collision fixes, clear arrowheads, degenerate splits, title boxes dropped; `check_figures.py` PASSED) | **N/A on the cloud flow** — a local-sweep-only step; a rollback simply keeps ZipTextExtract's `[figure: ...]` caption |
...
| check_figures.py (SlideFigures v1.4 / DF-5 — label collisions, arrowheads, degenerate splits, title boxes; 13 fixture figures; 9 of the 12 new assertions fire against v1.3) | 2026-09-03 |
