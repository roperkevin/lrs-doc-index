...
Last updated: **2026-09-03t** — see "Current state" below.
...
| check_figures.py (SlideFigures v2.2 / DF-13 — JPEG/GIF/BMP + full-PNG decode, 22 figures; plus the DF-5..DF-12 contract: label collisions, degenerate splits, title boxes, arrowheads, spanning-event chains, wireframes, OCR text, artifact suppression) | 2026-09-03 (DF-13) |
