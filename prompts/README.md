...
| TestPlanGen_Prompt.md | v1.3 (**paste pending** — a contract change: create the fifth input parameter `ReferenceText`, then paste; supersedes the pending v1.2 paste; see `testplangen/CHANGES.md` v2.0) | AI Builder custom prompt (TestPlanGen) |
