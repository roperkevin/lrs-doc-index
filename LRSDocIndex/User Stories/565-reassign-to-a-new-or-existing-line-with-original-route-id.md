...
| Field | Value |
| --- | --- |
| **Doc** | 594 · User Story · Server |
| **Product** | Pipeline Referencing |
| **Release** | — |
| **Issues** | [WebGIS/location-referencing#565](https://devtopia.esri.com/WebGIS/location-referencing/issues/565) |
...
<!-- related:begin -->
- [Reassign to a new or existing line with original Route ID/Name maintained on the target line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/reassign-to-a-new-or-existing-line-with-original-route-id.md>) — similar text 0.84 · 6 title words · 3 filename words · same kind/surface/folder <!-- rel:607 s=11.509 -->
- [Support Reassign: Transfer as New Route(s) to Adjacent Line Method in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-reassign-transfer-as-new-route-s-to-adjacent-line.md>) — similar text 0.50 · 3 title words · 1 filename word · same kind/folder <!-- rel:583 s=6.062 -->
- [Reassign Routes to Another Line with Original Route ID/Name Maintenance - REST Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-routes-to-another-line-with-original-route-id-name.md>) — similar text 0.29 · 6 title words · 2 filename words · same surface <!-- rel:542 s=5.459 -->
...
- [Fix existing Reassign UI automations](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/fix-existing-reassign-ui-automations.md>) — similar text 0.52 · 2 title words · 1 filename word · same kind/folder <!-- rel:582 s=4.811 -->
<!-- related:end -->
...
[figure: R1 · R2 · A · 9 · 9.1 · 7 · R1_reassign · 10 · 0 · 70 · 15 · 44 · 66 · L1 · L2 · R3 · 80 · 90 · 96 · 100 · 200 · 300 · 50 · R2_reassign · …]

![Figure 1 — Reassign to a new line Context: Buckeye Energy](../media/565-reassign-to-a-new-or-existing-line-with-original-route-id/fig-01-slide-02-reassign-to-a-new-line-context-buckeye.svg)
...
### Devs have determined Reassign Method will be added as a new parameter <!-- slide 5 -->
{ "effectiveDate" : <date>,
...
![Figure 2 — Devs have determined Reassign Method will be added as a new parameter](../media/565-reassign-to-a-new-or-existing-line-with-original-route-id/fig-02-slide-05-devs-have-determined-reassign-method.svg)

### New Reassign Methods – decision tree <!-- slide 6 -->
...
![Figure 3 — New Reassign Methods – decision tree](../media/565-reassign-to-a-new-or-existing-line-with-original-route-id/fig-03-slide-06-new-reassign-methods-decision-tree.svg)
...
![Figure 4 — Existing Reassign Methods – decision tree](../media/565-reassign-to-a-new-or-existing-line-with-original-route-id/fig-04-slide-07-existing-reassign-methods-decision-tree.svg)
...
[figure: R1 · R2 · R3 · 7 · 9 · 10 · 0 · 44 · 66 · 70 · 80 · 90 · 96 · 50 · R2_reassign · A · 15 · 9.1 · R1_reassign · New Reassign Methods · L1 · Lnew · L2 · 100 · …]

![Figure 5 — 8](../media/565-reassign-to-a-new-or-existing-line-with-original-route-id/fig-05-slide-08-8.svg)
...
![Figure 6 — Error cases](../media/565-reassign-to-a-new-or-existing-line-with-original-route-id/fig-06-slide-09-error-cases.jpg)
