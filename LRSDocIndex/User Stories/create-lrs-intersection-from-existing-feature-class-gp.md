...
<!-- related:begin -->
- [Create LRS Intersection Geoprocessing Tool User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-lrs-intersection-gp.md>) — similar text 0.57 · 4 title words · 2 filename words · same kind/surface/folder <!-- rel:882 s=6.897 -->
- [Modify LRS Intersection Feature Class Geoprocessing Tool](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/modify-lrs-intersection-feature-class-gp.md>) — similar text 0.60 · 5 title words · same surface/folder <!-- rel:878 s=5.882 -->
- [Generate LRS Data Product GP Tool: Support Database Tables](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/generate-lrs-data-product-gp-support-database-tables.md>) — similar text 0.08 · 1 title word · same kind/surface/folder <!-- rel:238 s=2.946 -->
- [Support rounding output measures in Derive Event Measures tool](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-rounding-output-measures-in-derive-event-measures.md>) — similar text 0.06 · 1 title word · same kind/surface/folder <!-- rel:823 s=2.878 -->
- [Remove LRS Entity To Support Intersections](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/remove-lrs-entity-to-support-intersections.md>) — similar text 0.16 · 1 filename word · same kind/surface/folder <!-- rel:877 s=2.837 -->
<!-- related:end -->
...
## Slide 1 — Create LRS Intersection From Existing Feature Class Geoprocessing Tool
...
![Figure 1 — This tool will register an existing m and z enabled point FC to the network](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-01-slide-02-this-tool-will-register-an-existing-m.png)
...
![Figure 2](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-02-slide-04.png)
...
![Figure 3 — SQL Server, Oracle and FGDB](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-03-slide-05-sql-server-oracle-and-fgdb.jpg)
![Figure 4 — SQL Server, Oracle and FGDB](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-04-slide-05-sql-server-oracle-and-fgdb.png)
![Figure 5 — SQL Server, Oracle and FGDB](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-05-slide-05-sql-server-oracle-and-fgdb.png)
...
![Figure 6 — Get the error codes from the Dev and get them added to the excel](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-06-slide-06-get-the-error-codes-from-the-dev-and-get.jpg)

## Slide 7

style.visibilitystyle.visibilitystyle.visibilitystyle.visibilitystyle.visibilitystyle.visibilitystyle.visibility

![Figure 7 — style.visibilitystyle.visibilitystyle.visibilitystyle.visibilitystyle.visibilitystyle.visibilitystyle.visibility](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-07-slide-07-style-visibilitystyle-visibilitystyle.svg)

## Slide 8

![Figure 8](../media/create-lrs-intersection-from-existing-feature-class-gp/fig-08-slide-08.png)
