...
<!-- related:begin -->
- [Configure Addressing Feature Classes GP Tool Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5572-configure-addressing-feature-classes-gp.md>) — similar text 0.39 · 4 title words · 1 filename word · same surface <!-- rel:424 s=5.477 -->
- [Configure Address Feature Classes (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6267-configure-address-feature-classes-lr.md>) — similar text 0.21 · 3 title words · 3 filename words · same surface <!-- rel:249 s=4.774 -->
- [Configure Addressing Feature Classes (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5645-configure-addressing-feature-classes-lr.md>) — similar text 0.27 · 4 title words · 1 filename word · same surface <!-- rel:427 s=4.366 -->
- [LRS Addressing and Utility Network Properties User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/lrs-addressing-and-un-properties.md>) — similar text 0.28 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:190 s=3.956 -->
- [Update Address Range Information in Overlay Events and Query Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/5537-update-address-range-information-in-overlay-events-and-query.md>) — similar text 0.18 · same kind/surface/folder <!-- rel:344 s=3.188 -->
<!-- related:end -->
...
## Story
### Configure Addressing feature classes <!-- slide 1 -->
User Story
ArcGIS Pro
...
![Figure 1 — Requirements](../media/configure-addressing-feature-classes/fig-01-slide-03-requirements.png)
