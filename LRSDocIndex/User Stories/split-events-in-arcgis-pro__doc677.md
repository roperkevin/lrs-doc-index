...
<!-- metadata
```yaml
title: "Split Events in ArcGIS Pro"
source_file: "SplitEventsPro.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/SplitEventsPro.pptx"
doc_id: 677
doc_kind: "User Story"
surface: "Pro"
doc_revision: ""
...
last_edited: "2022-03-10T00:50:06Z"
...
issues: []
related: [{"doc":472,"file":"split-event-in-experience-builder__doc472.md","s":4.558},{"doc":766,"file":"split-centerlines-in-local-scenes-in-pro__doc766.md","s":4.09},{"doc":686,"file":"add-multiple-line-events-tool-in-arcgis-pro__doc686.md","s":4.047},{"doc":685,"file":"add-multiple-point-events-tool-in-arcgis-pro__doc685.md","s":4.011},{"doc":687,"file":"add-line-event-tool-in-arcgis-pro__doc687.md","s":3.561}]
```
-->
...
<!-- related:begin -->
- [Split Event in Experience Builder](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/split-event-in-experience-builder__doc472.md>) — similar text 0.49 · 1 title word · 2 filename words · same kind/folder <!-- rel:472 -->
- [Split Centerlines in Local Scenes in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/split-centerlines-in-local-scenes-in-pro__doc766.md>) — similar text 0.23 · 2 title words · 1 filename word · same kind/surface/folder <!-- rel:766 -->
- [Add Multiple Line Events tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-multiple-line-events-tool-in-arcgis-pro__doc686.md>) — similar text 0.35 · 2 title words · same kind/surface/folder <!-- rel:686 -->
- [Add Multiple Point Events tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-multiple-point-events-tool-in-arcgis-pro__doc685.md>) — similar text 0.34 · 2 title words · same kind/surface/folder <!-- rel:685 -->
- [Add Line Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-event-tool-in-arcgis-pro__doc687.md>) — similar text 0.35 · 1 title word · same kind/surface/folder <!-- rel:687 -->
<!-- related:end -->
...
![image1.png](../media/doc243_image1.png)

## Slide 4 — Split Events in Pro
...
![image2.png](../media/doc243_image2.png)

## Slide 5 — Split Events in Pro
