...
<!-- related:begin -->
- [Add Multiple Point Events tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-multiple-point-events-tool-in-pro.md>) — similar text 0.83 · 5 title words · 3 filename words · same kind/surface/folder <!-- rel:685 s=8.349 -->
- [Add Line Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-event-tool-in-pro.md>) — similar text 0.84 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:687 s=8.322 -->
- [Add Single Point Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-single-point-event-tool-in-pro.md>) — similar text 0.73 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:688 s=6.197 -->
- [User Story Add Line Event (Multiple)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-event-multiple.md>) — similar text 0.35 · 3 title words · 3 filename words · same kind/folder <!-- rel:480 s=5.131 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6134-add-multiple-line-events-by-route-and-measure.md>) — similar text 0.19 · 4 title words · 3 filename words · same surface <!-- rel:120 s=4.977 -->
<!-- related:end -->
...
## Story
### Add Multiple Line Events tool in ArcGIS Pro <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Add Multiple Line Events (Loc Ref ribbon) <!-- slide 3 -->
...
![Figure 1 — Add Multiple Line Events (Loc Ref ribbon)](../media/add-multiple-line-events-tool-in-pro/fig-01-slide-03-add-multiple-line-events-loc-ref-ribbon.png)

### Add Multiple Line Events (tool) <!-- slide 4 -->
...
![Figure 2 — Add Multiple Line Events (tool)](../media/add-multiple-line-events-tool-in-pro/fig-02-slide-04-add-multiple-line-events-tool.png)

### Add Multiple Line Events (tool) <!-- slide 5 -->
...
![Figure 3 — Add Multiple Line Events (tool)](../media/add-multiple-line-events-tool-in-pro/fig-03-slide-05-add-multiple-line-events-tool.png)

### Add Multiple Line Events (tool) <!-- slide 6 -->
...
### Add Multiple Line Events (tool) <!-- slide 7 -->
...
![Figure 4 — Add Multiple Line Events (tool)](../media/add-multiple-line-events-tool-in-pro/fig-04-slide-07-add-multiple-line-events-tool.png)

### Add Multiple Line Events (tool) <!-- slide 8 -->
...
![Figure 5 — Add Multiple Line Events (tool)](../media/add-multiple-line-events-tool-in-pro/fig-05-slide-08-add-multiple-line-events-tool.png)
