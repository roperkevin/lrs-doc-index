...
| Field | Value |
| --- | --- |
| **Doc** | 361 · User Story · Experience Builder |
| **Product** | — |
| **Release** | — |
| **Issues** | — |
...
<!-- related:begin -->
- [Experience Builder Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/exb-dynseg-widget.md>) — similar text 0.43 · 5 title words · 5 filename words · same kind/surface/folder <!-- rel:362 s=7.847 -->
- [Dynamic Segmentation Table Test Plan Options](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/dynseg-table-options.md>) — similar text 0.29 · 3 title words · 2 filename words · same surface <!-- rel:337 s=5.669 -->
- [Experience Builder Straight Line Diagram Event Attributes/Editing on Click](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/exb-sld-event-attributes-editing-on-click.md>) — similar text 0.35 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:345 s=5.066 -->
- [Search by Referent Experience Builder widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/search-by-referent-exb-widget.md>) — similar text 0.28 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:476 s=4.731 -->
- [Search by Station Experience Builder widget User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/search-by-station-exb-widget.md>) — similar text 0.28 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:490 s=4.711 -->
<!-- related:end -->
...
## Story
### Experience Builder Dynamic Segmentation widget additional options <!-- slide 1 -->
User Story
ArcGIS Enterprise
...
## Acceptance Criteria
### Dynamic Segmentation widget additional options <!-- slide 3 -->
...
![Figure 1 — Dynamic Segmentation widget additional options](../media/exb-dynseg-widget-additional-options/fig-01-slide-03-dynamic-segmentation-widget-additional.png)

### Dynamic Segmentation widget additional options <!-- slide 4 -->
