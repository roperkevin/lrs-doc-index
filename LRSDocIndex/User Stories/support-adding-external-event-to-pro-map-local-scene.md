...
<!-- related:begin -->
- [Support updating External Event configuration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-updating-external-event-configuration.md>) — similar text 0.64 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:744 s=6.905 -->
- [Create External Event with No Connection File](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-external-event-with-no-connection-file.md>) — similar text 0.22 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:288 s=4.349 -->
- [Support Calibrate Route in Local Scenes in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-calibrate-route-in-local-scenes-in-pro.md>) — similar text 0.20 · 3 title words · 1 filename word · same kind/surface/folder <!-- rel:774 s=4.243 -->
- [Support Create Route in Local Scenes in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-create-route-in-local-scenes-in-pro.md>) — similar text 0.21 · 3 title words · 1 filename word · same kind/surface/folder <!-- rel:778 s=4.143 -->
- [Support Retire Route in Local Scenes in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-retire-route-in-local-scenes-in-pro.md>) — similar text 0.19 · 3 title words · 1 filename word · same kind/surface/folder <!-- rel:770 s=4.062 -->
<!-- related:end -->
...
## Story
### Support adding External Event to Pro map/local scene <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Add External Event to map/local scene <!-- slide 3 -->
