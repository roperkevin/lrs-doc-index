...
<!-- related:begin -->
- [LRS Intersection Properties User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/lrs-intersection-properties.md>) — similar text 0.11 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:843 s=3.742 -->
- [Related Table for Intersection Measures](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/related-table-for-intersection-measures.md>) — similar text 0.27 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:678 s=3.601 -->
- [Add Intermediate Calibration Points to Loops in Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-intermediate-cp-to-loops-in-routes.md>) — similar text 0.40 · same kind/surface/folder <!-- rel:697 s=3.082 -->
- [Allow LRS Events and Intersections in Update Measures from LRS tool](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/allow-lrs-events-and-intersections-in-update-measures.md>) — similar text 0.18 · 1 title word · same kind/surface/folder <!-- rel:393 s=2.863 -->
- [Support honoring referents event behavior for cartographic realignment](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-honoring-referents-eb-for-cartographic-realignment.md>) — similar text 0.29 · same kind/surface/folder <!-- rel:737 s=2.851 -->
<!-- related:end -->
...
## Story
### Update intersection referent tool <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Update Intersection Referents <!-- slide 3 -->
