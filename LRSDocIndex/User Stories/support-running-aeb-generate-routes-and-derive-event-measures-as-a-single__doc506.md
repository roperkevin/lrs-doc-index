...
| **Source** | [5198-ProRibbonTooltoRunAEBGenRoutesandDeriveEventMeas_V3.pptx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/5198-ProRibbonTooltoRunAEBGenRoutesandDeriveEventMeas_V3.pptx>) |
| **Edited** | 2023-09-05 17:27 by Mac Christmas |
| **Extracted** | 2026-09-04 · lane `xmlstrip` |

<!-- metadata
```yaml
title: "Support Running AEB, Generate Routes, and Derive Event Measures as a Single Operation via the LR Pro Ribbon"
source_file: "5198-ProRibbonTooltoRunAEBGenRoutesandDeriveEventMeas_V3.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/5198-ProRibbonTooltoRunAEBGenRoutesandDeriveEventMeas_V3.pptx"
doc_id: 506
doc_kind: "User Story"
surface: "Pro"
doc_revision: "V3"
...
last_edited: "2023-09-05T17:27:35Z"
...
related: [{"doc":453,"file":"support-running-aeb-generate-routes-and-derive-event-measures-as-a-single__doc453.md","s":1004.545},{"doc":688,"file":"add-single-point-event-tool-in-arcgis-pro__doc688.md","s":4.007},{"doc":683,"file":"conflict-prevention-for-event-editing-in-pro__doc683.md","s":3.888},{"doc":743,"file":"support-reverse-route-in-pro__doc743.md","s":3.653},{"doc":687,"file":"add-line-event-tool-in-arcgis-pro__doc687.md","s":3.505}]
```
-->
...
<!-- related:begin -->
- [Support Running AEB, Generate Routes, and Derive Event Measures as a Single Operation via the LR Pro Ribbon – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/support-running-aeb-generate-routes-and-derive-event-measures-as-a-single__doc453.md>) — shared issue ArcGISPro/ps-location-referencing#5198 · similar text 0.37 · 6 title words · same surface <!-- rel:453 -->
- [Add Single Point Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-single-point-event-tool-in-arcgis-pro__doc688.md>) — similar text 0.21 · 3 title words · 1 filename word · same kind/surface/folder <!-- rel:688 -->
- [Conflict Prevention for Event Editing in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/conflict-prevention-for-event-editing-in-pro__doc683.md>) — similar text 0.17 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:683 -->
- [Support Reverse Route in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-reverse-route-in-pro__doc743.md>) — similar text 0.18 · 2 title words · 1 filename word · same kind/surface/folder <!-- rel:743 -->
...
## Slide 1 — Support Running AEB, Generate Routes, and Derive Event Measures as a single operation via the LR Pro Ribbon
...
![image1.png](../media/doc441_image1.png)
