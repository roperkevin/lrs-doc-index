...
| Field | Value |
| --- | --- |
| **Doc** | 486 · User Story · Pro |
| **Product** | Pipeline Referencing · Utility Network |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#3004](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/3004) |
...
<!-- related:begin -->
- [Append Routes consider existing centerlines – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/3004-append-routes-consider-existing-centerlines.md>) — shared issue ArcGISPro/ps-location-referencing#3004 · similar text 0.28 · 5 title words · 1 filename word · same surface <!-- rel:469 s=1004.552 -->
- [Append Routes with existing Utility Network centerlines](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/append-routes-with-existing-un-centerlines.md>) — similar text 0.70 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:741 s=7.978 -->
- [Consider Route Dominance in Append Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/consider-route-dominance-in-append-routes.md>) — similar text 0.32 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:709 s=5.9 -->
- [Explode multipart centerlines in editing activities and Append Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/explode-multipart-centerlines-in-editing-activities.md>) — similar text 0.16 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:817 s=4.931 -->
- [Append Routes Partial Loading Support](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/append-routes-partial-loading-support.md>) — similar text 0.31 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:165 s=4.53 -->
<!-- related:end -->
...
## Story
### Append Routes consider existing centerlines <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Append Routes considering existing centerlines <!-- slide 3 -->
...
### Append Routes considering existing centerlines <!-- slide 4 -->
