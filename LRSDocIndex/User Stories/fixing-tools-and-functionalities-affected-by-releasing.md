...
<!-- related:begin -->
- [Support Reassign: Transfer to a New Line Method in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-reassign-transfer-to-a-new-line-method-in-pro.md>) — similar text 0.18 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:585 s=3.264 -->
- [Reassign to a New or Existing Line with Original Route ID/Name Maintained on the Target Line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/565-reassign-to-a-new-or-existing-line-with-original-route-id.md>) — similar text 0.16 · 2 title words · 1 filename word · same kind/folder <!-- rel:594 s=3.241 -->
- [Support Reassign: Transfer as New Route(s) to Adjacent Line Method in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-reassign-transfer-as-new-route-s-to-adjacent-line.md>) — similar text 0.16 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:583 s=3.219 -->
- [Conflict Prevention: Acquire Locks when creating new routes in Create, Extend, Realign, and Reassign Route](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/conflict-prevention-acquire-locks-when-creating-new-routes.md>) — similar text 0.09 · 1 title word · same kind/surface/folder <!-- rel:826 s=3.082 -->
- [Reassign to a new or existing line with original Route ID/Name maintained on the target line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/reassign-to-a-new-or-existing-line-with-original-route-id.md>) — similar text 0.15 · 2 title words · 1 filename word · same kind/folder <!-- rel:607 s=3.082 -->
<!-- related:end -->
...
## Story
### Fixing tools and functionalities that are affected by releasing the unique Rid/name check in Reassign <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Fixing affected tools and functionalities <!-- slide 3 -->
...
![Figure 1 — Fixing affected tools and functionalities](../media/fixing-tools-and-functionalities-affected-by-releasing/fig-01-slide-03-fixing-affected-tools.svg)

### Testing – sample testing <!-- slide 4 -->
