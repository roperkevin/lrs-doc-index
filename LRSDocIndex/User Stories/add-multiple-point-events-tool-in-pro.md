...
<!-- related:begin -->
- [Add Multiple Line Events tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-multiple-line-events-tool-in-pro.md>) — similar text 0.83 · 5 title words · 3 filename words · same kind/surface/folder <!-- rel:686 s=8.349 -->
- [Add Single Point Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-single-point-event-tool-in-pro.md>) — similar text 0.76 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:688 s=7.349 -->
- [Add Line Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-event-tool-in-pro.md>) — similar text 0.79 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:687 s=6.521 -->
- [Add Point Event Point Offset Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-point-event-point-offset-method.md>) — similar text 0.34 · 2 title words · 3 filename words · same kind/surface/folder <!-- rel:272 s=5.356 -->
- [Add Point Events in Experience Builder](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-point-events-in-exb-2023-09.md>) — similar text 0.34 · 3 title words · 3 filename words · same kind/folder <!-- rel:495 s=5.135 -->
<!-- related:end -->
...
## Story
### Add Multiple Point Events tool in ArcGIS Pro <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Add Multiple Point Events (Loc Ref ribbon) <!-- slide 3 -->
...
![Figure 1 — Add Multiple Point Events (Loc Ref ribbon)](../media/add-multiple-point-events-tool-in-pro/fig-01-slide-03-add-multiple-point-events-loc-ref-ribbon.png)

### Add Multiple Point Events (tool) <!-- slide 4 -->
...
![Figure 2 — Add Multiple Point Events (tool)](../media/add-multiple-point-events-tool-in-pro/fig-02-slide-04-add-multiple-point-events-tool.png)

### Add Multiple Point Events (tool) <!-- slide 5 -->
...
![Figure 3 — Add Multiple Point Events (tool)](../media/add-multiple-point-events-tool-in-pro/fig-03-slide-05-add-multiple-point-events-tool.png)

### Add Multiple Point Events (tool) <!-- slide 6 -->
...
### Add Multiple Point Events (tool) <!-- slide 7 -->
...
![Figure 4 — Add Multiple Point Events (tool)](../media/add-multiple-point-events-tool-in-pro/fig-04-slide-07-add-multiple-point-events-tool.png)

### Add Multiple Point Events (tool) <!-- slide 8 -->
...
![Figure 5 — Add Multiple Point Events (tool)](../media/add-multiple-point-events-tool-in-pro/fig-05-slide-08-add-multiple-point-events-tool.png)
