...
<!-- metadata
```yaml
title: "Support Reassign: Transfer as New Route(s) to Adjacent Line Method in ArcGIS Pro"
source_file: "ReassignUI_TransferToAdjacentLine.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/ReassignUI_TransferToAdjacentLine.pptx"
doc_id: 583
doc_kind: "User Story"
surface: "Pro"
doc_revision: ""
...
last_edited: "2023-04-05T23:24:32Z"
...
issues: []
related: [{"doc":585,"file":"support-reassign-transfer-to-a-new-line-method-in-arcgis-pro__doc585.md","s":11.901},{"doc":533,"file":"reassign-route-transfer-to-another-line-method-support-move-event-behavior-test__doc533.md","s":5.487},{"doc":586,"file":"reassign-ui-change-to-dynamically-support-existing-reassign-methods-pro__doc586.md","s":5.412},{"doc":594,"file":"reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc594.md","s":5.199},{"doc":607,"file":"reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc607.md","s":5.195}]
```
-->
...
<!-- related:begin -->
- [Support Reassign: Transfer to a New Line Method in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-reassign-transfer-to-a-new-line-method-in-arcgis-pro__doc585.md>) — similar text 0.88 · 6 title words · 3 filename words · same kind/surface/folder <!-- rel:585 -->
- [Reassign Route Transfer to Another Line Method: Support Move Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-route-transfer-to-another-line-method-support-move-event-behavior-test__doc533.md>) — similar text 0.23 · 6 title words · 2 filename words · same surface <!-- rel:533 -->
...
- [Reassign to a New or Existing Line with Original Route ID/Name Maintained on the Target Line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc594.md>) — similar text 0.50 · 3 title words · 1 filename word · same kind/folder <!-- rel:594 -->
- [Reassign to a new or existing line with original Route ID/Name maintained on the target line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc607.md>) — similar text 0.50 · 3 title words · 1 filename word · same kind/folder <!-- rel:607 -->
<!-- related:end -->
...
## Slide 1 — Support Reassign: Transfer as new route(s) to adjacent line Method in Pro

User Story

## Slide 2 — Transfer to adjacent line Context

![Diagram drawn from the slide's own shapes: 17 nodes, 7 connectors.](../media/doc361_slide2.svg)
...
![image1.png](../media/doc361_image1.png) ![image2.png](../media/doc361_image2.png)

## Slide 5 — Reassign Methods in Pro – Tool pane

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc361_slide5.svg)
...
![image3.png](../media/doc361_image3.png)

## Slide 6

![Interface screenshot redrawn as a standardized wireframe: 1 panel, 1 field, 3 icons, 21 text rows. 17 of 21 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc361_slide6_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 6 fields, 5 icons, 25 text rows. 17 of 25 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc361_slide6_fig2.svg)

Transfer as new route(s) to adjacent line
Apply values to all routes

![image4.png](../media/doc361_image4.png) ![image5.png](../media/doc361_image5.png) ![image6.png](../media/doc361_image6.png)
...
![image7.jpeg](../media/doc361_image7.jpeg)
...
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 6 fields, 3 icons, 24 text rows. 17 of 24 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc361_slide13_fig2.svg)

![Diagram drawn from the slide's own shapes: 34 nodes, 14 connectors.](../media/doc361_slide13_fig1.svg)
...
![image8.png](../media/doc361_image8.png)
