...
| Field | Value |
| --- | --- |
| **Doc** | 646 · User Story · Enterprise |
| **Product** | — |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#4039](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/4039) |
...
<!-- related:begin -->
- [Support Conflict Prevention in Sync Service](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-conflict-prevention-in-sync-service.md>) — similar text 0.70 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:645 s=7.068 -->
- [Field Maps and Sync Service Issues and Workflow Notes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/field-maps-and-sync-service-issues-and-workflow-notes.md>) — similar text 0.21 · 2 title words · 2 filename words · same surface/folder <!-- rel:616 s=6.219 -->
- [Spike: Sync Service Automation Pattern](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Design Spikes/sync-service-automation-pattern.md>) — similar text 0.23 · 2 title words · 2 filename words · same folder <!-- rel:642 s=3.642 -->
- [Support LRS Partial Posting](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-lrs-partial-posting.md>) — similar text 0.11 · 1 title word · same kind/surface/folder <!-- rel:738 s=2.579 -->
- [Support honoring referents event behavior for cartographic realignment](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-honoring-referents-eb-for-cartographic-realignment.md>) — similar text 0.15 · 2 title words · same kind/folder <!-- rel:737 s=2.414 -->
<!-- related:end -->
...
## Story
### Integrate LRS into Sync Service to support disconnected event editing workflows <!-- slide 1 -->
