...
<!-- related:begin -->
- [Conflict Prevention for Event Editing in Pro – Core Tools](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/conflict-prevention-for-event-editing-in-pro-core-tools-2022-04.md>) — similar text 0.23 · 5 title words · 5 filename words · same surface <!-- rel:671 s=6.973 -->
- [Conflict Prevention for Event Editing in Pro – Core Tools](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/conflict-prevention-for-event-editing-in-pro-core-tools-v4.md>) — similar text 0.22 · 5 title words · 5 filename words · same surface <!-- rel:670 s=6.946 -->
- [Conflict Prevention for Event Editing in Pro – LR Event Tools](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/conflict-prevention-for-event-editing-in-pro-lr-event-tools.md>) — similar text 0.21 · 5 title words · 5 filename words · same surface <!-- rel:666 s=6.674 -->
- [Support Conflict Prevention in Route Editing skills in Pro AI Assistant](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/support-conflict-prevention-in-route-editing-skills-in-pro.md>) — similar text 0.31 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:94 s=6.19 -->
- [Experience Builder Conflict Prevention User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/exb-conflict-prevention.md>) — similar text 0.48 · 2 title words · 2 filename words · same kind/folder <!-- rel:433 s=5.296 -->
<!-- related:end -->
...
## Story
### Conflict Prevention for Event Editing in Pro <!-- slide 1 -->
User Story
...
## Acceptance Criteria
### Conflict Prevention Event Editing in Pro <!-- slide 3 -->
