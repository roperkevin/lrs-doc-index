...
| Field | Value |
| --- | --- |
| **Doc** | 478 · User Story · Experience Builder |
...
| **Source** | [3780-SupportSnapEBinRetireRoute_V5.pptx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/3780-SupportSnapEBinRetireRoute_V5.pptx>) · rev V5 |
...
<!-- related:begin -->
- [Support Snap Event Behavior in Retire Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/3780-support-snap-eb-in-retire-routes-rh-apr-v4.md>) — shared issue ArcGISPro/ps-location-referencing#3780 · similar text 0.94 · 6 title words · 5 filename words · same kind/surface/folder <!-- rel:479 s=1011.437 -->
- [Retire Routes: Snap Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/3780-retire-routes-snap-eb.md>) — shared issue ArcGISPro/ps-location-referencing#3780 · similar text 0.72 · 5 title words · 2 filename words · same surface <!-- rel:454 s=1007.294 -->
- [Support Snap Event Behavior in Realign Route](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-snap-eb-in-realign-route.md>) — similar text 0.13 · 4 title words · 3 filename words · same kind/folder <!-- rel:730 s=5.235 -->
- [Transfer to Another Line – Support Snap Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/transfer-to-another-line-support-snap-eb-rh-apr-2023-08-2.md>) — similar text 0.07 · 4 title words · 1 filename word · same surface <!-- rel:527 s=3.607 -->
- [Support Event Behaviors for New Reassign Method: Transfer to another line](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-eb-for-new-reassign-method-transfer-to-another-line.md>) — similar text 0.13 · 2 title words · same kind/surface/folder <!-- rel:572 s=3.535 -->
<!-- related:end -->
...
![Figure 1 — Nonline Network, Retire Whole Route](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-01-slide-04-nonline-network-retire-whole-route.svg)
...
[figure: Routes Before Edit: · Routes After Edit: · Events Before Edit: · Events After Edit: · Route1 · Route2 (concurrent) · Post-edit, AEB ran: · 0 · 10 · 5]

![Figure 2 — Nonline Network, Retire first half of route](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-02-slide-05-nonline-network-retire-first-half.svg)
...
![Figure 3 — Nonline Network, Retire middle of Route](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-03-slide-06-nonline-network-retire-middle-of-route.svg)
...
![Figure 4 — Nonline Network, Retire second half of Route](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-04-slide-07-nonline-network-retire-second-half.svg)
...
![Figure 5 — Line Network, Retire all routes](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-05-slide-08-line-network-retire-all-routes.svg)
...
![Figure 6 — Line Network, Retire first half of routes](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-06-slide-09-line-network-retire-first-half-of-routes.svg)
...
![Figure 7 — Line Network, Retire middle route](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-07-slide-10-line-network-retire-middle-route.svg)
...
![Figure 8 — Line Network, Retire last half of routes](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-08-slide-11-line-network-retire-last-half-of-routes.svg)
...
![Figure 9 — Nonline Network, Retire whole route, partial concurrency:](../media/3780-support-snap-eb-in-retire-routes-rh-apr-v5/fig-09-slide-12-nonline-network-retire-whole-route.svg)
