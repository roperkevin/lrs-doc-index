# Add Multiple Line Events tool in ArcGIS Pro

|   |   |
| --- | --- |
| **Kind** | User Story · Pro |
| **Release** | — |
| **Source** | [AddMultipleLineEvent.pptx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/AddMultipleLineEvent.pptx>) |
| **Edited** | 2022-01-21 01:06 by Nathan Easley |
| **Extracted** | 2026-09-04 · lane `xmlstrip` |

<!-- metadata
```yaml
title: "Add Multiple Line Events tool in ArcGIS Pro"
source_file: "AddMultipleLineEvent.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/AddMultipleLineEvent.pptx"
doc_id: 686
doc_kind: "User Story"
surface: "Pro"
doc_revision: ""
...
last_edited: "2022-01-21T01:06:14Z"
extracted: 2026-09-04
extraction_lane: xmlstrip
prompt_version: "v2.0.2"
keywords: ["line event", "route", "measure", "attribute set", "spanning event", "gap calibration"]
tools: ["Add Multiple Line Events"]
products: []
issues: []
related: [{"doc":685,"file":"add-multiple-point-events-tool-in-arcgis-pro__doc685.md","s":8.349},{"doc":687,"file":"add-line-event-tool-in-arcgis-pro__doc687.md","s":8.322},{"doc":688,"file":"add-single-point-event-tool-in-arcgis-pro__doc688.md","s":6.197},{"doc":480,"file":"user-story-add-line-event-multiple__doc480.md","s":5.131},{"doc":120,"file":"add-multiple-line-events-by-route-and-measure__doc120.md","s":4.977}]
```
-->

## Summary

User story describing the need for an Add Multiple Line Events tool in ArcGIS Pro to enable LRS Editors to add multiple line events at a single location within the application. The tool includes UI workflows for selecting routes, measures, attribute sets, and handling spanning events with validation and error handling. Testing and automation plans are outlined for various network types and scenarios.

## Related documents

<!-- related:begin -->
- [Add Multiple Point Events tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-multiple-point-events-tool-in-arcgis-pro__doc685.md>) — similar text 0.83 · 5 title words · 3 filename words · same kind/surface/folder <!-- rel:685 -->
- [Add Line Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-event-tool-in-arcgis-pro__doc687.md>) — similar text 0.84 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:687 -->
- [Add Single Point Event tool in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-single-point-event-tool-in-arcgis-pro__doc688.md>) — similar text 0.73 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:688 -->
- [User Story Add Line Event (Multiple)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/user-story-add-line-event-multiple__doc480.md>) — similar text 0.35 · 3 title words · 3 filename words · same kind/folder <!-- rel:480 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-multiple-line-events-by-route-and-measure__doc120.md>) — similar text 0.19 · 4 title words · 3 filename words · same surface <!-- rel:120 -->
<!-- related:end -->

<!-- docs:begin -->
## Esri documentation

[Add multiple line events](https://doc.esri.com/en/arcgis-pro/latest/help/production/location-referencing-pipelines/add-multiple-line-events.html) · [Split a centerline by measure](https://doc.esri.com/en/arcgis-pro/latest/help/production/location-referencing-pipelines/split-a-centerline-by-measure.html)
<!-- docs:end -->

---

## Slide 1 — Add Multiple Line Events tool in ArcGIS Pro

User Story

## Slide 2 — User Story

As an LRS Editor, I need the capability to add multiple line events at a single location in ArcGIS Pro, so that I can complete entire LRS editing workflows within a single application.

Persona
LRS Editor: This user is responsible for making edits to the LRS.  The edits they need to make come in from field crews/contractors in a variety of formats (shapefiles, engineering drawing, fgdbs).  The LRS Editor is responsible for making the route and event edits based on these documents. As of now, the LRS Editor can edit an event’s shape and location in Pro, but none of the attributes such as Route ID, Route Name, measure and date fields are updated.  We need to build a tool that allows them to create multiple line events at a single location inside of ArcGIS Pro.

## Slide 3 — Add Multiple Line Events (Loc Ref ribbon)

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide3_fig1.svg)
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide3_fig2.svg)

Add a new button to the events section called Add Multiple Line Events. (Note the icons for this tool should have been requested already as part of the Add Point Event user story)
...
![image1.png](../media/doc233_image1.png)

## Slide 4 — Add Multiple Line Events (tool)

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide4.svg)
...
![image2.png](../media/doc233_image2.png)

## Slide 5 — Add Multiple Line Events (tool)

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide5.svg)
...
![image3.png](../media/doc233_image3.png)

## Slide 6 — Add Multiple Line Events (tool)

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide6.svg)
...
## Slide 7 — Add Multiple Line Events (tool)

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide7.svg)
...
![image4.png](../media/doc233_image4.png)

## Slide 8 — Add Multiple Line Events (tool)

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc233_slide8.svg)
...
![image5.png](../media/doc233_image5.png)
...
Create a new topic called Adding Multiple Line Events (in the same section of the documentation for the previous event editing topics using core tools)
