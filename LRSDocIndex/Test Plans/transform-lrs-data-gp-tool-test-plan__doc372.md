...
| **Kind** | Test Plan · Pro |
| **Release** | — |
| **Issue** | [ArcGISPro/ps-location-referencing#5742](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/5742) |
...
<!-- metadata
```yaml
title: "Transform LRS Data GP tool – Test Plan"
source_file: "TransformReportingDataGP_Testplan.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/TransformReportingDataGP_Testplan.pptx"
doc_id: 372
doc_kind: "Test Plan"
surface: "Pro"
doc_revision: ""
...
last_edited: "2024-05-16T23:02:19Z"
...
products: []
issues: ["ArcGISPro/ps-location-referencing#5742"]
related: [{"doc":359,"file":"transform-lrs-data-gp-tool-summarize-by-polygon-boundaries-test-plan__doc359.md","s":7.616},{"doc":255,"file":"generate-a-route-log-including-spanning-events-and-centerline-test-plan__doc255.md","s":5.785},{"doc":260,"file":"generate-a-route-log-using-the-glrsdp-gp-tool-test-plan__doc260.md","s":4.965},{"doc":232,"file":"support-table-output-with-the-length-product-template-test-plan__doc232.md","s":4.234},{"doc":323,"file":"support-multiple-summary-fields-in-lrs-data-template-wizard-test-plan__doc323.md","s":3.668}]
```
-->
...
<!-- related:begin -->
- [Transform LRS Data GP tool: Summarize by polygon boundaries – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/transform-lrs-data-gp-tool-summarize-by-polygon-boundaries-test-plan__doc359.md>) — similar text 0.35 · 2 title words · 3 filename words · same kind/surface/dev/folder <!-- rel:359 -->
- [Generate a route Log including spanning events and centerline – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/generate-a-route-log-including-spanning-events-and-centerline-test-plan__doc255.md>) — similar text 0.09 · 1 filename word · same kind/surface/pe/dev/folder <!-- rel:255 -->
- [Generate a Route Log using the GLRSDP GP Tool – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/generate-a-route-log-using-the-glrsdp-gp-tool-test-plan__doc260.md>) — similar text 0.18 · 1 title word · 1 filename word · same kind/surface/dev/folder <!-- rel:260 -->
- [Support table output with the length product template – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/support-table-output-with-the-length-product-template-test-plan__doc232.md>) — similar text 0.22 · 1 filename word · same kind/surface/pe/dev <!-- rel:232 -->
- [Support multiple summary fields in LRS Data Template wizard – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/support-multiple-summary-fields-in-lrs-data-template-wizard-test-plan__doc323.md>) — similar text 0.23 · 1 filename word · same kind/surface/pe/folder <!-- rel:323 -->
<!-- related:end -->
...
## Slide 1 — Transform LRS Data GP tool – Test Plan *Data prepared with real data
...
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 8 fields, 1 row separator, 6 icons, 28 text rows. 25 of 28 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc595_slide2.svg)

GP tool:

- Add a GP tool Transform LRS Data that accepts configuration and routes as input and returns a mileage report in table format
- GP tool should be added in regular Location Referencing toolbox
...
![image1.png](../media/doc595_image1.png)

## Slide 3

![Interface screenshot redrawn as a standardized wireframe: 1 panel, 8 fields, 1 row separator, 6 icons, 28 text rows. 25 of 28 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc595_slide3.svg)
...
| --- | --- | --- | --- |
| 1 | A required field is missing upon clicking Run | Error |  |
| 2 | User provides a report template that is incorrect / does not exist (one error or 2 different errors) | Error |  |
| 3 | User provides a non- LRSnetwork in network | Error |  |
| 4 | User provides an invalid output name if there is any restriction on this in Pro | Error |  |
|  | User provides an output file name that already exists | Warning. Overwrite existing file |  |
| 5 | User provides a negative number of decimals | Error |  |
| 6 | User provides abc for decimals | Error |  |
| 6b | User provides more than 7 decimals – put in design | Error |  |
| 7 | Tool is cancelled after hitting run | Error and output depends on the stage of cancel |  |
| 8 | User does not have LR license | Tool does not open |  |
| 9 | User provides incorrect format for these fields (this can happen in python) | Error |  |
| 10 | User provide incorrect file type we don’t support yet in python | Error |  |
|  |  |  |  |
...
| --- | --- | --- | --- |
| 1 (Simple1) | Simple route 0-1.3810116 | 1.3810116 mi |  |
| 2 (SimpleGap1) | Gapped route Euclidean Distance 0.23- 0.5633576 0.7366332-1.2819481 | 0.8786725 mi |  |
| 3 (Stepping2Gap1) on same line as 6 | Multiple gapped route Stepping Increment of 0 1000-1399.834 1399.834-1985.418 1985.418-2662.91 (concurrent with 4) | 1662.91 m |  |
| 4 (AddingGap1) | Multiple gapped route Adding Increment of 0.1 0- 0.399834 0.499834 - 1.085418 1.185418 -1.8291 (concurrent with 3) | 1.662910 km |  |
| 5 (Loop1) | Loop route 5-5.6978757 | 0.6978757 mi |  |
| 6 (Stepping2Lollipop2) on same line as 3 | Multiple gapped lollipop route Stepping Increment of 0 2862.91-4605.776 4605.776-4764.922 4764.92-6885.126 | 4022.216 m |  |
| 6b (Stepping2) | Derived route from 3 and 6. 0-5.685126 | 5.685126 km |  |
...
![Interface screenshot redrawn as a standardized wireframe: 1 field, 2 buttons, 9 icons, 82 text rows. 46 of 82 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc595_slide9.svg)
