...
<!-- metadata
```yaml
title: "Transfer to Another Line – Support Snap Event Behavior Test Plan"
source_file: "ReassignSnapEB_2pages_new_2.pdf"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/ReassignSnapEB_2pages_new_2.pdf"
doc_id: 527
doc_kind: "Test Plan"
...
issues: []
related: [{"doc":526,"file":"transfer-to-another-line-support-snap-event-behavior-test-plan__doc526.md","s":11.198},{"doc":528,"file":"reassign-transfer-to-another-line-with-stayput-and-retire-event-behavior-test__doc528.md","s":6.564},{"doc":533,"file":"reassign-route-transfer-to-another-line-method-support-move-event-behavior-test__doc533.md","s":6.223},{"doc":572,"file":"support-event-behaviors-for-new-reassign-method-transfer-to-another-line__doc572.md","s":4.841},{"doc":521,"file":"relocate-events-test-plan__doc521.md","s":4.182}]
```
-->
...
<!-- related:begin -->
- [Transfer to Another Line – Support Snap Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/transfer-to-another-line-support-snap-event-behavior-test-plan__doc526.md>) — similar text 0.68 · 6 title words · 3 filename words · same kind/surface/pe/dev/folder <!-- rel:526 -->
- [Reassign - Transfer to Another Line with StayPut and Retire Event Behavior - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/reassign-transfer-to-another-line-with-stayput-and-retire-event-behavior-test__doc528.md>) — similar text 0.23 · 5 title words · 1 filename word · same kind/dev/folder <!-- rel:528 -->
- [Reassign Route Transfer to Another Line Method: Support Move Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-route-transfer-to-another-line-method-support-move-event-behavior-test__doc533.md>) — similar text 0.18 · 6 title words · 1 filename word · same kind/folder <!-- rel:533 -->
- [Support Event Behaviors for New Reassign Method: Transfer to another line](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-event-behaviors-for-new-reassign-method-transfer-to-another-line__doc572.md>) — similar text 0.26 · 5 title words · 1 filename word · same surface <!-- rel:572 -->
- [Relocate Events Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/relocate-events-test-plan__doc521.md>) — similar text 0.39 · 1 filename word · same kind/surface/folder <!-- rel:521 -->
<!-- related:end -->
...
Data:
                                                                             3
•   Test with FS in Pro
•   Test on a mix of RH and APR data, but line network only. No PoM is
    required
•   Test with projected data (make few cases in unprojected data that
    has routes on beginning and end of a line, with sparse vertices at
    lease 1 mile from each other)
...
•   Test time slicing
•   Test transferring entire route, multiple entire routes, partial route,
    and combinations
...
•   Test events that cover entire reassigned portion, more than
    reassigned portion, and shorter than reassigned portion
•   Test events on begin-end, begin-middle, middle-middle, and middle-
    end of routes
                                                                                      4

Automation
•    Add to existing for projected data; create a new set under the same
     category (APR Python Tests) for cases in unprojected data
•    Runs in Python in Feature Service
•    Automations on existing event behaviors are unlikely to fail. However, if
     there is any, please fix. Depending on the scope, fixing automation can be
...
1.   Verify edit log (the changed routes (rows) in xml, pay attention to effective
     date)
2.   Verify for existing methods in Reassign, and Realign, snap still works the say
     it is today (Existing EB automation can help)
3.   Ensure shape, measure, and LRS attributes for all time slices on events are
     correct after running AEB
4.   Verify a new event record is created if event changes line-ship (the line that
     the routes with the event belong to)
5.   Verify source routes are recalibrated downstream and calibrate event
     behavior will apply to the downstream events if Recalibrate source routes
     downstream checked
Positive cases – repeat for New Line & Existing Line                                                   5
There is no negative case (Loc error)
  Spanning events                       Snap Events will move so tables are not accurate
  1.   Transfer to New Line – transfer 3 entire simple routes; transfer CP; keep original measures;
       keep original route name/id
                                                                                          CW58_1A
        1-b. Transfer to New Line - 2 separate transfers; transfer CP; keep original measures;
        partial routes change route name/id                                               CW55_1A
  2.   Transfer to New Line – transfer 3 entire simple routes; not transfer CP; change measures;
       change 1 route name/id                                                             CW52_1A
  3.   Transfer to New Line – transfer 1 entire simple route; transfer CP; keep original measures;
       keep original route name/id                                                        CW49_1A
        3-b: Transfer to New Line – transfer 1 entire simple route; transfer CP; keep original
        measures; keep original route name/id; effective date is route start date         CW46_1A
  4.   Transfer to New Line – transfer 1 entire loop; transfer CP; change measures; keep original
       route name/id                                                                      loopCW4_1A
  5.   Transfer to New Line – transfer 0.5+1+0.5 simple routes; transfer CP; keep original
       measures; partial routes have to change route name/id (2 variations for source
       recalibration)                                                    CW40_1A CW37_1A
        5-b: Transfer to New Line – transfer 0.5 route; transfer CP; change measures; partial route
        changes route name/id; recalibrate source downstream                            CW34_1A
  6.   Transfer to New Line – transfer 0.5+1 simple routes; transfer CP; change measures; partial
       routes have to change route name/id                                                CW31_1A
  7.   Transfer to New Line – transfer 3 entire simple routes that have concurrent routes that have
       events; transfer CP; change measures on 1 route; change 1 route name/id            CW28_1A
  8.   Transfer to New Line – transfer 1+0.5 simple routes; routes on source line have concurrent
       routes that have events; routes on source line have multiple time slices; transfer CP; change
       measures on 0.5 route; partial routes have to change route name/id                 CW25_1A
        8-b: Transfer to New Line – transfer 3 simple routes; routes on source line have multiple
        time slices; not transfer CP                                                      CW22_1A
Non-spanning events
9.    Transfer to New Line – transfer 3 entire simple routes; transfer CP; keep original measures; keep original
                                                                                                                   6
      route name/id
                                                                                                    CW58_1A
        9-b. Transfer to New Line - 2 separate transfers; transfer CP; keep original measures; partial routes
        change name/id                                                                              CW55_1A
10.   Transfer to New Line - transfer 1 entire simple route; not transfer CP; keep original measures; keep
      original route name/id                                                                        CW19_1A
11.   Transfer to New Line – transfer 0.5+1+0.5 simple routes; transfer CP; keep original measures; partial
      routes have to change route name/id (2 variations for source recalibration)
                                                                                    CW40_1A CW37_1A
        11-b: Transfer to New Line – transfer 0.5 route; transfer CP; change measures; partial route change
        route name/id; recalibrate source downstream
                                                                                                    CW34_1A
12.   Transfer to New Line – transfer 0.5+1 simple routes; transfer CP; change measures; partial routes have to
      change route name/id
                                                                                                    CW31_1A
13.   Transfer to New Line – transfer 3 entire simple routes that have concurrent routes that have events;
      transfer CP; change measures on 1 route; change 1 route name/id                               CW28_1A
14.   Transfer to New Line – transfer 1+0.5 simple routes; routes on source line have concurrent routes that
      have events; routes on source line have multiple time slices; transfer CP; change measures on 0.5 route;
      partial routes have to change route name/id
                                                                                                    CW25_1A
        14-b: Transfer to New Line – transfer 3 simple routes; routes on source line have multiple time slices;
        not transfer CP
Point events                                                                                        CW22_1A
15.   Transfer to New Line – transfer 3 entire simple routes; transfer CP; keep original measures; keep original
      route name/id
                                                                                                    CW58_1A
        15-b. Transfer to New Line - 2 separate transfers; transfer CP; keep original measures; partial routes
        change route name/id                                                                        CW55_1A
16.   Transfer to New Line – transfer 1 entire simple route; not transfer CP; keep original measures; keep
      original route name/id                                                                        CW19_1A
        16-b: Transfer to New Line – transfer 1 entire simple route; transfer CP; keep original measures; keep
        original route name/id; effective date is route start date                                  CW46_1A
17.   Transfer to New Line – transfer 0.5+1 simple routes; not transfer CP; change measures; partial routes
      have to change route name/id                                                                  CW16_1A
        17-b: Transfer to New Line – transfer 0.5 route; transfer CP; change measures; partial route changes
        route name.id; recalibrate source downstream                                                CW34_1A
18.   Transfer to New Line – transfer 3 entire simple routes that have concurrent routes that have events;
      transfer CP; change measures on 1 route; change 1 route name/id                               CW28_1A
19.   Transfer to New Line – transfer 1+0.5 simple routes; routes on source line have concurrent routes that
      have events; routes on source line have multiple time slices; transfer CP; change measures on 0.5 route;
...
                    Test case 1: Transfer to New Line – transfer 3 entire simple routes;                                                          9
                    transfer CP; keep original measures; keep original route name/id
...
                  Test case 1: Transfer to New Line – transfer 3 entire simple routes;                                                   10
                  transfer CP; keep original measures; keep original route name/id
...
2A, 200
          ...
          Event ID       From Date           To Date From Route ID To Route ID From M                         To M Location Error
          S_blue         1/1/2000            <Null> 1B             2B          4                              5    No Error
         Test case 1-b: Transfer to New Line – 2 separate transfers; transfer CP;                                                   11
         keep original measures; partial routes change route name/id
...
S8             1/1/2000         <Null>    1A                        1A              2                  8      No Error
                     ...
                     Recal downstream unchecked
                        Test case 1-b: Transfer to New Line – 2 separate transfers; transfer CP;                                                                      12
                        keep original measures; partial routes change route name/id
...
100
               ...
               6                                                                      4                                                                      6
                    ...
                    1A_reassign_      Yellow          100             1/1/2030                  null                 6                   8
                    reassign
                    1B                Blue            100             1/1/2000                  null                 3                   5
                    2B                Blue            200             1/1/2000                  null                 4                   8
                    3B                Blue            300             1/1/2000                  null                 0                   4
               ...
               S5             1/1/2030        null          1A_reassign_reassi 1A_reassign_reassi 6                           8              No Error
                                                            gn                            gn
...
                   Test case 2: Transfer to New Line – transfer 3 entire simple routes; not                                                   13
                   transfer CP; change measures; change 1 route name/id
...
2A, 200
          ...
          S8             1/1/2000         <Null>    1A                        3A              2                  4      No Error
                               ...
                               Effective date is 1/1/2020
                               Recal downstream unchecked
                  Test case 2: Transfer to New Line – transfer 3 entire simple routes; not                                   14
                  transfer CP; change measures; change 1 route name/id
...
                   Test case 3: Transfer to New Line – transfer 1 entire simple route;                                                       15
                   transfer CP; keep original measures; keep original route name/id
      Before
               4          3          2                               0        1                         4
           0                                                                                                2                      8
...
2A, 200
          ...
          S8             1/1/2000        <Null>    1A                        3A              2                  4      No Error
                              ...
                              Effective date is 1/1/2020
                              Recal downstream unchecked
                   Test case 3: Transfer to New Line – transfer 1 entire simple route;                                               16
                   transfer CP; keep original measures; keep original route name/id
      After
               4          3          2                           0       1                       4
           0                                                                                         2                     8
...
                   Test case 3-b: Transfer to New Line – transfer 1 entire simple route; transfer
                   CP; keep original measures; keep original route name/id; effective date is     17
                   route start date
      Before
               4           3          2                               0        1                         4
           0                                                                                                 2                      8
...
2A, 200
          ...
          S8             1/1/2000         <Null>    1A                        3A              2                  4      No Error
                               ...
                               Recal downstream unchecked
                   Test case 3-b: Transfer to New Line – transfer 1 entire simple route; transfer
                   CP; keep original measures; keep original route name/id; effective date is     18
                   route start date
      After
               4           3          2                               0        1                         4
           0                                                                                                 2                      8
...
                   Test case 4: Transfer to New Line - transfer 1 entire loop;                                                                         19
                   transfer CP; change measures; keep original route name/id
          Before
               4          3                    2                               0        1                         4
           0                                                                                                          2                      8
                                                                                   8
...
3A, 300
          ...
          S8             1/1/2000                  <Null>    1A                        4A              0                  4      No Error
                              ...
                              Effective date is 1/1/2020
                              Recal downstream unchecked
                   Test case 4: Transfer to New Line - transfer 1 entire loop;                                                             20
                   transfer CP; change measures; keep original route name/id
          After
               6          4                    2                           0       1                       4
           2                                                                                                   2                 8
...
2A, 200
          ...
          S8                     1/1/2000        <Null>             1A              3A                    2         4      No Error
                                     ...
                                     Effective date is 1/1/2020
                                     This case has 2 variations. Recal downstream
                                     unchecked in result1, and checked in result 2
              Test case 5: Transfer to New Line – transfer 0.5+1+0.5 simple routes; transfer CP; keep original
              measures; partial routes have to change route name/id – without recalibrate source downstream
                                                                                                                                                22
          After
                                                                      2
          0
...
              Test case 5: Transfer to New Line – transfer 0.5+1+0.5 simple routes; transfer CP; keep original
              measures; partial routes have to change route name/id – recalibrate source downstream
                                                                                                                                                23
          After
                                                                      2
          0
...
2A, 200
          ...
          S8                  1/1/2020             null                   1A_reassign     3A_reassign              3        2      No Error
24
               Test case 5-b: Transfer to New Line – transfer 0.5 route; transfer CP;                                                        25
               change measures; partial route changes route name/id; recalibrate
               source downstream
      Before
               4          3          2                               0        1                         4
           0                                                                                                2                      8
...
                      Test case 5-b: Transfer to New Line – transfer 0.5 route; transfer CP;                                                                 26
                      change measures; partial route changes route name/id; recalibrate
                      source downstream
           After
                      4              3           2                               0        1                         4
...
2A, 200
               ...
               S7                   1/1/2000     <Null>        1A                        3A               3                  2       No Error     record as
                                                                                                                                                  length
...
        Test case 6: Transfer to New Line – transfer 0.5+1 simple routes; transfer                                               27
...
3    1B, 100   5
    ...
    S8             1/1/2000            <Null>        1A              3A                2                     4       No Error
                       ...
                       Effective date is 1/1/2020
                       Recal downstream unchecked
        Test case 6: Transfer to New Line – transfer 0.5+1 simple routes; transfer                                                          28
        CP; change measures; partial routes have to change route name/id
    After                    4                3            2                 0       1                          4
                         0                                                                                          2                          8
                                                                                 8
...
     Test case 7: Transfer to New Line – transfer 3 entire simple routes; source line
     has concurrent routes that have events; transfer CP; change measures on 1                                                                            29
     route; change 1 route name/id
     Before
            4                 3          2                                0       1                           4
        0                                                                                                         2                             8
20                                                                            8
...
23      2                                                                     4                                                                  6
       ...
       Sconc                 1/1/2000         <Null> Conc1          Conc1       21.5                                     30   No Error
                                  ...
                                  Recal downstream unchecked
     Test case 7: Transfer to New Line – transfer 3 entire simple routes; source line
     has concurrent routes that have events; transfer CP; change measures on 1                                                                                 30
     route; change 1 route name/id
     After
            4                     3           2                                0        1                         4
        0                                                                                                             2                              8
...
23      2                                                                          4                                                                  6
      ...
      Event ID                  From Date         To Date From Route ID To Route ID From M                                  To M Location Error
      Sconc                     1/1/2000          <Null> Conc1          Conc1       21.5                                    30   No Error
  Test case 8: Transfer to New Line – transfer 1+0.5 simple routes; routes on source line have
  concurrent routes that have events; routes on source line have multiple time slices; transfer CP;
                                                                                                                                                                    31
  change measures on 0.5 route; partial routes have to change route name/id
                                             Conc1, 100
Before                                       2000-null
...
Sconc2                   1/1/2015      <Null>                 Conc2                     Conc2          17.5                  20     No Error
34
    Test case 8-b: Transfer to New Line – transfer 3 simple routes; routes on source line have multiple                          35
    time slices; not transfer CP
...
2A, 200
  ...
  S8                1/1/2020        <Null>     1A                    3A                2                     4       No Error
                       ...
                       Recal downstream unchecked
    Test case 8-b: Transfer to New Line – transfer 3 simple routes; routes on source line have multiple             36
    time slices; not transfer CP
...
                    Test case 9: Transfer to New Line – transfer 3 entire simple routes;                                                             37
                    transfer CP; keep original measures; keep original route name/id
...
2A, 200
          ...
          S_blue          1/1/2000      <Null> 1B         2B          4                                              5    No Error
                              Effective date is 1/1/2020
                              Recal downstream unchecked
                    Test case 9: Transfer to New Line – transfer 3 entire simple routes;                                                                                      38
                    transfer CP; keep original measures; keep original route name/id
      After
                4           3               2                                         0         1                            4
            0                                                                                                                    2                                  8
...
2A, 200
          ...
          S8c             1/1/2020                  <Null>              3A                              0                            4         No Error
            Event ID       From Date                To Date      From Route ID                To Route ID       From M                To M     Location Error
            S_blue         1/1/2000                 <Null>       1B                           2B                4                     5        No Error
         Test case 9-b: Transfer to New Line – 2 separate transfers; transfer CP;                                                         39
         keep original measures; partial routes change route name/id
...
S8               1/1/2000            <Null>       1A                           2                        8        No Error
                     ...
                     Second transfer is 1/1/2030
                     Recal downstream unchecked
                        Test case 9-b: Transfer to New Line – 2 separate transfers; transfer CP;                                                                            40
                        keep original measures; partial routes change route name/id
        After
                    4                 3               2                                 0       1                              4
                4                                                                                                                  2                              8
...
                   Test case 10: Transfer to New Line – transfer 1 entire simple route; not                                                         41
                   transfer CP; keep original measures; keep original route name/id
...
2A, 200
          ...
          S8c              1/1/2000            <Null>       3A                           0                        4        No Error
                               ...
                               Effective date is 1/1/2020
                               Recal downstream unchecked
                   Test case 10: Transfer to New Line – transfer 1 entire simple route; not                                                            42
                   transfer CP; keep original measures; keep original route name/id
...
2A, 200
          ...
          S8c                        1/1/2000         <Null>             3A                             0             4          No Error
                                      ...
                                      Effective date is 1/1/2020
                                      This case has 2 variations for recal
                                      downstream option.
              Test case 11: Transfer to New Line – transfer 0.5+1+0.5 simple routes; transfer CP; keep original
              measures; partial routes have to change route name/id – without recalibrate source downstream                                   44
...
2A, 200
          ...
          2                                                Gray                 3B          Blue   300     1/1/2000   null       0        4
              0                      2     3       4       line                 1C          Gray   100     1/1/2000   null       2        6
                  ...
                  300
                                                           hidden               3C          Gray   300     1/1/2000   null       6        8
...
              Test case 11: Transfer to New Line – transfer 0.5+1+0.5 simple routes; transfer CP; keep original
              measures; partial routes have to change route name – recalibrate source downstream                                              45
          After                                                                 Rname       Line   Line    From       To Date    From M   To M
              4                      3             2                    2                   Name   Order   Date
          0                                                                     1A          Red    100     1/1/2000   1/1/2020   2        4
                                                                            1
...
46
               Test case 11-b: Transfer to New Line – transfer 0.5 route; transfer CP;                                                             47
               change measures; partial route changes route name/id; recalibrate
               source downstream
      Before
               4          3           2                                 0       1                        4
...
2A, 200
          ...
          S8c             1/1/2000            <Null>       3A                           0                        4        No Error
                              ...
                              Effective date is 1/1/2020
                              Recal downstream checked
                      Test case 11-b: Transfer to New Line – transfer 0.5 route; transfer CP;                                                                        48
                      change measures; partial route changes route name/id; recalibrate
                      source downstream
           After
                      4             3           2                                    0       1                          4
...
2A, 200
               ...
               S8c                  1/1/2000            <Null>         3A                            0                          4         No Error
        Test case 12: Transfer to New Line – transfer 0.5+1 simple routes; transfer                                               49
        CP; change measures; partial routes have to change route name/id
...
3    1B, 100   5
    ...
    S8c                1/1/2000              <Null>           3A                      0              4           No Error
                        ...
                        Effective date is 1/1/2020
                        Recal downstream unchecked
        Test case 12: Transfer to New Line – transfer 0.5+1 simple routes; transfer                                                              50
        CP; change measures; partial routes have to change route name/id
    After                    4                  3             2                         0       1                       4
                         0                                                                                                  2                        8
                                                                                            8
...
     Test case 13: Transfer to New Line – transfer 3 entire simple routes; source line
     has concurrent routes that have events; transfer CP; change measures on 1                                                                                 51
     route; change 1 route name/id
     Before
            4                 3           2                                   0       1                           4
        0                                                                                                             2                              8
...
23      2                                                                         4                                                                   6
       ...
       Sconc                 1/1/2000             <Null> Conc1          Conc1       21.5                                     30   No Error
                                  ...
                                  Recal downstream unchecked
     Test case 13: Transfer to New Line – transfer 3 entire simple routes; source line
     has concurrent routes that have events; transfer CP; change measures on 1                                                                                  52
     route; change 1 route name/id
     After
            4                     3           2                               0       1                           4
        0                                                                                                             2                               8
...
23      2                                                                         4                                                                    6
      ...
      Event ID                  From Date         To Date From Route ID To Route ID From M                                   To M Location Error
      Sconc                     1/1/2000          <Null> Conc1          Conc1       21.5                                     30   No Error
  Test case 14: Transfer to New Line – transfer 1+0.5 simple routes; routes on source line have
  concurrent routes that have events; routes on source line have multiple time slices; transfer CP;
                                                                                                                                                                       53
  change measures on 0.5 route; partial routes have to change route name/id
                                             Conc1, 100
...
Sconc2                   1/1/2015          <Null>                    Conc2                     Conc2          17.5                   20      No Error
56
       Test case 14-b: Transfer to New Line – transfer 3 simple routes; routes on source line have
       multiple time slices; not transfer CP
                                                                                                                                       57
   Before
                4      3          2                                  0       1                         4
            0                                                                                              2                      8
...
                   Test case 15: Transfer to New Line – transfer 3 entire simple routes;                                                           59
                   transfer CP; keep original measures; keep original route name/id
...
2A, 200
          ...
          Star_blue             1/1/2000     <Null>  2B              6.5         No Error
                                   ...
                                   Effective date is 1/1/2020
                                   Recal downstream unchecked
                    Test case 15: Transfer to New Line – transfer 3 entire simple routes;                                                               60
                    transfer CP; keep original measures; keep original route name/id
      After
                4               3           2                                 0       1                         4
            0                                                                                                       2                         8
...
2A, 200
          ...
          Event ID               From Date    To Date Route ID        Measure     Location Error
          Star_blue              1/1/2000     <Null>  2B              6.5         No Error
         Test case 15-b: Transfer to New Line – 2 separate transfers; transfer CP;                                                      61
         keep original measures; partial routes get new route name/id
 ...
 6                                                                 4                                                           6
     ...
     3C                 Gray           300          1/1/2000                null                 6               8
         ...
         Star5           1/1/2000         <Null>      1A                             6                   No Error
                        ...
                        Second transfer is 1/1/2030
                        Recal downstream unchecked
                       Test case 15-b: Transfer to New Line – 2 separate transfers; transfer CP;                                                           62
                       keep original measures; partial routes get new route name/id
        After
                   4                 3           2                               0       1                         4
               4                                                                                                       2                         8
...
                  Test case 16: Transfer to New Line – transfer 1 entire simple route; not                                                       63
                  transfer CP; keep original measures; keep original route name/id
          ...
          2                                                                 4                                                           6
              ...
              3C                 Gray           300          1/1/2000                null                 6               8
                  ...
                  Star5           1/1/2000         <Null>      2A                             2                   No Error
                                 ...
                                 Effective date is 1/1/2020
                                 Recal downstream unchecked
                  Test case 16: Transfer to New Line – transfer 1 entire simple route; not                                                        64
                  transfer CP; keep original measures; keep original route name/id
...
2A, 200
          ...
          2                                                                  4                                                           6
              ...
              3C                 Gray           300           1/1/2000                null                 6               8
                  ...
                  Star5           1/1/2000         <Null>       2A                             2 ??                No Error
                  Test case 16-b: Transfer to New Line – transfer 1 entire simple route;                                                         65
                  transfer CP; keep original measures; keep original route name/id; effective
          ...
          2                                                                 4                                                           6
              ...
              3C                 Gray           300          1/1/2000                null                 6               8
                  ...
                  Star5           1/1/2000         <Null>      2A                             2                   No Error
                                 ...
                                 Effective date is 1/1/2000
                                 Recal downstream unchecked
                  Test case 16-b: Transfer to New Line – transfer 1 entire simple route;                                              66
                  transfer CP; keep original measures; keep original route name/id; effective
                  date is route start date
      After
              4           3          2                                0       1                       4
...
2A, 200
          ...
          2                                                               4                                                  6
              ...
              3C              Gray        300              1/1/2000                null        6           8
               ...
               Star4            1/1/2000      <Null>         3A                           4          No Error
               Star5            1/1/2000      <Null>         2A                           2 ??       No Error
       Test case 17: Transfer to New Line – transfer 0.5+1 simple routes; not                                                   67
       transfer CP; change measures; partial routes have to change route name/id
...
3    1B, 100 1.25
      ...
      3C                    Gray                300              1/1/2000      null          6                       8
       ...
       Star5                   1/1/2000            <Null>         2A                   2                       No Error
                            ...
                            Effective date is 1/1/2020
                            Recal downstream unchecked
        Test case 17: Transfer to New Line – transfer 0.5+1 simple routes; not                                                          68
        transfer CP; change measures; partial routes have to change route name/id
...
              Test case 17-b: Transfer to New Line – transfer 0.5 route; transfer CP;                                                            69
              change measures; partial route gets new route name/id; recalibrate
              source downstream
      Before
              4              3          2                               0       1                         4
          0                                                                                                   2                        8
          ...
          2                                                                 4                                                           6
              ...
              3C                 Gray           300          1/1/2000                null                 6               8
                  ...
                  Star5           1/1/2000         <Null>      2A                             2                   No Error
                                 ...
                                 Effective date is 1/1/2020
                                 Recal downstream checked
                      Test case 17-b: Transfer to New Line – transfer 0.5 route; transfer CP;                                                                70
                      change measures; partial route gets new route name/id; recalibrate
                      source downstream
           After
                      4              3           2                                 0       1                         4
...
     Test case 18: Transfer to New Line – transfer 3 entire simple routes; source line
     has concurrent routes that have events; transfer CP; change measures on 1                                                                         71
     route; change 1 route name/id
     Before
            4                 3          2                              0       1                           4
        0                                                                                                       2                            8
...
23      2                                                                   4                                                                 6
            ...
            Star_conc             1/1/2000       <Null>       Conc1                           22                      No Error
                                  ...
                                  Recal downstream unchecked
     Test case 18: Transfer to New Line – transfer 3 entire simple routes; source line
     has concurrent routes that have events; transfer CP; change measures on 1                                                                              72
     route; change 1 route name/id
     After
            4                     3           2                             0       1                           4
        0                                                                                                           2                             8
...
23      2                                                                       4                                                                  6
            2                            8    10                                                                2                3            4
                23                            30
                 ...
                 Event ID                From Date    To Date      Route ID                       Measure                   Location Error
                 Star_conc               1/1/2000     <Null>       Conc1                          22                        No Error
  Test case 19: Transfer to New Line – transfer 1+0.5 simple routes; routes on source line have
  concurrent routes that have events; routes on source line have multiple time slices; transfer CP;
                                                                                                                                                                      73
  change measures on 0.5 route; partial routes have to change route name/id
