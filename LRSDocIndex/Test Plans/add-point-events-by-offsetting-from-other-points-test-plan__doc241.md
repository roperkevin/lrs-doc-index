...
| **Kind** | Test Plan · Pro |
| **Release** | — |
| **Issue** | [ArcGISPro/ps-location-referencing#3906](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/3906) |
...
<!-- metadata
```yaml
title: "Add Point Events by offsetting from other points – Test Plan"
source_file: "3906_AddPointEventsPointOffset_testplan.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/3906_AddPointEventsPointOffset_testplan.pptx"
doc_id: 241
doc_kind: "Test Plan"
surface: "Pro"
doc_revision: ""
...
last_edited: "2025-01-21T23:45:47Z"
...
products: []
issues: ["ArcGISPro/ps-location-referencing#3906"]
related: [{"doc":231,"file":"add-line-events-by-offsetting-from-other-points-test-plan__doc231.md","s":1011.161},{"doc":48,"file":"location-offset-method-in-add-point-and-add-line-widgets-test-plan__doc48.md","s":5.684},{"doc":268,"file":"add-line-events-point-offset-method__doc268.md","s":5.023},{"doc":234,"file":"add-point-events-by-location-offset__doc234.md","s":4.967},{"doc":272,"file":"add-point-event-point-offset-method__doc272.md","s":4.63}]
```
-->
...
<!-- related:begin -->
- [Add Line Events by offsetting from other points – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/add-line-events-by-offsetting-from-other-points-test-plan__doc231.md>) — shared issue ArcGISPro/ps-location-referencing#3906 · similar text 0.66 · 5 title words · 4 filename words · same kind/surface/pe/dev/folder <!-- rel:231 -->
- [Location Offset Method in Add Point and Add Line Widgets Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/location-offset-method-in-add-point-and-add-line-widgets-test-plan__doc48.md>) — similar text 0.58 · 2 title words · 2 filename words · same kind/folder <!-- rel:48 -->
- [Add Line Events Point Offset Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-events-point-offset-method__doc268.md>) — similar text 0.41 · 3 title words · 3 filename words · same surface <!-- rel:268 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset__doc234.md>) — similar text 0.16 · 3 title words · 4 filename words · same surface <!-- rel:234 -->
- [Add Point Event Point Offset Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-point-event-point-offset-method__doc272.md>) — similar text 0.35 · 2 title words · 3 filename words · same surface <!-- rel:272 -->
<!-- related:end -->
...
## Slide 1 — Add Point Events by offsetting from other points – Test Plan
...
![Interface screenshot redrawn as a standardized wireframe: 3 panels, 4 fields, 1 button, 2 colour blocks, 5 icons, 32 text rows. 25 of 32 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide2_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 7 fields, 1 colour block, 7 icons, 22 text rows. 17 of 22 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide2_fig2.svg)
...
![image1.png](../media/doc749_image1.png) ![image2.png](../media/doc749_image2.png)

## Slide 3

![Interface screenshot redrawn as a standardized wireframe: 3 panels, 4 fields, 1 button, 2 colour blocks, 5 icons, 32 text rows. 25 of 32 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide3.svg)
...
![image3.png](../media/doc749_image3.png) ![image2.png](../media/doc749_image2.png)

## Slide 4

![Interface screenshot redrawn as a standardized wireframe: 3 panels, 4 fields, 1 button, 2 colour blocks, 5 icons, 32 text rows. 25 of 32 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide4.svg)
...
![image2.png](../media/doc749_image2.png)

## Slide 5

![Interface screenshot redrawn as a standardized wireframe: 3 panels, 4 fields, 1 button, 2 colour blocks, 5 icons, 32 text rows. 25 of 32 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide5.svg)
...
## Positive Cases <!-- slide 8 -->

### Continuous – Single Field RID
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide10.svg)
...
![image4.png](../media/doc749_image4.png) ![image5.png](../media/doc749_image5.png)

## Slide 11

![Diagram drawn from the slide's own shapes: 3 nodes (R2), 2 connectors.](../media/doc749_slide11.svg)
...
![image7.png](../media/doc749_image7.png)
...
![Diagram drawn from the slide's own shapes: 2 nodes (R3), 6 connectors.](../media/doc749_slide12.svg)

| EventID | RouteName | Measure | Referent Method | ReferentID | Referent Offset | From Date | ToDate | Sign Type |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sign3 | R3 | 1.502903 | C1 network | {R0003- | 1.502903 (mi) | 1/1/2000 |  | Stop Sign |

![image9.png](../media/doc749_image9.png)
...
![Diagram drawn from the slide's own shapes: 2 nodes (CS2), 6 connectors.](../media/doc749_slide13.svg)

| EventID | RouteID | Measure | From Date | ToDate | Friction System |
| --- | --- | --- | --- | --- | --- |
| Friction2 | CS2 | 2 | 1/1/2000 |  | X |

![image5.png](../media/doc749_image5.png)

## Slide 14

![Interface screenshot redrawn as a standardized wireframe: 2 colour blocks, 2 icons, 4 text rows. Text inside a screenshot is pixels, so text rows render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide14.svg)
...
![image4.png](../media/doc749_image4.png) ![image11.png](../media/doc749_image11.png)
...
![Diagram drawn from the slide's own shapes: 2 nodes (CM00B), 2 connectors.](../media/doc749_slide15_fig1.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 2 colour blocks, 2 icons, 4 text rows. Text inside a screenshot is pixels, so text rows render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc749_slide15_fig2.svg)

| EventID | RouteID | Measure | From Date | ToDate | NBI |
| --- | --- | --- | --- | --- | --- |
| Bridge1 | CM00B | 2 | 1/1/2000 |  | 96 |

![image9.png](../media/doc749_image9.png) ![image11.png](../media/doc749_image11.png)

## Slide 16

![Diagram drawn from the slide's own shapes: 3 nodes (L1R1, L1R2), 2 connectors.](../media/doc749_slide16.svg)
...
![image13.png](../media/doc749_image13.png)

## Slide 17

![Diagram drawn from the slide's own shapes: 3 nodes (L2R1, L2R2), 2 connectors.](../media/doc749_slide17.svg)
...
![image13.png](../media/doc749_image13.png) ![image9.png](../media/doc749_image9.png)
...
![Diagram drawn from the slide's own shapes: 3 nodes (L3R1, L3R2), 5 connectors.](../media/doc749_slide18.svg)
...
![Diagram drawn from the slide's own shapes: 4 nodes (L4R1, L4R2), 5 connectors.](../media/doc749_slide19.svg)
