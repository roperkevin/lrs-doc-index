...
<!-- metadata
```yaml
title: "Allow Append Events to Run When Locks Are Present - Test Plan"
source_file: "AllowAppendEvents_ConflictPreventionOptional_Testplan.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/AllowAppendEvents_ConflictPreventionOptional_Testplan.pptx"
doc_id: 156
doc_kind: "Test Plan"
surface: "Pro"
doc_revision: ""
...
last_edited: "2025-07-07T14:19:55Z"
...
related: [{"doc":124,"file":"append-events-location-referencing__doc124.md","s":1003.366},{"doc":155,"file":"allow-lrs-intersections-to-be-updated-without-locking-intersecting-routes-test__doc155.md","s":7.881},{"doc":168,"file":"allow-append-events-to-run-when-locks-are-present-on-impacted-routes__doc168.md","s":7.146},{"doc":279,"file":"consider-route-dominance-in-append-events-add-method-test-plan__doc279.md","s":5.654},{"doc":278,"file":"consider-route-dominance-in-append-events-test-plan__doc278.md","s":5.434}]
```
-->
...
<!-- related:begin -->
- [Append Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/append-events-location-referencing__doc124.md>) — shared issue ArcGISPro/ps-location-referencing#6640 · similar text 0.16 · 2 title words · 2 filename words · same surface <!-- rel:124 -->
- [Allow LRS Intersections to be updated without locking intersecting routes - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/allow-lrs-intersections-to-be-updated-without-locking-intersecting-routes-test__doc155.md>) — similar text 0.58 · 1 title word · 2 filename words · same kind/surface/pe/dev/folder <!-- rel:155 -->
- [Allow Append Events to Run When Locks Are Present on Impacted Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/allow-append-events-to-run-when-locks-are-present-on-impacted-routes__doc168.md>) — similar text 0.33 · 6 title words · 3 filename words · same surface <!-- rel:168 -->
- [Consider Route Dominance in Append Events (add method) – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/consider-route-dominance-in-append-events-add-method-test-plan__doc279.md>) — similar text 0.23 · 2 title words · 3 filename words · same kind/surface/folder <!-- rel:279 -->
- [Consider Route Dominance in Append Events Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/consider-route-dominance-in-append-events-test-plan__doc278.md>) — similar text 0.24 · 2 title words · 3 filename words · same kind/pe/folder <!-- rel:278 -->
<!-- related:end -->
...
| 5 | Append point event check add to dominant route , subordinate route only locked – any method(having concurrencies with time slices) Time and location overlap scenario | Append events , no warning message provided |
...
| 12 | Append line event check add to dominant route , subordinate route only locked – any method (having concurrencies with time slices) Time and location overlap scenario | Append events , no warning message provided |
| 13 | Append line event check add to dominant route , dominant route only locked – any method(having concurrencies with time slices) Time and location overlap scenario | Append events , warning message for dominant route is provided |
...
| 18 | Append spanning line event check add to dominant route , subordinate route only locked – any method (having concurrencies with time slices) Time and location overlap scenario | Append events , no warning message provided |
| 19 | Append spanning line event check add to dominant route , dominant route only locked – any method (having concurrencies with time slices) Time and location overlap scenario | Append events , warning message for dominant route & line is provided |
...
| 32 | Add line event on unlocked route – any method | Acquire lock and append events Show the message of acquiring lock |
| 33 | Add spanning line event on unlocked route – any method | Acquire lock and append events Show the message of acquiring lock |
