...
| Field | Value |
| --- | --- |
| **Doc** | 513 · Test Plan · Pro |
| **Product** | — |
| **Release** | — |
| **Issues** | — |
| **Source** | [ExportNetwork_ReassignTransfer_TestPlanV1.pdf](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/ExportNetwork_ReassignTransfer_TestPlanV1.pdf>) · rev V1 |
...
<!-- related:begin -->
- [Reassign - Transfer to Another Line with StayPut and Retire Event Behavior - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/5140-reassign-transfer-to-another-line-with-stayput-and-retire-eb.md>) — similar text 0.07 · 2 title words · 1 filename word · same kind/surface/folder <!-- rel:528 s=4.787 -->
- [Reassign Route Transfer to Another Line Method: Support Move Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5141-reassign-route-transfer-to-another-line-method-support-move.md>) — similar text 0.08 · 2 title words · 1 filename word · same kind/surface/folder <!-- rel:533 s=3.818 -->
- [Reassign Route AI Assistant Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/7039-reassign-route-ai-assistant.md>) — similar text 0.03 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:34 s=3.621 -->
- [Reassign UI Existing Line Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-ui-existing-line.md>) — similar text 0.06 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:535 s=3.248 -->
- [Reassign Routes to Another Line with Original Route ID/Name Maintenance - REST Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/reassign-routes-to-another-line-with-original-route-id-name.md>) — similar text 0.09 · 1 title word · 1 filename word · same kind/folder <!-- rel:542 s=3.22 -->
<!-- related:end -->
...
Edit Log
<?xml version="1.0"?> <RouteEditModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"
...
SourceRouteId=“3A"
TargetRouteId=“3A"/></ReassignedSegments><ReassignedRouteStates/></RouteEditActi vity></RouteEditModel>
...
Ask Nathan for the Pima county data that supports lines to test concurrency.
...
change new route names

Reassign more than one route for source in both
               PoM and Line
               Networks
Middle routes should be considered for testing

Test with more than one retired route
