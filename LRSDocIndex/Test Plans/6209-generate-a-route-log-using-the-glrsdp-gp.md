...
| Field | Value |
| --- | --- |
| **Doc** | 260 · Test Plan · Pro |
| **Product** | — |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#6209](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/6209) |
...
<!-- related:begin -->
- [Sample Route Log](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/sample-route-log.md>) — similar text 0.69 · 2 title words · 2 filename words · same surface <!-- rel:283 s=8.415 -->
- [Generate a route Log including spanning events and centerline – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/6240-generate-a-route-log-including-spanning-events.md>) — similar text 0.30 · 3 title words · 3 filename words · same kind/surface/dev/folder <!-- rel:255 s=8.23 -->
- [Transform LRS Data GP tool: Summarize by polygon boundaries – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5744-transform-lrs-data-gp-summarize-by-polygon-boundaries.md>) — similar text 0.32 · 1 title word · 1 filename word · same kind/surface/pe/dev/folder <!-- rel:359 s=7.145 -->
- [Route Log data product template – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/6203-route-log-data-product-template.md>) — similar text 0.23 · 2 title words · 3 filename words · same kind/surface/folder <!-- rel:256 s=5.87 -->
- [Transform LRS Data GP tool – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5742-transform-lrs-data-gp.md>) — similar text 0.18 · 1 title word · 1 filename word · same kind/surface/dev/folder <!-- rel:372 s=4.965 -->
<!-- related:end -->
...
### Slide 1 — Generate a route Log using the GLRSDP GP tool – Test Plan <!-- slide 1 -->
...
**Steps:**
1. Verify that Generate LRS Data Product geoprocessing tool accept LRS data template created for the route log.
2. Verify that the below are hidden for the route log template
   - *Units. Change this to an optional field as its not used for this product type
   - Summary Layer
   - Summary Field
   - Exclude null summary rows

### TC-N01 — Routes does not exist for the provided date. <!-- src: S4 · slide 3 · Negative cases · 1 -->

### TC-U02 — One Line Event log field <!-- src: S2 · slide 5 · case 1 -->
...
![Figure 2 — TC1 – One Line Event log field](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-02-slide-05-tc1-one-line-event-log-field.png)

### TC-U03 — Multiple Line Event log fields <!-- src: S2 · slide 6 · case 2 -->
...
### TC-U04 — Point Event & Intersections log fields <!-- src: S2 · slide 7 · case 3 -->

| Route ID | Description | Measure | Sign Type | Intersection |
| --- | --- | --- | --- | --- |
| RouteA | Begin RouteA | 0 |  |  |
| RouteA | Intersecting<br>RouteA , Route1 | 0 |  | RouteA , Route1 |
| RouteA | Sign Speed Limit 65 | 1.4 | Speed Limit |  |
| RouteA | Sign Stop | 2.5 | Stop |  |
| RouteA | Intersecting<br>RouteA , Route2 | 2.5 |  | RouteA , Route2 |
| RouteA | Sign Speed Limit 40 | 7.5 | Speed Limit |  |
| RouteA | Intersecting<br>RouteA , Route3 | 10 |  | RouteA , Route3 |
| RouteA | End RouteA | 10 |  |  |
| Route1 | Begin Route1 | 2.2 |  |  |
| Route1 | Intersecting<br>RouteA , Route1 | 5.2 |  | RouteA , Route1 |
| Route1 | End Route1 | 7.2 |  |  |
| Route2 | Begin Route2 | 0 |  |  |
| Route2 | Intersecting<br>RouteA , Route2 | 2 |  | RouteA , Route2 |
| Route2 | End Route2 | 2 |  |  |
| Route3 | Begin Route3 | 0 |  |  |
| Route3 | Intersecting<br>RouteA , Route3 | 2 |  | RouteA , Route3 |
| Route3 | End Route3 | 5 |  |  |
...
### TC-U05 — Location fields <!-- src: S2 · slide 8 · case 4 -->

| Route ID | Description | Measure | County | City |
| --- | --- | --- | --- | --- |
| RouteA | Begin RouteA | 0 | Union | Titan |
| RouteA | End City Limit<br>Titan | 3.6 | Union | Titan |
| RouteA | Start City Limit<br>Mega One | 3.6 | Union | Mega One |
...
### TC-U06 — Point Event & Intersections log fields with Referents <!-- src: S2 · slide 9 · case 5 -->

| Route ID | Description | Measure | Referent | Offset | Sign Type | Intersection |
| --- | --- | --- | --- | --- | --- | --- |
| RouteA | Begin RouteA | 0 | Mile 0 | 0 |  |  |
| RouteA | Intersecting<br>RouteA , Route1 | 0 | Mile 0 | 0 |  | RouteA , Route1 |
...
| RouteA | Intersecting<br>RouteA , Route2 | 2.5 | Mile 2 | 2640 |  | RouteA , Route2 |
...
| RouteA | Intersecting<br>RouteA , Route3 | 10 | Mile 10 | 0 |  | RouteA , Route3 |
...
![Figure 3 — TC5 – Point Event & Intersections log fields with Referents](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-03-slide-09-tc5-point-event-and-intersections-log.png)

### TC-U07 — Line Event log fields with Referents <!-- src: S2 · slide 10 · case 5 -->
...
### TC-U08 — Loop route with Point, Line and Location fields (case 6) <!-- src: S2 · slide 11 · case 6 -->
...
![Figure 4 — TC6 - Loop route with Point, Line and Location fields](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-04-slide-11-tc6-loop-route-with-point-line.svg)

### TC-U09 — Loop route with Point, Line and Location fields (case 7) <!-- src: S2 · slide 12 · case 7 -->
...
![Figure 5 — TC7 - Loop route with Point, Line and Location fields](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-05-slide-12-tc7-loop-route-with-point-line.svg)

### TC-U10 — Line Network routes with Point, Line and Location fields <!-- src: S2 · slide 13 · case 8 -->
...
[figure: R1L1 · R2L1 · R3L1 · 2 · 0 · 2.1 · 4.1 · 4.2 · 6.2 · Orion county · Template Details :]

![Figure 6 — TC8 – Line Network routes with Point, Line and Location fields](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-06-slide-13-tc8-line-network-routes-with-point-line.svg)

### TC-U11 — Location fields with boundaries missing <!-- src: S2 · slide 16 · case 10 -->

| Route ID | Description | Measure | County | City |
| --- | --- | --- | --- | --- |
| RouteA | Begin RouteA | 0 | Union | Unclassified |
| RouteA | Begin City Limit<br>Mega One | 3.6 | Union | Mega One |
| RouteA | End City Limit<br>Mega One | 9.3 | Union | Mega One |
...
![Figure 7 — TC10 – Location fields with boundaries missing](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-07-slide-16-tc10-location-fields-with-boundaries.png)
...
![Figure 1 — 2](../media/6209-generate-a-route-log-using-the-glrsdp-gp/fig-01-slide-02-2.png)
