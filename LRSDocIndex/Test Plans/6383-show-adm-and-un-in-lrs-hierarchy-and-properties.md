...
| Field | Value |
| --- | --- |
| **Doc** | 159 · Test Plan · Pro |
| **Product** | Roads & Highways · Pipeline Referencing · Utility Network |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#6383](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/6383) |
...
<!-- related:begin -->
- [LRS Addressing and Utility Network Properties User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/lrs-addressing-and-un-properties.md>) — similar text 0.55 · 1 title word · 1 filename word · same surface <!-- rel:190 s=5.484 -->
- [Configure Addressing Feature Classes GP Tool Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5572-configure-addressing-feature-classes-gp.md>) — similar text 0.26 · same kind/surface/folder <!-- rel:424 s=3.08 -->
- [LRS Intersection Properties User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/lrs-intersection-properties.md>) — similar text 0.27 · 1 title word · 1 filename word · same surface <!-- rel:843 s=2.824 -->
- [View the LRS hierarchy](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/7300-view-the-lrs-hierarchy.md>) — similar text 0.21 · 1 title word · 1 filename word · same surface <!-- rel:65 s=2.801 -->
- [Route Dominance Properties User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/route-dominance-properties.md>) — similar text 0.25 · 1 title word · 1 filename word · same surface <!-- rel:699 s=2.767 -->
<!-- related:end -->
...
![Figure 1 — 2](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-01-slide-02-2.png)
![Figure 2 — 2](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-02-slide-02-2.png)
![Figure 3 — 2](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-03-slide-02-2.png)
![Figure 4 — 2](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-04-slide-02-2.png)
![Figure 5 — 2](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-05-slide-02-2.png)
![Figure 6 — 2](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-06-slide-02-2.png)
...
![Figure 7 — 3](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-07-slide-03-3.png)
![Figure 8 — 3](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-08-slide-03-3.png)
![Figure 9 — 3](../media/6383-show-adm-and-un-in-lrs-hierarchy-and-properties/fig-09-slide-03-3.png)
