...
| Field | Value |
| --- | --- |
| **Doc** | 620 · Test Plan · Pro |
| **Product** | — |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#4483](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/4483) |
| **Source** | [4483-SupportTranslationBetweenRouteIdandRouteName_TestPlan_V3.pptx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/4483-SupportTranslationBetweenRouteIdandRouteName_TestPlan_V3.pptx>) · rev V3 |
...
<!-- related:begin -->
- [Support Translation Between RouteID and RouteName (and Between LRS Networks) Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/4483-support-translation-between-routeid-and-routename-v1.md>) — shared issue ArcGISPro/ps-location-referencing#4483 · similar text 0.95 · 6 title words · 5 filename words · same kind/surface <!-- rel:640 s=1010.176 -->
- [Translate tool for ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/translate-tool-for-pro.md>) — similar text 0.49 · same surface <!-- rel:644 s=3.892 -->
- [Change Route/Line Name Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/837-change-route-line-name.md>) — similar text 0.16 · 2 filename words · same kind/surface/folder <!-- rel:637 s=3.564 -->
- [Generate a route Log including spanning events and centerline – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/6240-generate-a-route-log-including-spanning-events.md>) — similar text 0.05 · 1 filename word · same kind/surface/folder <!-- rel:255 s=3.101 -->
- [LRS Data Template Preview – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5814-lrs-data-template-preview.md>) — similar text 0.15 · same kind/surface/folder <!-- rel:355 s=2.937 -->
<!-- related:end -->
...
### TC-P18 — Check if multiple items can be copied to the clipboard and then pasted. <!-- src: S4 · slide 2 · Positive Tests: All Components (Continued) · 8 -->

- **Group:** All Components (Continued)
- **Case:** Check if multiple items can be copied to the clipboard and then pasted. For example, RouteID and RouteName.

### TC-P19 — Component works only with networks from FS and EGDB DC. (2) <!-- src: S4 · slide 2 · Positive Tests: Translate LineID and Line Name · 1 -->

- **Group:** Translate LineID and Line Name

### TC-P20 — Lines radio button is disabled when network’s Line Name is not configured. <!-- src: S4 · slide 2 · Positive Tests: Translate LineID and Line Name · 2 -->

- **Group:** Translate LineID and Line Name

### TC-P21 — If the network layer is turned off (2) <!-- src: S4 · slide 2 · Positive Tests: Translate LineID and Line Name · 3 -->
...
### TC-P22 — Component works with FS, EGDB DC, and FGDB. <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 1 -->

- **Group:** Translate Measures

### TC-P23 — Select From and To Networks <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 2 -->
...
### TC-P24 — Type the RouteName/RouteID in the From Network section and upon losing focus <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 3 -->
...
### TC-P25 — The RouteName/RouteID of the From/To Network sections will always be in sync. <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 4 -->

- **Group:** Translate Measures

### TC-P26 — From and To Network are same network <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 5 -->

- **Group:** Translate Measures
- **Case:** From and To Network are same network, allowing for measure translation between overlapping routes.

### TC-P27 — When using the same From and To Network <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 6 -->

- **Group:** Translate Measures
- **Case:** When using the same From and To Network, a modal window will appear for intersecting routes, overlapping routes, and time slices showing these fields: Network, RouteID, Route Name, From Date, and To Date.

### TC-P28 — From and To Network are different networks with different measurement units. <!-- src: S4 · slide 2 · Positive Tests: Translate Measures · 7 -->
...
![Figure 1 — Devtopia Issue Link](../media/4483-support-translation-between-routeid-and-routename-v3/fig-01-slide-01-devtopia-issue-link.png)
