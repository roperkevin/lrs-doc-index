...
<!-- related:begin -->
- [Create LRS Intersection From Existing Feature Class Geoprocessing Tool](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-lrs-intersection-from-existing-feature-class-gp.md>) — similar text 0.60 · 5 title words · same surface/folder <!-- rel:881 s=5.882 -->
- [Create LRS Intersection Geoprocessing Tool User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-lrs-intersection-gp.md>) — similar text 0.63 · 3 title words · same surface/folder <!-- rel:882 s=4.618 -->
- [Support a single summary field in LRS Data Template wizard – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5774-support-a-single-summary-field-in-lrs-data-template-wizard.md>) — similar text 0.18 · same kind/surface <!-- rel:347 s=2.981 -->
- [Test Plan : Registering](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/registering.md>) — similar text 0.23 · same kind/surface <!-- rel:89 s=2.602 -->
- [LR Feature Classes Inside Feature Dataset Housing LRCD User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/lr-feature-classes-inside-feature-dataset-housing-lrcd.md>) — similar text 0.13 · 1 title word · same surface/folder <!-- rel:870 s=2.592 -->
<!-- related:end -->
...
## Slide 1 — Modify LRS Intersection Feature Class Geoprocessing Tool
...
![Figure 1 — The Intersection FC should be a registered intersection with the LRS. If not show error.](../media/modify-lrs-intersection-feature-class-gp/fig-01-slide-02-the-intersection-fc-should-be.png)
...
![Figure 2](../media/modify-lrs-intersection-feature-class-gp/fig-02-slide-04.png)
...
![Figure 3 — SQL Server, Oracle and FGDB](../media/modify-lrs-intersection-feature-class-gp/fig-03-slide-05-sql-server-oracle-and-fgdb.jpg)
![Figure 4 — SQL Server, Oracle and FGDB](../media/modify-lrs-intersection-feature-class-gp/fig-04-slide-05-sql-server-oracle-and-fgdb.png)
![Figure 5 — SQL Server, Oracle and FGDB](../media/modify-lrs-intersection-feature-class-gp/fig-05-slide-05-sql-server-oracle-and-fgdb.png)
...
![Figure 6 — Get the error codes from the Dev and get them added to the excel](../media/modify-lrs-intersection-feature-class-gp/fig-06-slide-06-get-the-error-codes-from-the-dev-and-get.jpg)
...
![Figure 7 — Estimate:](../media/modify-lrs-intersection-feature-class-gp/fig-07-slide-07-estimate.png)
