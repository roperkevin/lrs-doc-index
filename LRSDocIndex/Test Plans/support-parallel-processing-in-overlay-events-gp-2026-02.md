...
<!-- related:begin -->
- [Support Parallel Processing in Overlay Events GP Tool Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/support-parallel-processing-in-overlay-events-gp-2026-02-2.md>) — similar text 1.00 · 6 title words · 5 filename words · same kind/surface/folder <!-- rel:54 s=13.343 -->
- [Overlay Event Performance Improvements using Async tool and parallel processing – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/6379-overlay-event-performance-improvements-using-async-tool.md>) — similar text 0.20 · 4 title words · 2 filename words · same kind/surface/folder <!-- rel:160 s=5.972 -->
- [Overlay Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/7061-overlay-events-lr.md>) — similar text 0.20 · 2 title words · 4 filename words · same surface <!-- rel:66 s=4.949 -->
- [Use Async GP tool in Overlay Events for Feature Services](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/use-async-gp-in-overlay-events-for-feature-services.md>) — similar text 0.35 · 3 title words · 2 filename words · same surface <!-- rel:179 s=4.468 -->
- [Support performance improvements in Overlay Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/6954-support-performance-improvements-in-overlay-events.md>) — similar text 0.19 · 3 title words · 2 filename words · same surface <!-- rel:99 s=4.051 -->
<!-- related:end -->
...
![Figure 1 — Notes](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-01-slide-02-notes.svg)
...
![Figure 2 — Benchmark Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-02-slide-03-benchmark-performance-tests.svg)
...
![Figure 3 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-03-slide-04-parallel-processing-performance-tests.svg)
...
![Figure 4 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-04-slide-05-parallel-processing-performance-tests.svg)
...
![Figure 5 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-05-slide-06-parallel-processing-performance-tests.svg)
...
![Figure 6 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-06-slide-07-parallel-processing-performance-tests.svg)
...
![Figure 7 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-07-slide-08-parallel-processing-performance-tests.svg)
...
![Figure 8 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-08-slide-09-parallel-processing-performance-tests.svg)
...
![Figure 9 — Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-09-slide-10-parallel-processing-performance-tests.svg)
...
![Figure 10 — Parallel Processing - Functional Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-10-slide-11-parallel-processing-functional-tests.svg)
...
![Figure 11 — Parallel Processing - Functional Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-11-slide-12-parallel-processing-functional-tests.svg)
...
![Figure 12 — Negative Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-12-slide-13-negative-tests.svg)
...
![Figure 13 — Without Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-13-slide-14-without-parallel-processing-performance.svg)
...
![Figure 14 — Without Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-14-slide-15-without-parallel-processing-performance.svg)
...
![Figure 15 — Without Parallel Processing Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-15-slide-16-without-parallel-processing-performance.svg)
...
![Figure 16 — Line Network Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-16-slide-17-line-network-performance-tests.svg)
...
![Figure 17 — Line Network Performance Tests](../media/support-parallel-processing-in-overlay-events-gp-2026-02/fig-17-slide-18-line-network-performance-tests.svg)
