...
<!-- metadata
```yaml
title: "Reassign Routes to Another Line with Original Route ID/Name Maintenance - REST Test Plan"
source_file: "Reassign_REST_5044.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/Reassign_REST_5044.pptx"
doc_id: 542
doc_kind: "Test Plan"
surface: "Server"
doc_revision: ""
...
last_edited: "2023-06-21T22:16:07Z"
...
products: []
issues: []
related: [{"doc":538,"file":"reassign-route-supporting-transferring-to-another-line-test-plan__doc538.md","s":5.999},{"doc":607,"file":"reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc607.md","s":5.558},{"doc":594,"file":"reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc594.md","s":5.459},{"doc":535,"file":"reassign-ui-existing-line-test-plan__doc535.md","s":4.657},{"doc":533,"file":"reassign-route-transfer-to-another-line-method-support-move-event-behavior-test__doc533.md","s":4.515}]
```
-->
...
<!-- related:begin -->
- [Reassign Route Supporting Transferring to Another Line - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-route-supporting-transferring-to-another-line-test-plan__doc538.md>) — similar text 0.35 · 4 title words · 1 filename word · same kind/folder <!-- rel:538 -->
- [Reassign to a new or existing line with original Route ID/Name maintained on the target line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc607.md>) — similar text 0.30 · 6 title words · 2 filename words · same surface <!-- rel:607 -->
- [Reassign to a New or Existing Line with Original Route ID/Name Maintained on the Target Line - REST](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/reassign-to-a-new-or-existing-line-with-original-route-id-name-maintained-on__doc594.md>) — similar text 0.29 · 6 title words · 2 filename words · same surface <!-- rel:594 -->
- [Reassign UI Existing Line Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-ui-existing-line-test-plan__doc535.md>) — similar text 0.36 · 2 title words · 1 filename word · same kind/folder <!-- rel:535 -->
- [Reassign Route Transfer to Another Line Method: Support Move Event Behavior Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-route-transfer-to-another-line-method-support-move-event-behavior-test__doc533.md>) — similar text 0.26 · 4 title words · 1 filename word · same kind/folder <!-- rel:533 -->
<!-- related:end -->
...
## Slide 1 — Transfer to another line with original Route ID/Name being able to maintain on the target line - REST
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide11.svg)
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide27.svg)
...
![image9.png](../media/doc398_image9.png)
...
![image10.png](../media/doc398_image10.png)
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide31.svg)
...
![image11.png](../media/doc398_image11.png)

## Slide 32

![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide32.svg)
...
![image12.png](../media/doc398_image12.png)
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide33.svg)
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide34.svg)
...
![Route diagram vector-traced from the slide's pasted picture; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide35.svg)
...
![image13.png](../media/doc398_image13.png)
...
![image14.png](../media/doc398_image14.png)
...
![image16.png](../media/doc398_image16.png)
...
![image17.png](../media/doc398_image17.png)
...
![image18.png](../media/doc398_image18.png)
...
![image19.png](../media/doc398_image19.png)
...
![image20.png](../media/doc398_image20.png)
...
![Interface screenshot redrawn as a standardized wireframe: 10 buttons, 2 row separators, 48 icons, 51 text rows. 51 of 51 text rows carry text transcribed from the screenshot (OCR, approximate); positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide54.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 8 buttons, 5 icons, 25 text rows. 16 of 25 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide58.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 5 buttons, 2 row separators, 3 icons, 22 text rows. 13 of 22 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide59_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 8 buttons, 5 icons, 25 text rows. 15 of 25 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide59_fig2.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 6 buttons, 2 row separators, 3 icons, 18 text rows. 12 of 18 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide60_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 8 buttons, 5 icons, 25 text rows. 18 of 25 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide60_fig2.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 8 buttons, 5 icons, 25 text rows. 18 of 25 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide61_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 4 buttons, 2 row separators, 3 icons, 20 text rows. 12 of 20 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide61_fig2.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 2 buttons, 2 row separators, 4 icons, 18 text rows. 12 of 18 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide62_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 8 buttons, 5 icons, 25 text rows. 18 of 25 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide62_fig2.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 9 buttons, 1 colour block, 2 row separators, 4 icons, 15 text rows. 8 of 15 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide63_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 3 buttons, 3 icons, 22 text rows. 14 of 22 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide63_fig2.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 3 buttons, 3 icons, 22 text rows. 14 of 22 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide64_fig1.svg)
![Interface screenshot redrawn as a standardized wireframe: 5 buttons, 2 row separators, 3 icons, 21 text rows. 16 of 21 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide64_fig2.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 4 icons, 17 text rows. 17 of 17 text rows carry text transcribed from the screenshot (OCR, approximate); positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc398_slide66_fig2.svg)
...
![Diagram drawn from the slide's own shapes: 2 nodes (New Line), 1 connector.](../media/doc398_slide66_fig1.svg)
...
![Measured route diagram drawn from the slide's own shapes, measures 10 to 100.](../media/doc398_slide67_fig1.svg)
...
![Measured route diagram drawn from the slide's own shapes, measures 10 to 200.](../media/doc398_slide67_fig2.svg)
