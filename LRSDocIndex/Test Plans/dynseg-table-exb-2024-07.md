...
| Field | Value |
| --- | --- |
| **Doc** | 351 · Test Plan · Experience Builder |
| **Product** | — |
| **Release** | — |
| **Issues** | — |
...
<!-- related:begin -->
- [Dynamic Segmentation Table Experience Builder Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/dynseg-table-exb-2024-07-2.md>) — similar text 0.90 · 5 title words · 3 filename words · same kind/surface <!-- rel:352 s=9.746 -->
- [Dynamic Segmentation Table Test Plan Options](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/dynseg-table-options.md>) — similar text 0.22 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:337 s=5.223 -->
- [Dynamic Segmentation – Straight Line Diagram Support - ExB](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/20594-dynseg-sld-support-exb.md>) — similar text 0.30 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:346 s=5.016 -->
- [Experience Builder Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/exb-dynseg-widget.md>) — similar text 0.24 · 4 title words · 1 filename word · same surface <!-- rel:362 s=4.312 -->
- [Dynamic Segmentation Merge Option Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/4902-dynseg-merge-option.md>) — similar text 0.11 · 2 title words · same kind/surface/folder <!-- rel:592 s=3.635 -->
<!-- related:end -->
...
![Figure 1 — 2](../media/dynseg-table-exb-2024-07/fig-01-slide-02-2.png)
...
![Figure 2 — Acceptance Testing](../media/dynseg-table-exb-2024-07/fig-02-slide-03-acceptance-testing.png)
...
![Figure 3 — 5](../media/dynseg-table-exb-2024-07/fig-03-slide-05-5.svg)
...
![Figure 4 — 6](../media/dynseg-table-exb-2024-07/fig-04-slide-06-6.svg)
