...
<!-- metadata
```yaml
title: "Generate LogLo GP Standalone Test Plan"
source_file: "Generate_LogLo_GP_Standalone_TestPlan1.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/Generate_LogLo_GP_Standalone_TestPlan1.pptx"
doc_id: 259
doc_kind: "Test Plan"
surface: "Pro"
doc_revision: ""
...
last_edited: "2025-01-14T18:16:47Z"
...
products: []
issues: []
related: [{"doc":260,"file":"generate-a-route-log-using-the-glrsdp-gp-tool-test-plan__doc260.md","s":4.479},{"doc":255,"file":"generate-a-route-log-including-spanning-events-and-centerline-test-plan__doc255.md","s":4.331},{"doc":173,"file":"standalone-gp-generate-feature-count-test-plan__doc173.md","s":4.115},{"doc":256,"file":"route-log-data-product-template-test-plan__doc256.md","s":3.825},{"doc":150,"file":"generate-route-log-location-referencing__doc150.md","s":3.422}]
```
-->
...
<!-- related:begin -->
- [Generate a Route Log using the GLRSDP GP Tool – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/generate-a-route-log-using-the-glrsdp-gp-tool-test-plan__doc260.md>) — similar text 0.15 · 1 title word · 2 filename words · same kind/surface/folder <!-- rel:260 -->
- [Generate a route Log including spanning events and centerline – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/generate-a-route-log-including-spanning-events-and-centerline-test-plan__doc255.md>) — similar text 0.11 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:255 -->
- [Standalone GP – Generate Feature Count – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/standalone-gp-generate-feature-count-test-plan__doc173.md>) — similar text 0.35 · 2 title words · 1 filename word · same kind/surface <!-- rel:173 -->
- [Route Log data product template – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/route-log-data-product-template-test-plan__doc256.md>) — similar text 0.28 · 1 filename word · same kind/surface/folder <!-- rel:256 -->
- [Generate Route Log (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/generate-route-log-location-referencing__doc150.md>) — similar text 0.15 · 1 title word · 2 filename words · same surface <!-- rel:150 -->
<!-- related:end -->
...
![Interface screenshot redrawn as a standardized wireframe: 4 fields, 5 icons, 14 text rows. 12 of 14 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc727_slide2.svg)
...
![image2.png](../media/doc727_image2.png)

## Slide 3

![Interface screenshot redrawn as a standardized wireframe: 4 fields, 5 icons, 14 text rows. 12 of 14 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc727_slide3.svg)
...
![Interface screenshot redrawn as a standardized wireframe: 1 panel, 9 fields, 1 row separator, 6 icons, 27 text rows. 16 of 27 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc727_slide4.svg)
...
![image3.png](../media/doc727_image3.png) ![image4.png](../media/doc727_image4.png)

## Slide 5

![Interface screenshot redrawn as a standardized wireframe: 1 panel, 9 fields, 1 row separator, 6 icons, 27 text rows. 16 of 27 text rows carry text transcribed from the screenshot (OCR, approximate); the rest render as placeholder bars; positions are approximate to the source image and colours are mapped to the corpus palette.](../media/doc727_slide5.svg)
...
![image4.png](../media/doc727_image4.png)
