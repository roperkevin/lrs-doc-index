...
| **Issue** | [ArcGISPro/ps-location-referencing#6159](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/6159) |
...
<!-- metadata
```yaml
title: "Support External Event Configuration Without Connection File – Test Plan"
source_file: "ConfigureExternalEventsWOreference_testplan2.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/ConfigureExternalEventsWOreference_testplan2.pptx"
doc_id: 275
doc_kind: "Test Plan"
surface: "Pro"
doc_revision: ""
...
last_edited: "2024-12-09T22:08:51Z"
...
issues: ["ArcGISPro/ps-location-referencing#6159"]
related: [{"doc":264,"file":"relocate-events-support-for-external-event-with-no-connection-file-test-plan__doc264.md","s":5.942},{"doc":288,"file":"create-external-event-with-no-connection-file__doc288.md","s":4.722},{"doc":811,"file":"configure-external-events__doc811.md","s":4.165},{"doc":744,"file":"support-updating-external-event-configuration__doc744.md","s":3.85},{"doc":248,"file":"configure-external-event-behaviors-with-lrs__doc248.md","s":3.584}]
```
-->
...
<!-- related:begin -->
- [Relocate Events Support for External Event with No Connection File - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/relocate-events-support-for-external-event-with-no-connection-file-test-plan__doc264.md>) — similar text 0.10 · 4 title words · 3 filename words · same kind/dev/folder <!-- rel:264 -->
- [Create External Event with No Connection File](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-external-event-with-no-connection-file__doc288.md>) — similar text 0.50 · 3 title words · 1 filename word · same surface <!-- rel:288 -->
- [Configure External Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Design%20Spikes/configure-external-events__doc811.md>) — similar text 0.25 · 1 title word · 3 filename words · same surface <!-- rel:811 -->
- [Support updating External Event configuration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-updating-external-event-configuration__doc744.md>) — similar text 0.20 · 4 title words · 1 filename word · same surface <!-- rel:744 -->
- [Configure External Event Behaviors With LRS](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configure-external-event-behaviors-with-lrs__doc248.md>) — similar text 0.13 · 2 title words · 2 filename words · same surface <!-- rel:248 -->
<!-- related:end -->
...
## Slide 1 — Support external event configuration without connection file – Test Plan
...
![image1.png](../media/doc715_image1.png)
...
![image2.png](../media/doc715_image2.png) ![image3.png](../media/doc715_image3.png) ![image4.png](../media/doc715_image4.png)
...
## Slide 5 — Positive cases
  ...
  - Configure a point event with non-line network with all stayput behaviors
...
Negative cases
  ...
  - Input Event Name is left empty
