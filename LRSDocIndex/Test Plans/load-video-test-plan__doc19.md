...
<!-- metadata
```yaml
title: "Load Video Test Plan"
source_file: "LoadVideo_TestPlan_3126.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/LoadVideo_TestPlan_3126.pptx"
doc_id: 19
doc_kind: "Test Plan"
surface: "Pro"
doc_revision: ""
...
last_edited: "2026-06-22T23:47:40Z"
...
products: []
issues: []
related: [{"doc":10,"file":"detect-objects-test-plan__doc10.md","s":4.836},{"doc":8,"file":"camera-calibration-test-plan__doc8.md","s":4.183},{"doc":372,"file":"transform-lrs-data-gp-tool-test-plan__doc372.md","s":2.837},{"doc":359,"file":"transform-lrs-data-gp-tool-summarize-by-polygon-boundaries-test-plan__doc359.md","s":2.61},{"doc":360,"file":"add-point-event-to-dominant-route-in-arcgis-pro-test-plan__doc360.md","s":2.603}]
```
-->
...
<!-- related:begin -->
- [Detect Objects Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/detect-objects-test-plan__doc10.md>) — similar text 0.29 · same kind/surface/folder <!-- rel:10 -->
- [Camera Calibration Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/camera-calibration-test-plan__doc8.md>) — similar text 0.31 · same kind/folder <!-- rel:8 -->
- [Transform LRS Data GP tool – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/transform-lrs-data-gp-tool-test-plan__doc372.md>) — similar text 0.06 · same kind/surface/folder <!-- rel:372 -->
- [Transform LRS Data GP tool: Summarize by polygon boundaries – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/transform-lrs-data-gp-tool-summarize-by-polygon-boundaries-test-plan__doc359.md>) — similar text 0.05 · same kind/surface/folder <!-- rel:359 -->
...
![image2.png](../media/doc1014_image2.png)
...
GoPro 13 Black Profiles

## Slide 5

Time sync and frequency alignment
...
![image3.png](../media/doc1014_image3.png) ![image4.png](../media/doc1014_image4.png) ![image5.png](../media/doc1014_image5.png)
...
![image6.png](../media/doc1014_image6.png) ![image7.png](../media/doc1014_image7.png)
