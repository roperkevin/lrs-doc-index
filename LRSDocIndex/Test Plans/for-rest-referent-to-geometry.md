...
| Field | Value |
| --- | --- |
| **Doc** | 563 · Test Plan · Server |
| **Product** | Pipeline Referencing |
| **Release** | — |
| **Issues** | — |
| **Source** | [TestPlan_RefToGeom_V3.pptx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Test%20Plans/TestPlan_RefToGeom_V3.pptx>) · rev V3 |
...
<!-- related:begin -->
- [Test Plan for REST Referent To Geometry in Linear Referencing](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/for-rest-referent-to-geometry-in-lr.md>) — similar text 0.92 · 3 title words · 2 filename words · same kind/folder <!-- rel:588 s=11.904 -->
- [REST Geometry to Referent Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/4211-rest-geometry-to-referent.md>) — similar text 0.23 · 3 title words · same kind/surface/folder <!-- rel:587 s=4.864 -->
- [REST Geometry to Referent User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/rest-geometry-to-referent.md>) — similar text 0.15 · 3 title words · same surface <!-- rel:608 s=3.039 -->
- [REST: Referent to Geometry](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/rest-referent-to-geometry.md>) — similar text 0.15 · 3 title words · same surface <!-- rel:614 s=3.018 -->
- [ExB Search By Referent – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/16462-exb-search-by-referent.md>) — similar text 0.17 · 1 title word · same kind/folder <!-- rel:456 s=2.999 -->
<!-- related:end -->
...
### TC-U04 — Output (3) <!-- src: S5 · slide 33 · label Output -->
...
![Figure 1 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-01-slide-02-rest-referent-to-geometry.png)
![Figure 2 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-02-slide-02-rest-referent-to-geometry.png)

### Slide 3 — REST: Referent To Geometry <!-- slide 3 -->

![Figure 3 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-03-slide-03-rest-referent-to-geometry.png)
...
![Figure 4 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-04-slide-04-rest-referent-to-geometry.png)
...
| Input | Output |
| --- | --- |
| layerId : 1,<br>ObjectId : 1<br>Offset : -10 | routeId : R1,<br>Measure: Nan |
...
![Figure 5 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-05-slide-05-rest-referent-to-geometry.png)
![Figure 6 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-06-slide-05-rest-referent-to-geometry.png)

![Figure 7 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-07-slide-05-rest-referent-to-geometry.svg)
...
| Input | Output |
| --- | --- |
| layerId : 1,<br>fromObjectId : 3<br>fromOffset : -4<br>toObjectId : 4<br>toOffset : -4 | routeId : R1,<br>Measure: 14,<br>toMeasure : 16 geometryType : line, geometry: xyz |

| Input | Output |
| --- | --- |
| layerId : 1,<br>fromObjectId : 3<br>fromOffset : -20<br>toObjectId : 4<br>toOffset : 20 | routeId : R1,<br>Measure: Nan |
...
![Figure 8 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-08-slide-06-rest-referent-to-geometry.svg)
...
![Figure 9 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-09-slide-07-rest-referent-to-geometry.svg)
...
![Figure 10 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-10-slide-08-rest-referent-to-geometry.png)
![Figure 5 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-05-slide-05-rest-referent-to-geometry.png)
...
![Figure 11 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-11-slide-09-rest-referent-to-geometry.png)
![Figure 5 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-05-slide-05-rest-referent-to-geometry.png)
...
![Figure 12 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-12-slide-10-rest-referent-to-geometry.svg)
...
![Figure 13 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-13-slide-11-rest-referent-to-geometry.png)
![Figure 5 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-05-slide-05-rest-referent-to-geometry.png)

![Figure 14 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-14-slide-11-rest-referent-to-geometry.svg)
...
| Input | Output |
| --- | --- |
| layerId : 1,<br>fromObjectId : 15<br>fromOffset : -5<br>toObjectId : 15<br>toOffset : 3 | routeId : R6,<br>Measure: 12,<br>TorouteId : R6,<br>toMeasure : 20 geometryType : point, geometry: xyz |

| Input | Output |
| --- | --- |
| layerId : 1,<br>fromObjectId : 16<br>Offset : -5<br>layerId : 1,<br>fromObjectId : 17<br>fromOffset : -0.25<br>toObjectId : 17<br>toOffset : 0.25 | routeId : R7,<br>Measure: 11,<br>geometryType : point, geometry: xyz<br>routeId : R9,<br>Measure: 2.25,<br>TorouteId : R9,<br>toMeasure : 2.75<br>geometryType : point, geometry: xyz |
...
![Figure 15 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-15-slide-12-rest-referent-to-geometry.svg)
...
| Input | Output |
| --- | --- |
| layerId : 1,<br>ObjectId : 18<br>Offset :10 | routeId : R10,<br>Measure: 20, geometryType : point, geometry: xyz<br>routeId : R10,<br>Measure: 60, geometryType : point, geometry: xyz Will only be output for pt. feature |
...
![Figure 16 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-16-slide-14-rest-referent-to-geometry.svg)
...
| Input | Output |
| --- | --- |
| layerId : 1,<br>fromObjectId : 15<br>fromOffset : -5<br>toObjectId : 15<br>toOffset : 3<br>TempViewDate : | {<br>" unitsOfMeasure ": " esriMiles ",<br>" spatialReference ": {<br>" wkid ": 3310<br>},<br>"locations": [<br>{<br>"status": " esriLocatingCannotFindLocation ",<br>"results": [<br>]<br>}<br>]<br>} |
...
![Figure 17 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-17-slide-17-rest-referent-to-geometry.svg)
...
| Input | Output |
| --- | --- |
| layerId : 1,<br>fromObjectId : 35<br>fromOffset : -2<br>toObjectId : 35<br>toOffset : 0 | routeId : R28,<br>Measure: 0,<br>TorouteId : R28,<br>toMeasure : 3 geometryType : line, geometry: xyz |

[figure: 0 · 2 · 3 · 35 · 1–3 · R28]

![Figure 18 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-18-slide-18-rest-referent-to-geometry.svg)
...
![Figure 19 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-19-slide-19-rest-referent-to-geometry.svg)
...
![Figure 20 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-20-slide-20-rest-referent-to-geometry.svg)
...
[figure: 10–22 · 1 · 2 · R7 · X · 3 · 30 · 31 · R8 · R9]

![Figure 5 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-05-slide-05-rest-referent-to-geometry.png)

![Figure 21 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-21-slide-21-rest-referent-to-geometry.svg)
...
[figure: 10–22 · 1 · 10 · 11 · 3 · 32 · Ry(100) · Rx(200) · Ry(300) · X]

![Figure 5 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-05-slide-05-rest-referent-to-geometry.png)

![Figure 22 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-22-slide-22-rest-referent-to-geometry.svg)
...
| Input | Output |
| --- | --- |
| layerId : 3,<br>ObjectId : 33<br>Offset : 2640<br>*Network in miles, offset distance in feet | routeId : R8_1 ,<br>Measure: 7.99,<br>geometryType : point, geometry: xyz<br>routeId : T0,<br>Measure: 0,<br>geometryType : point, geometry: xyz<br>routeId : T0,<br>Measure: 4,<br>geometryType : point, geometry: xyz |

Note: Check measure for R8_1 for output

[figure: 0 · R8_1 · 10 · X · 33]

![Figure 23 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-23-slide-23-rest-referent-to-geometry.svg)
...
![Figure 24 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-24-slide-25-rest-referent-to-geometry.svg)
...
![Figure 25 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-25-slide-27-rest-referent-to-geometry.svg)
...
![Figure 26 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-26-slide-28-rest-referent-to-geometry.svg)
...
![Figure 27 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-27-slide-29-rest-referent-to-geometry.svg)
...
![Figure 28 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-28-slide-30-rest-referent-to-geometry.svg)
...
![Figure 29 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-29-slide-31-rest-referent-to-geometry.png)

![Figure 30 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-30-slide-31-rest-referent-to-geometry.svg)
...
![Figure 31 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-31-slide-32-rest-referent-to-geometry.png)
![Figure 32 — REST: Referent To Geometry](../media/for-rest-referent-to-geometry/fig-32-slide-32-rest-referent-to-geometry.png)
...
![Figure 33 — 33](../media/for-rest-referent-to-geometry/fig-33-slide-33-33.svg)
