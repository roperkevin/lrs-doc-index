...
| Field | Value |
| --- | --- |
| **Doc** | 11 · Test Plan · Pro |
| **Product** | Roads & Highways · Pipeline Referencing |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#7167](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/7167) |
...
| **People** | author PptxGenJS · PE — · dev Devtopia |
...
<!-- related:begin -->
- [Iteration Planning and Issue Tracking for Location Referencing 3.8/12.2](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Schedules/3040-iteration-planning-and-issue-tracking-for-lr-3-8-12-2.md>) — shared issue ArcGISPro/ps-location-referencing#7167 · similar text 0.04 · same surface <!-- rel:2 s=1002.199 -->
- [Reassign Route AI Assistant Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/7039-reassign-route-ai-assistant.md>) — similar text 0.33 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:34 s=7.536 -->
- [Realign Route AI Assistant Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/7067-realign-route-ai-assistant-rh-apr-2026-02.md>) — similar text 0.17 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:51 s=5.837 -->
- [Retire Route – Pro AI Assistant Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/7066-retire-route-pro-ai-assistant.md>) — similar text 0.23 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:4 s=5.144 -->
- [Reassign Route UI: Dynamic Support of Existing Methods Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/5152-reassign-route-ui-dynamic-support-of-existing-methods.md>) — similar text 0.14 · 2 title words · 2 filename words · same kind/folder <!-- rel:550 s=5.067 -->
<!-- related:end -->
...
## Slide 1 — Pro AI Assistant Skill
...
![Figure 1 — Pro AI Assistant Skill](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-01-slide-01-pro-ai-assistant-skill.png)

### Notes

Reassign Route subsequent-pane assistant. Test and automation execution plan for the Pro AI Assistant skill.

## Slide 2 — What this skill does
...
![Figure 2 — What this skill does](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-02-slide-02-what-this-skill-does.svg)
...
## Slide 3 — Which panes the assistant must populate
...
![Figure 3 — Which panes the assistant must populate](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-03-slide-03-which-panes-the-assistant-must-populate.svg)
...
![Figure 4 — Test environment & data](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-04-slide-04-test-environment-and-data.svg)
...
![Figure 5 — METHOD CASE · P-NLF-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-05-slide-05-method-case-p-nlf-01.svg)
...
![Figure 6 — METHOD CASE · P-NLF-02](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-06-slide-06-method-case-p-nlf-02.svg)
...
![Figure 7 — METHOD CASE · P-NLM-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-07-slide-07-method-case-p-nlm-01.svg)
...
![Figure 8 — METHOD CASE · P-NLM-02](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-08-slide-08-method-case-p-nlm-02.svg)
...
![Figure 9 — METHOD CASE · P-LF-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-09-slide-09-method-case-p-lf-01.svg)
...
![Figure 10 — METHOD CASE · P-LF-02](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-10-slide-10-method-case-p-lf-02.svg)

### Notes

P-LF-02. Form resolved in first pane; attributes provided up front. Assistant confirms with no re-ask.

## Slide 11 — METHOD CASE · P-LM-01
...
![Figure 11 — METHOD CASE · P-LM-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-11-slide-11-method-case-p-lm-01.svg)
...
![Figure 12 — METHOD CASE · P-LM-02](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-12-slide-12-method-case-p-lm-02.svg)

### Notes

P-LM-02. Merge resolved in first pane; attributes up front. Assistant confirms the attributes.

## Slide 13 — METHOD CASE · P-LT-01
...
![Figure 13 — METHOD CASE · P-LT-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-13-slide-13-method-case-p-lt-01.svg)
...
![Figure 14 — METHOD CASE · P-LT-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-14-slide-14-method-case-p-lt-01.svg)

### Notes

P-LT-01. Transfer to Another Line — the most expanded method. Assistant prompts for each missing item in turn: target route name, from, to, then attributes. After approval, panes pre-populated.

## Slide 15 — METHOD CASE · P-LT-01
...
![Figure 15 — METHOD CASE · P-LT-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-15-slide-15-method-case-p-lt-01.svg)

### Notes

P-LT-01. Transfer to Another Line — the most expanded method. Assistant prompts for each missing item in turn: target route name, from, to, then attributes. After approval, panes pre-populated.

## Slide 16 — METHOD CASE · P-LT-02
...
![Figure 16 — METHOD CASE · P-LT-02](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-16-slide-16-method-case-p-lt-02.svg)
...
![Figure 17 — METHOD CASE · P-MF-01](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-17-slide-17-method-case-p-mf-01.svg)
...
![Figure 18 — METHOD CASE · P-MF-02](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-18-slide-18-method-case-p-mf-02.svg)
...
## Slide 19 — Confirmation, amendment & method-change behavior
...
![Figure 19 — Confirmation, amendment & method-change behavior](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-19-slide-19-confirmation-amendment-and-method-change.svg)
...
## Slide 20 — NEGATIVE CASES · 1 OF 2
...
![Figure 20 — NEGATIVE CASES · 1 OF 2](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-20-slide-20-negative-cases-1-of-2.svg)
...
## Slide 21 — NEGATIVE CASES · 2 OF 2
...
![Figure 21 — NEGATIVE CASES · 2 OF 2](../media/7167-reassign-route-subsequent-pane-ai-assistant/fig-21-slide-21-negative-cases-2-of-2.svg)
