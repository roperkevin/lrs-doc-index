...
<!-- related:begin -->
- [Events Data Model](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/events-data-model-rh.md>) — similar text 0.95 · 2 title words · 2 filename words · same kind/folder <!-- rel:247 s=9.245 -->
- [Location Referencing GP Error Messages](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/3147-lr-gp-error-messages.md>) — similar text 0.24 · same kind <!-- rel:39 s=3.403 -->
- [External Event Registration in ArcGIS Pipeline Referencing](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/external-event-registration-in-arcgis-apr.md>) — similar text 0.37 · 1 filename word · same kind <!-- rel:243 s=3.398 -->
- [View LRS Event Properties](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/view-lrs-event-properties.md>) — similar text 0.32 · same kind <!-- rel:134 s=2.943 -->
- [External system integration with ArcGIS Pipeline Referencing](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/external-system-integration-with-arcgis-apr.md>) — similar text 0.27 · 1 filename word · same folder <!-- rel:242 s=2.82 -->
<!-- related:end -->
