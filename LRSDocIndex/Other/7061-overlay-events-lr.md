...
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#7061](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/7061) |
| **Source** | [7061_OverlayEventsGP_ParallelProcessing.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro37_Ent121/7061_OverlayEvents_PP/7061_OverlayEventsGP_ParallelProcessing.docx>) |
| **People** | author — · PE — · dev — |
| **Edited** | 2026-02-25 01:55 by unknown |
| **Extracted** | 2026-09-04 · lane xmlstrip · format 3.0 · prompt v2.0.2 |
| **Keywords** | dynamic segmentation · line event · point event · address data management · utility network · parallel processing · feature service |
| **Tools** | Overlay Events |

## Summary

Describes the Overlay Events tool which overlays one or more line and point event layers onto a target network and outputs a feature class or table representing the dynamic segmentation of the inputs. It covers usage, parameters, Python examples, environment settings, and licensing requirements.

## Related documents

<!-- related:begin -->
- [Iteration Planning and Issue Tracking for Esri LRS Development](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Schedules/363-iteration-planning-and-issue-tracking-for-esri-lrs.md>) — shared issue ArcGISPro/ps-location-referencing#7061 · similar text 0.06 · same surface <!-- rel:59 s=1001.27 -->
- [Overlay Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6379-overlay-events-lr.md>) — similar text 0.97 · 2 title words · 2 filename words · same kind/surface <!-- rel:131 s=7.278 -->
- [Overlay Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/overlay-events-lr.md>) — similar text 0.90 · 2 title words · 2 filename words · same kind/surface <!-- rel:75 s=7.025 -->
- [Overlay Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6267-overlay-events-lr.md>) — similar text 0.83 · 2 title words · 2 filename words · same kind/surface <!-- rel:251 s=6.302 -->
- [Overlay Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5647-overlay-events-lr.md>) — similar text 0.51 · 2 title words · 2 filename words · same kind/surface <!-- rel:422 s=4.971 -->
<!-- related:end -->

<!-- docs:begin -->
## Esri documentation

[Apply dynamic segmentation](https://doc.esri.com/en/arcgis-pro/latest/help/production/roads-highways/apply-dynamic-segmentation.html) · [Manage address and roadway characteristic data together](https://doc.esri.com/en/arcgis-pro/latest/help/production/roads-highways/manage-address-and-roadway-characteristic-data-together.html) · [View utility network feature class properties](https://doc.esri.com/en/arcgis-pro/latest/help/production/location-referencing-pipelines/view-utility-network-feature-class-properties.html) · [Edit feature services](https://doc.esri.com/en/arcgis-pro/latest/help/production/roads-highways/edit-feature-services.html)
...
- If you are running this tool against a large number of routes, it is recommended that you enable parallel processing to improve performance. You can control the number of cores the tool uses by specifying a value for the https://pro.arcgis.com/en/pro-app/latest/tool-reference/environment-settings/parallel-processing-factor.htm Parallel Processing Factor environment.
- If you experience poor performance or tool failures when running this tool with data from a feature service, increase the heap size at the service level.
- The https://pro.arcgis.com/en/pro-app/latest/tool-reference/environment-settings/parallel-processing-factor.htm Parallel Processing Factor environment setting for this tool applies only to events that span multiple routes.
...
![Figure 1 — Licensing information](../media/7061-overlay-events-lr/fig-01-licensing-information.png)
