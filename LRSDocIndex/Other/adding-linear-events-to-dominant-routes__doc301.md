...
<!-- metadata
```yaml
title: "Adding Linear Events to Dominant Routes"
source_file: "AddLinearEvents_DominantRoute_APR.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5858_line-event-dominant-route/AddLinearEvents_DominantRoute_APR.docx"
doc_id: 301
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
last_edited_by: ""
last_edited: "2024-10-10T21:20:25.5445153Z"
...
issues: []
related: [{"doc":326,"file":"add-linear-events-to-dominant-routes__doc326.md","s":9.11},{"doc":309,"file":"adding-point-events-to-dominant-routes__doc309.md","s":5.951},{"doc":310,"file":"adding-point-events-to-dominant-routes__doc310.md","s":5.475},{"doc":120,"file":"add-multiple-line-events-by-route-and-measure__doc120.md","s":4.75},{"doc":235,"file":"add-point-events-by-location-offset__doc235.md","s":4.178}]
```
-->
...
<!-- related:begin -->
- [Add Linear Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-linear-events-to-dominant-routes__doc326.md>) — similar text 0.57 · 4 title words · 5 filename words · same kind/surface/folder <!-- rel:326 -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes__doc309.md>) — similar text 0.44 · 4 title words · 2 filename words · same kind/surface <!-- rel:309 -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes__doc310.md>) — similar text 0.45 · 4 title words · 1 filename word · same kind/surface <!-- rel:310 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-multiple-line-events-by-route-and-measure__doc120.md>) — similar text 0.38 · 1 title word · 3 filename words · same kind/surface <!-- rel:120 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset__doc235.md>) — similar text 0.28 · 1 title word · 3 filename words · same kind/surface <!-- rel:235 -->
<!-- related:end -->
...
- 9. Specify the start date of the event by doing one of the following:
  ...
  - Check the Route start date check box.
  - Double-click in the Start Date text box to use today'sthe current date.
...
![image1.png](../media/doc640_image1.png) ![image13.png](../media/doc640_image13.png) ![image3.png](../media/doc640_image3.png) ![image4.png](../media/doc640_image4.png) ![image5.png](../media/doc640_image5.png) ![image14.png](../media/doc640_image14.png) ![image6.png](../media/doc640_image6.png) ![image7.png](../media/doc640_image7.png) ![image8.png](../media/doc640_image8.png) ![image12.png](../media/doc640_image12.png) ![image15.png](../media/doc640_image15.png) ![image16.png](../media/doc640_image16.png)
