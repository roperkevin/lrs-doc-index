...
<!-- related:begin -->
- [Event Behavior for Route Reassignment – Transfer to Another Line Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-reassignment-transfer-to-another-line-method.md>) — similar text 0.69 · 5 title words · 1 filename word · same kind/surface/folder <!-- rel:36 s=8.867 -->
- [Event Behavior for Route Reassignment – Merge to Adjacent Route Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-reassignment-merge-to-adjacent-route-method.md>) — similar text 0.80 · 5 title words · 2 filename words · same kind/surface/folder <!-- rel:522 s=7.96 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02-2.md>) — similar text 0.54 · 3 title words · same kind/surface <!-- rel:425 s=4.901 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-rh-2024-01-2.md>) — similar text 0.54 · 3 title words · same kind/surface <!-- rel:442 s=4.728 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-apr-2024-01.md>) — similar text 0.53 · 3 title words · same kind/surface <!-- rel:441 s=4.704 -->
<!-- related:end -->
...
![Figure 1 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-01-snap-event-behavior.png)
![Figure 2 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-02-snap-event-behavior.png)
![Figure 3 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-03-snap-event-behavior.png)
![Figure 4 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-04-snap-event-behavior.png)
![Figure 5 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-05-snap-event-behavior.png)
![Figure 6 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-06-snap-event-behavior.png)
![Figure 7 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-07-snap-event-behavior.png)
![Figure 8 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-08-snap-event-behavior.png)
![Figure 9 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-09-snap-event-behavior.png)
![Figure 10 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-10-snap-event-behavior.png)
![Figure 11 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-11-snap-event-behavior.png)
![Figure 12 — Snap event behavior](../media/eb-for-route-reassignment-form-a-new-route-method/fig-12-snap-event-behavior.png)
