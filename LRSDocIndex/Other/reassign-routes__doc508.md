...
source_file: "Reassign_routes_Pipeline_trackChanges.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5418_ReassignRoutesAPR/Reassign_routes_Pipeline_trackChanges.docx"
doc_id: 508
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
last_edited: "2023-09-05T23:17:00Z"
...
issues: []
related: [{"doc":507,"file":"reassign-routes__doc507.md","s":12.477},{"doc":894,"file":"reassigning-a-route__doc894.md","s":4.018},{"doc":523,"file":"event-behavior-for-route-reassignment-form-a-new-route-method__doc523.md","s":3.953},{"doc":34,"file":"reassign-route-ai-assistant-test-plan__doc34.md","s":3.873},{"doc":100,"file":"pro-ai-assistant-reassign-route-user-story__doc100.md","s":3.603}]
```
-->
...
<!-- related:begin -->
- [Reassign Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/reassign-routes__doc507.md>) — similar text 0.91 · 2 title words · 4 filename words · same kind/surface <!-- rel:507 -->
- [Reassigning a Route](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/reassigning-a-route__doc894.md>) — similar text 0.48 · 1 filename word · same kind/surface <!-- rel:894 -->
...
- [Reassign Route AI Assistant Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/reassign-route-ai-assistant-test-plan__doc34.md>) — similar text 0.25 · 1 title word · 1 filename word · same surface <!-- rel:34 -->
- [Pro AI Assistant Reassign Route User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/pro-ai-assistant-reassign-route-user-story__doc100.md>) — similar text 0.15 · 1 title word · 1 filename word · same surface <!-- rel:100 -->
<!-- related:end -->
...
- In the Source Route section, click the Choose route from map button  and click the route on the map to populate From Route Name.
- Note:
...
- In the Target Route section, click the Choose route from map button and choose the target route from the map.
- Alternatively, provide a new route name to reassign to a new route.
...
- provide a new route name to reassign to a new route.
- Provide a From measure value for the target route reassignment location by doing one of the following:
  - Provide a value in the From Measure text box.
  - Click the Recalculate From Measure button . The From measure value is calculated as the source measure length minus the To measure value.
- Note:
...
![image1.png](../media/doc439_image1.png) ![image2.png](../media/doc439_image2.png) ![image3.png](../media/doc439_image3.png) ![image4.png](../media/doc439_image4.png) ![image5.png](../media/doc439_image5.png) ![image6.png](../media/doc439_image6.png) ![image7.png](../media/doc439_image7.png) ![image8.png](../media/doc439_image8.png) ![image9.png](../media/doc439_image9.png) ![image10.png](../media/doc439_image10.png) ![image11.png](../media/doc439_image11.png) ![image34.png](../media/doc439_image34.png)
