...
source_file: "AI_assistant_LRS_route_editing - 38-122.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro38_Ent122/AI_assistant_LRS_route_editing%20-%2038-122.docx"
doc_id: 907
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: "Kyle Chin"
last_edited_by: ""
last_edited: "2026-08-27T18:46:42.8097363Z"
...
issues: []
related: [{"doc":55,"file":"perform-an-action-with-the-arcgis-pro-assistant-beta__doc55.md","s":9.742},{"doc":62,"file":"perform-an-action-with-the-arcgis-pro-assistant-beta__doc62.md","s":9.735},{"doc":82,"file":"arcgis-pro-assistant-beta-documentation__doc82.md","s":5.219},{"doc":50,"file":"arcgis-pro-ai-assistant-realign-route-subsequent-panes-test-plan__doc50.md","s":3.374},{"doc":102,"file":"pro-ai-assistant-realign-route-user-story__doc102.md","s":3.156}]
```
-->
...
<!-- related:begin -->
- [Perform an action with the ArcGIS Pro Assistant (Beta)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/perform-an-action-with-the-arcgis-pro-assistant-beta__doc55.md>) — similar text 0.91 · 5 title words · 3 filename words · same kind/surface <!-- rel:55 -->
- [Perform an action with the ArcGIS Pro Assistant (Beta)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/perform-an-action-with-the-arcgis-pro-assistant-beta__doc62.md>) — similar text 0.93 · 5 title words · 3 filename words · same kind/surface <!-- rel:62 -->
- [ArcGIS Pro Assistant (Beta) Documentation](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/arcgis-pro-assistant-beta-documentation__doc82.md>) — similar text 0.58 · 3 title words · 1 filename word · same kind/surface <!-- rel:82 -->
- [ArcGIS Pro AI Assistant : Realign Route Subsequent panes – Test plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/arcgis-pro-ai-assistant-realign-route-subsequent-panes-test-plan__doc50.md>) — similar text 0.20 · 2 title words · 1 filename word · same surface <!-- rel:50 -->
- [Pro AI Assistant Realign Route User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/pro-ai-assistant-realign-route-user-story__doc102.md>) — similar text 0.17 · 2 title words · 2 filename words · same surface <!-- rel:102 -->
<!-- related:end -->
...
| Route realignment | Realign a route in the Engineering Network. The source from measure is 949.46 and the source to measure is 3847.665. The target from measure is 949.46 and the target to measure is 9079.625. Use centerline 2902 valid on 01/ 01/2010. Use 'L7_Abandon'as the abandoned line name and use 'R34_Abandon' for the abandoned route name. Do not recalibrate downstream, and use 'NewRouteR1000' as the name for the new realigned route. | You are presented with the populated first page of the Realign Route pane. After you click Run , the subsequent pages of the Realign Route pane are also populated. |
| Route reassignment |  |  |
| Route reassignment |  |  |
| Route extension |  |  |
| Route extension |  |  |
| Route retirement | Retire a route . | If only one LRS Network is found on the map, you are asked to provide a route ID or route name. If multiple LRS Networks are found on the map, you are asked to specify an LRS Network. |
