...
<!-- related:begin -->
- [Create and modify LRS Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/create-and-modify-lrs-events-rh.md>) — similar text 0.70 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:261 s=8.697 -->
- [Replace Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/replace-events-apr.md>) — similar text 0.23 · 1 title word · 2 filename words · same kind/surface <!-- rel:122 s=3.704 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6134-add-multiple-line-events-by-route-and-measure.md>) — similar text 0.22 · 1 title word · 2 filename words · same kind/surface <!-- rel:120 s=3.643 -->
...
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset-apr.md>) — similar text 0.21 · 1 title word · 2 filename words · same kind/surface <!-- rel:235 s=3.568 -->
<!-- related:end -->
...
1. Check the Append events to dominant routes box to append events to the dominant route where concurrencies exist.

1. The following example illustrates a scenario where point events and spanning line events are appended to the dominant routes. In the following graphics and tables, there are multiple routes across two lines. The concurrent routes have opposite directions and different ranges in time.
...
![Figure 1 — After appending events to the dominant route:](../media/create-and-modify-lrs-events-apr/fig-01-after-appending-events-to-the-dominant.png)
