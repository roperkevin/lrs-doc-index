...
<!-- metadata
```yaml
title: "Configure Attribute Sets"
source_file: "APR_Proattset.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5102_AttributeSetsInCIM/APR_Proattset.docx"
doc_id: 556
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
last_edited: "2023-06-07T18:37:00Z"
...
issues: []
related: [{"doc":555,"file":"configure-attribute-sets__doc555.md","s":9.172},{"doc":552,"file":"producing-attribute-sets__doc552.md","s":4.592},{"doc":554,"file":"configuring-attribute-sets__doc554.md","s":4.254},{"doc":553,"file":"configuring-attribute-sets__doc553.md","s":3.688},{"doc":551,"file":"producing-attribute-sets__doc551.md","s":3.652}]
```
-->
...
<!-- related:begin -->
- [Configure Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configure-attribute-sets__doc555.md>) — similar text 0.86 · 3 title words · 1 filename word · same kind/surface/folder <!-- rel:555 -->
- [Producing Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/producing-attribute-sets__doc552.md>) — similar text 0.36 · 2 title words · 1 filename word · same kind/folder <!-- rel:552 -->
- [Configuring Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configuring-attribute-sets__doc554.md>) — similar text 0.39 · 2 title words · 1 filename word · same kind/folder <!-- rel:554 -->
- [Configuring Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configuring-attribute-sets__doc553.md>) — similar text 0.37 · 2 title words · same kind/folder <!-- rel:553 -->
- [Producing Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/producing-attribute-sets__doc551.md>) — similar text 0.35 · 2 title words · same kind/folder <!-- rel:551 -->
<!-- related:end -->
...
- In ArcGIS Pro, open the map that contains the LRS dataset whose event layers from an enterprise geodatabase will define an attribute set.
- Click the Location Referencing tab, and in the Events group, click the Attribute Sets button .
...
- Click the Attribute Set drop-down arrow and choose Create New Attribute Set to create an attribute set based on the selected layer type.
- The Create New Attribute Set dialog box appears.
- A default name is provided based on the selected layer type.
- Optionally, provide a different name for the attribute set.
...
- Drag a layer or layer column to the list on the right to define it as part of an attribute set.
...
- When you're finished adding attributes and providing values in the attribute set, click Save.
...
- To import a shared attribute set RHAS file, click Import in the Attribute Set dialog box. This will open the Attribute Set Folder Location. You can also browse to other locations if the attribute set RHAS file is not in the default location. Click the attribute set RHAS file and click OK to import it to the map.
Importing an attribute set RHAS file automatically saves it as an attribute set in the map.

- Optionally, click the Set as default button to make a customized attribute set the default for the map.
- Click Close  to close the Attribute Sets dialog box.
...
- In ArcGIS Pro, open an LRS feature service that has published attribute sets in a map.
- Click the Location Referencing tab, and in the Events group, click the Attribute Sets button .
- The Attribute Sets dialog box appears with the line event default attribute set visible.
...
![image1.png](../media/doc385_image1.png) ![image2.png](../media/doc385_image2.png) ![image3.png](../media/doc385_image3.png) ![image4.png](../media/doc385_image4.png) ![image5.png](../media/doc385_image5.png) ![image6.png](../media/doc385_image6.png) ![image7.png](../media/doc385_image7.png) ![image8.png](../media/doc385_image8.png) ![image9.png](../media/doc385_image9.png) ![image10.png](../media/doc385_image10.png)
