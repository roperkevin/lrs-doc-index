...
| Field | Value |
| --- | --- |
| **Doc** | 64 · Other · Experience Builder |
| **Product** | Roads & Highways · Pipeline Referencing |
| **Release** | — |
| **Issues** | [Beijing-R-D-Center/ExperienceBuilder-Web-Extensions#26748](https://devtopia.esri.com/Beijing-R-D-Center/ExperienceBuilder-Web-Extensions/issues/26748) |
...
<!-- related:begin -->
- [Branch Version Editing widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/29868-branch-version-editing-widget.md>) — similar text 0.60 · 1 title word · 1 filename word · same kind/surface <!-- rel:61 s=4.816 -->
- [LRS Identify widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/lrs-identify-widget.md>) — similar text 0.41 · 1 title word · 1 filename word · same kind/surface <!-- rel:905 s=3.825 -->
- [Experience Builder Branch Versioning widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/exb-branch-versioning-widget.md>) — similar text 0.38 · 1 title word · 1 filename word · same surface <!-- rel:101 s=3.783 -->
- [Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24838-dynseg-widget.md>) — similar text 0.33 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:118 s=3.737 -->
- [Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/29871-dynseg-widget.md>) — similar text 0.34 · 1 title word · 1 filename word · same kind/surface <!-- rel:57 s=3.684 -->
<!-- related:end -->
...
1. Add the LRS Controller widget to the canvas.

1. Add a Map widget to the canvas. Connect it to a web map with LRS data published with the Linear Referencing and Version Management capabilities enabled.

1. Connect the LRS Controller widget to the Map widget.

1. Add other widgets that have editing capabilities to the LRS Controller widget.

1. Publish the app.

1. Launch the app. If prompted, sign in to your ArcGIS Enterprise portal.

1. Optionally, on the LRS Controller widget, click the Date button to filter data by date.

1. Complete the following steps to create a new named version:

1. On the LRS Controller widget, click Version > Create Version.
The Create Version dialog box appears.

1. Provide a name for the new version in the Name text box.

1. Optionally, provide a desriptiondescription for the version in the Description text box.

1. Click Public, Protected, or Private to set the access level for the version.
...
1. Optionally, check the Switch to new version check box to switch to the version after it is created.
...
1. Edit data using other widgets.
...
![Figure 1 — Perform an end-to-end editing workflow with the LRS Controller widget](../media/26748-lrs-controller-widget/fig-01-perform-an-end-to-end-editing-workflow.png)
