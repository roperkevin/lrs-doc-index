...
source_file: "APR_routelogtemplate_20250219.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro35_Ent115/6271_RouteLog_Data_Product_Template/APR_routelogtemplate_20250219.docx"
doc_id: 201
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: "Doug Haller"
last_edited_by: ""
last_edited: "2025-03-09T23:52:38.1628794Z"
...
issues: []
related: [{"doc":203,"file":"create-a-template-for-an-lrs-route-log-data-product__doc203.md","s":6.704},{"doc":198,"file":"create-a-template-for-an-lrs-feature-count-data-product__doc198.md","s":4.4},{"doc":196,"file":"create-a-template-for-an-lrs-feature-count-data-product__doc196.md","s":3.956},{"doc":256,"file":"route-log-data-product-template-test-plan__doc256.md","s":3.874},{"doc":255,"file":"generate-a-route-log-including-spanning-events-and-centerline-test-plan__doc255.md","s":3.347}]
```
-->
...
<!-- related:begin -->
- [Create a template for an LRS route log data product](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/create-a-template-for-an-lrs-route-log-data-product__doc203.md>) — similar text 0.44 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:203 -->
- [Create a template for an LRS feature count data product](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/create-a-template-for-an-lrs-feature-count-data-product__doc198.md>) — similar text 0.33 · 2 title words · 1 filename word · same kind/surface <!-- rel:198 -->
- [Create a template for an LRS feature count data product](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/create-a-template-for-an-lrs-feature-count-data-product__doc196.md>) — similar text 0.29 · 2 title words · same kind/surface <!-- rel:196 -->
- [Route Log data product template – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/route-log-data-product-template-test-plan__doc256.md>) — similar text 0.26 · 3 title words · same surface <!-- rel:256 -->
- [Generate a route Log including spanning events and centerline – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/generate-a-route-log-including-spanning-events-and-centerline-test-plan__doc255.md>) — similar text 0.17 · 2 title words · same surface <!-- rel:255 -->
<!-- related:end -->
...
- Click the Data Product Type drop-down arrow and choose Route Log.
- Click Next.
...
- Provide a template name or browse to a location and provide a template name, then click OK.
...
- Optionally, update text in the Feature Begin Text and Feature End Text text boxes to indicate the start and end of routes.
The default values are Begin and End, as shown in the example.

- Optionally, provide text in the Field Value Prefix and Field Value Suffix text boxes to supplement information before and after the route identifier value, respectively.
...
- Click Add to create a blank row in the Log Fields table.
...
- Click the Field drop-down arrow and choose a field from the layer specified.
...
- Optionally, update text to appear before the start and end log fields in the Feature Begin Text and Feature End Text text boxes.
The default values are Begin and End.
Point events and intersections do not have a Feature Begin Text or Feature End Text.

- Optionally, provide Field Value Prefix and Field Value Suffix text.
...
- Optionally, click the Filter Expression drop-down arrow and provide an expression to filter specific log values.
...
- Optionally, check the Merge Coincident Events check box for line event log layers.
Checking this box returns coincident events with the same value in log field as a single event in the route log.

- Repeat the steps to add more log fields.
...
- Click Add to create a blank row in the Location Fields table.
...
- Click the Field drop-down arrow and choose a field from the location specified.
For this example, Operating Area is configured as the location field.

- Optionally, update display name in the Name in Table text box.
The Location value appears by default.
The text that appears here populates the blank row in the Location Fields.

- Optionally, update text to appear before the start and end log fields in the Feature Begin Text and Feature End Text text.
The default values are Begin and End.
...
- Optionally, click the Filter Expression drop-down arrow and provide an expression to filter by a specific location field.
...
- Repeat the steps to add more location fields.
...
- Click the Referent Located At drop-down arrow and choose a referent method.
...
- Optionally, update the display name for the Name in Table text box.
The Referent value appears by default.

- Optionally, provide text in the Field Value Prefix and Field Value Suffix text boxes.
...
- Click the Offset Unit drop-down arrow and choose a value.
...
![image1.png](../media/doc770_image1.png) ![image2.png](../media/doc770_image2.png) ![image3.png](../media/doc770_image3.png) ![image4.png](../media/doc770_image4.png) ![image5.png](../media/doc770_image5.png) ![image6.png](../media/doc770_image6.png) ![image7.png](../media/doc770_image7.png) ![image8.png](../media/doc770_image8.png) ![image9.png](../media/doc770_image9.png) ![image17.png](../media/doc770_image17.png) ![image18.png](../media/doc770_image18.png) ![image19.png](../media/doc770_image19.png)
