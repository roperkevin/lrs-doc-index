...
source_file: "AddPtDomi_APR.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5810_Add-Point-Dominant-Route/AddPtDomi_APR.docx"
doc_id: 309
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: "Claire Wang"
last_edited_by: ""
last_edited: "2024-09-10T00:05:52.0762945Z"
...
issues: []
related: [{"doc":310,"file":"adding-point-events-to-dominant-routes__doc310.md","s":8.362},{"doc":301,"file":"adding-linear-events-to-dominant-routes__doc301.md","s":5.951},{"doc":326,"file":"add-linear-events-to-dominant-routes__doc326.md","s":5.146},{"doc":235,"file":"add-point-events-by-location-offset__doc235.md","s":4.471},{"doc":234,"file":"add-point-events-by-location-offset__doc234.md","s":3.959}]
```
-->
...
<!-- related:begin -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes__doc310.md>) — similar text 0.76 · 5 title words · 2 filename words · same kind/surface/folder <!-- rel:310 -->
- [Adding Linear Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-linear-events-to-dominant-routes__doc301.md>) — similar text 0.44 · 4 title words · 2 filename words · same kind/surface <!-- rel:301 -->
- [Add Linear Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-linear-events-to-dominant-routes__doc326.md>) — similar text 0.45 · 3 title words · 1 filename word · same kind/surface <!-- rel:326 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset__doc235.md>) — similar text 0.32 · 2 title words · 2 filename words · same kind/surface <!-- rel:235 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset__doc234.md>) — similar text 0.31 · 2 title words · 1 filename word · same kind/surface <!-- rel:234 -->
<!-- related:end -->
...
- Specify a route by doing oneeither of the following:
...
- The start date default value is today's the current date, but you can change the date by doing one of the following:
...
![image1.png](../media/doc645_image1.png) ![image2.png](../media/doc645_image2.png) ![image3.png](../media/doc645_image3.png) ![image4.png](../media/doc645_image4.png) ![image5.png](../media/doc645_image5.png) ![image6.png](../media/doc645_image6.png) ![image7.png](../media/doc645_image7.png) ![image8.png](../media/doc645_image8.png) ![image9.png](../media/doc645_image9.png) ![image10.png](../media/doc645_image10.png) ![image11.png](../media/doc645_image11.png) ![image12.png](../media/doc645_image12.png)
