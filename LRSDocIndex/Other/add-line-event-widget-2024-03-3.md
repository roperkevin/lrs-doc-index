...
| Field | Value |
| --- | --- |
| **Doc** | 412 · Other · Experience Builder |
| **Product** | — |
| **Release** | — |
| **Issues** | — |
...
<!-- related:begin -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03.md>) — similar text 0.89 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:410 s=9.251 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03-4.md>) — similar text 0.83 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:413 s=9.074 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/add-line-event-widget-2024-03-2.md>) — similar text 0.83 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:411 s=8.565 -->
- [Add Line Event widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24791-add-line-event-widget.md>) — similar text 0.52 · 4 title words · 2 filename words · same kind/surface <!-- rel:138 s=5.758 -->
...
1. Specify the start location for the line eventSpecify a route for the line event to start from by doing either of the following:
...
![Figure 1 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-01-adding-line-event-by-route-and-measure.png)
![Figure 2 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-02-adding-line-event-by-route-and-measure.png)
![Figure 3 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-03-adding-line-event-by-route-and-measure.png)
![Figure 4 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-04-adding-line-event-by-route-and-measure.png)
![Figure 5 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-05-adding-line-event-by-route-and-measure.png)
![Figure 6 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-06-adding-line-event-by-route-and-measure.png)
![Figure 7 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-3/fig-07-adding-line-event-by-route-and-measure.png)
