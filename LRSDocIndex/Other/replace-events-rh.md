...
<!-- related:begin -->
- [Replace Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/replace-events-apr.md>) — similar text 0.70 · 2 title words · 2 filename words · same kind/surface/folder <!-- rel:122 s=9.32 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset-rh.md>) — similar text 0.41 · 1 title word · 1 filename word · same kind/surface <!-- rel:234 s=4.005 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset-apr.md>) — similar text 0.39 · 1 title word · 1 filename word · same kind/surface <!-- rel:235 s=3.939 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6134-add-multiple-line-events-by-route-and-measure.md>) — similar text 0.40 · 1 title word · 1 filename word · same kind/surface <!-- rel:120 s=3.589 -->
- [Event Editing Using Feature Edits](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/event-editing-using-feature-edits.md>) — similar text 0.35 · same kind/surface <!-- rel:319 s=2.794 -->
<!-- related:end -->
...
1. Click the Network drop-down arrow and choose the network to use as the source linear referencing method (LRM) for event replacement.

- Note:
- The LRS Network must be published as a feature service layer.

1. In the From: Route and Measure section, specify the route by doing either of the following:
...
1. In the To: Route and Measure section, specify a route by doing either of the following:
...
![Figure 1 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-01-event-editing-with-conflict-prevention.png)
![Figure 2 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-02-event-editing-with-conflict-prevention.png)
![Figure 3 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-03-event-editing-with-conflict-prevention.png)
![Figure 4 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-04-event-editing-with-conflict-prevention.png)
![Figure 5 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-05-event-editing-with-conflict-prevention.png)
![Figure 6 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-06-event-editing-with-conflict-prevention.png)
![Figure 7 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-07-event-editing-with-conflict-prevention.png)
![Figure 8 — Event editing with conflict prevention enabled](../media/replace-events-rh/fig-08-event-editing-with-conflict-prevention.png)
