...
| **Release** | — |
| **Issues** | — |
| **Source** | [calibrate_APR.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5581_calibrate_behavior/calibrate_APR.docx>) |
| **People** | author — · PE — · dev — |
| **Edited** | 2023-11-28 20:20 by Claire Wang |
| **Extracted** | 2026-09-04 · lane xmlstrip · format 3.0 · prompt v2.0.2 |
| **Keywords** | route calibration · event behavior · calibration point · event measures · route editing · line network · spanning events |
| **Tools** | Apply Event Behaviors · Generate Routes · Location Referencing route editing tools |
...
<!-- related:begin -->
- [Event Behavior for Route Calibration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-calibration-rh-2023-11.md>) — similar text 0.93 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:447 s=8.93 -->
- [Event Behavior for Route Calibration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-calibration-apr-2023-11.md>) — similar text 0.80 · 4 title words · 2 filename words · same kind/surface/folder <!-- rel:446 s=7.986 -->
- [Event Behavior for Route Calibration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-calibration-rh-2023-11-2.md>) — similar text 0.82 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:449 s=7.612 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02-2.md>) — similar text 0.55 · 3 title words · 1 filename word · same kind/surface <!-- rel:425 s=5.891 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02.md>) — similar text 0.56 · 3 title words · 1 filename word · same kind/surface <!-- rel:420 s=5.759 -->
<!-- related:end -->
...
![Figure 1 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-01-retire-event-behavior.png)
![Figure 2 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-02-retire-event-behavior.png)
![Figure 3 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-03-retire-event-behavior.png)
![Figure 4 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-04-retire-event-behavior.png)
![Figure 5 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-05-retire-event-behavior.png)
![Figure 6 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-06-retire-event-behavior.png)
![Figure 7 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-07-retire-event-behavior.png)
![Figure 8 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-08-retire-event-behavior.png)
![Figure 9 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-09-retire-event-behavior.png)
![Figure 10 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-10-retire-event-behavior.png)
![Figure 11 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-11-retire-event-behavior.png)
![Figure 12 — Retire event behavior](../media/eb-for-route-calibration-apr-2023-11-2/fig-12-retire-event-behavior.png)
