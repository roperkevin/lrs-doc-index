...
| **Release** | 3.6 |
| **Issues** | [ArcGISPro/ps-location-referencing#6125](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/6125) |
...
<!-- related:begin -->
- [Reassign Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/reassign-routes-apr-un-2023-09.md>) — similar text 0.41 · 1 title word · 1 filename word · same kind/surface <!-- rel:507 s=3.157 -->
- [ArcGIS Pro AI Assistant: Realign Route Subsequent Panes Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/pro-ai-assistant-realign-route-subsequent-panes.md>) — similar text 0.21 · 1 title word · 1 filename word · same surface <!-- rel:50 s=3.119 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6134-add-multiple-line-events-by-route-and-measure.md>) — similar text 0.23 · 1 filename word · same kind/surface/folder <!-- rel:120 s=3.117 -->
- [Reassign Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/reassign-routes-apr-un-2023-09-2.md>) — similar text 0.40 · 1 title word · 1 filename word · same kind/surface <!-- rel:508 s=3.106 -->
- [Pro AI Assistant Realign Route User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/pro-ai-assistant-realign-route-2025-12.md>) — similar text 0.18 · 1 title word · 1 filename word · same surface <!-- rel:91 s=2.878 -->
<!-- related:end -->
...
1. Zoom in to the location where you want to realign the route.

- Note:
- The centerline feature for realigning the route must exist in the centerline feature class before realigning the route.

1. On the Location Referencing tab, in the Routes group, click Realign .

- The Realign Route pane appears with the Select By Rectangle option  active by the default.

1. Select one or more centerlines by rectangle at the location of the new route.
...
1. Click the Allow choosing of one or more centerlines button .
...
1. Optionally, choose one or more rows from the Order column and use the buttons below the table to change the centerline selection order. You can also drag rows to change the order.
...
1. In the Realign Route pane, choose the network in which you want to realign a route.
...
1. Click the Specify an effective date for the realignment in the Effective Date drop-down arrow text box to choose an effective date for the realignment.
...
1. Optionally, if the centerline doesn't touch the route, use the pickers to populate the From Route Name, To Route Name, From Measure, and To Measure parameters.
...
1. Optionally, provide a start From mMeasure value.
...
1. Optionally, provide an end Target mMeasure value of your choice.
...
| If the realignment results in the creation of a new route and/ or abandoned routes | Click Next and proceed to step 14 .<br>The next screen allows you to give the new route a name and fill in any attributes you choose. |
| --- | --- |
| lf a new route and/or abandoned routes will not be created | Click Run and proceed to step 15 . |

1. Click Next.

1. Provide a name for the new route that will be created in the realigned portion, if one will be created.
...
1. Provide a name for each abandoned route.
...
![Figure 1 — Example 4](../media/6125-realign-routes/fig-01-example-4.png)
![Figure 2 — Example 4](../media/6125-realign-routes/fig-02-example-4.png)
![Figure 3 — Example 4](../media/6125-realign-routes/fig-03-example-4.jpg)
![Figure 4 — Example 4](../media/6125-realign-routes/fig-04-example-4.png)
![Figure 5 — Example 4](../media/6125-realign-routes/fig-05-example-4.png)
![Figure 6 — Example 4](../media/6125-realign-routes/fig-06-example-4.png)
![Figure 7 — Example 4](../media/6125-realign-routes/fig-07-example-4.png)
![Figure 8 — Example 4](../media/6125-realign-routes/fig-08-example-4.png)
![Figure 9 — Example 4](../media/6125-realign-routes/fig-09-example-4.png)
![Figure 10 — Example 4](../media/6125-realign-routes/fig-10-example-4.png)
![Figure 11 — Example 4](../media/6125-realign-routes/fig-11-example-4.png)
![Figure 12 — Example 4](../media/6125-realign-routes/fig-12-example-4.png)
