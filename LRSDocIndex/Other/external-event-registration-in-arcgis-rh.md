...
<!-- related:begin -->
- [External Event Registration in ArcGIS Pipeline Referencing](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/external-event-registration-in-arcgis-apr.md>) — similar text 0.92 · 3 title words · 3 filename words · same kind/surface/folder <!-- rel:243 s=11.504 -->
- [External system integration with ArcGIS Roads and Highways](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/external-system-integration-with-arcgis-rh.md>) — similar text 0.34 · 3 title words · 2 filename words · same kind/surface <!-- rel:246 s=5.093 -->
- [External system integration with ArcGIS Pipeline Referencing](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/external-system-integration-with-arcgis-apr.md>) — similar text 0.37 · 1 title word · 2 filename words · same surface <!-- rel:242 s=3.877 -->
- [Events Data Model](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/events-data-model-rh.md>) — similar text 0.36 · same kind/surface <!-- rel:247 s=3.374 -->
- [Create External Event with No Connection File](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-external-event-with-no-connection-file.md>) — similar text 0.28 · 2 title words · 1 filename word · same surface <!-- rel:288 s=2.95 -->
<!-- related:end -->
...
![Figure 1 — External events without a connection file](../media/external-event-registration-in-arcgis-rh/fig-01-external-events-without-a-connection.png)
![Figure 2 — External events without a connection file](../media/external-event-registration-in-arcgis-rh/fig-02-external-events-without-a-connection.png)
