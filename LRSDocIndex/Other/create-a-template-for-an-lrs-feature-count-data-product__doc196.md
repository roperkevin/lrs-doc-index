...
source_file: "RH_Template_FeatureCount_RR1.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro35_Ent115/6353_FeatureCount_Data_Product_Template/RH_Template_FeatureCount_RR1.docx"
doc_id: 196
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
last_edited_by: ""
last_edited: "2025-03-16T02:16:03.4226864Z"
...
issues: []
related: [{"doc":198,"file":"create-a-template-for-an-lrs-feature-count-data-product__doc198.md","s":8.184},{"doc":254,"file":"feature-count-template-test-plan__doc254.md","s":4.902},{"doc":258,"file":"lrs-data-template-create-a-template-feature-count__doc258.md","s":4.599},{"doc":147,"file":"generate-lrs-feature-count-location-referencing__doc147.md","s":4.14},{"doc":281,"file":"generate-feature-count-geoprocessing-tool__doc281.md","s":4.065}]
```
-->
...
<!-- related:begin -->
- [Create a template for an LRS feature count data product](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/create-a-template-for-an-lrs-feature-count-data-product__doc198.md>) — similar text 0.62 · 4 title words · 2 filename words · same kind/surface/folder <!-- rel:198 -->
- [Feature Count Template Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/feature-count-template-test-plan__doc254.md>) — similar text 0.22 · 2 title words · 2 filename words · same surface <!-- rel:254 -->
...
- [Generate LRS Feature Count (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/generate-lrs-feature-count-location-referencing__doc147.md>) — similar text 0.13 · 2 title words · 1 filename word · same kind/surface <!-- rel:147 -->
- [Generate Feature Count Geoprocessing Tool](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/generate-feature-count-geoprocessing-tool__doc281.md>) — similar text 0.18 · 2 title words · 2 filename words · same kind/surface <!-- rel:281 -->
<!-- related:end -->
...
- Click Add to create a blank row in the add a Ssummary Fields tablelevel.
...
- Once a summary field is chosen, the Display Value Map section shows a table of the unique values in the summary field. You can edit the Display Value column in the table.

Figure  SEQ Figure \* ARABIC 7 Preview after adding the summary field

- Optionally, Provideupdate the display a name for the summary level in the Name in Table text box.
For this example, the level name is City.

- Optionally, click the Filter Expression drop-down arrow and providedefine an expression to filter display values in the Display Value Map section.
- If you're want to adding multiple summary levels, repeat the previous steps for each level.
- Click Next.
...
- Optionally, click the Filter Expression drop-down arrow and providedefine an expression to filter the feature count layer.
- The next three feature count fields are Speed Limit Signs, Stop Signs and Approaching Signal Signs. All the three sign types are available inbelong to the Signs point event layer. To add these three fields together, use the Unique Values option in the Selection method and follow these complete the following steps:
- Click Add to create a blank row in the Feature Count Fields table.
- Click the Feature Count Layer drop-down arrow and choose Signs as the feature count layer.
- Choose Unique values in Click the Selection Method drop-down arrow and choose Unique Values.
...
- Click Add to create a blank row in the Feature Count Fields table.
- Click the Layer drop-down arrow and choose Speed as the feature count layer.
- Choose Single Value in the Selection Method drop-down.
- Add Speed Limit 20 as the Name in the table.
- Use the filter expression as shown below to filter line events that has a Speed Limit of 20:

Figure  SEQ Figure \* ARABIC 13 Adding a feature count field using the single value selection method

- Repeat steps 9-13 with a new name and new filter expression to filter line events that haves a Speed Limit of 40.
...
![image1.png](../media/doc796_image1.png) ![image3.png](../media/doc796_image3.png) ![image4.jpeg](../media/doc796_image4.jpeg) ![image5.jpeg](../media/doc796_image5.jpeg) ![image9.jpeg](../media/doc796_image9.jpeg) ![image11.jpeg](../media/doc796_image11.jpeg) ![image12.jpeg](../media/doc796_image12.jpeg) ![image13.jpeg](../media/doc796_image13.jpeg) ![image14.jpeg](../media/doc796_image14.jpeg)
