...
| **Issue** | [ArcGISPro/ps-location-referencing#6640](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/6640) |
...
source_file: "6640_5009_AppendEventsGP.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro36_Ent12/6640_5009_AppendEventsGP.docx"
doc_id: 124
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: ""
last_edited_by: ""
last_edited: "2025-09-09T18:01:56.4869175Z"
...
issues: ["ArcGISPro/ps-location-referencing#6640"]
related: [{"doc":156,"file":"allow-append-events-to-run-when-locks-are-present-test-plan__doc156.md","s":1003.244},{"doc":263,"file":"append-events-location-referencing__doc263.md","s":8.582},{"doc":525,"file":"append-events-location-referencing__doc525.md","s":6.833},{"doc":128,"file":"append-routes-location-referencing__doc128.md","s":5.133},{"doc":69,"file":"generate-events-location-referencing__doc69.md","s":4.2}]
```
-->
...
<!-- related:begin -->
- [Allow Append Events to Run When Locks Are Present - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/allow-append-events-to-run-when-locks-are-present-test-plan__doc156.md>) — shared issue ArcGISPro/ps-location-referencing#6640 · similar text 0.16 · 2 title words · 2 filename words · same surface <!-- rel:156 -->
...
- [Append Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/append-events-location-referencing__doc525.md>) — similar text 0.90 · 2 title words · 2 filename words · same kind/surface <!-- rel:525 -->
- [Append Routes (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/append-routes-location-referencing__doc128.md>) — similar text 0.48 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:128 -->
- [Generate Events (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/generate-events-location-referencing__doc69.md>) — similar text 0.46 · 1 title word · 1 filename word · same kind/surface <!-- rel:69 -->
<!-- related:end -->
...
| Field Map | Controls how the attribute information in the fields of the input event is transferred to the target event. Because the source event records are appended to an existing target event that has a predefined schema (field definitions), fields cannot be added or removed from the target event. While you can set merge rules for each output field, the tool ignores those rules. | Field Mappings |
| Load Type (Optional) | Specifies how appended events will be loaded into the target event. Add—The source event records will be appended to the specified target event. Retire overlaps— The source event records will be appended to the specified target event and any records that have the same measure or temporality overlaps as the appended events will be retired. If the appended event eclipses the specified target event record, the target event record will be deleted. Use this option for line events only. Retire by event ID—The source event records will be appended to the specified target event and any records that have the same event ID and temporality overlaps as the appended events will be retired. If the appended event eclipses a target event record that has the same event ID, the target event record will be deleted. Replace by event ID—The source event records will be appended to the specified target event, and any records that have the same event ID as the appended events will be replaced. | String |
| Generate Event ID GUIDs for loaded events (Optional) | Specifies whether event IDs will be generated for source event records being appended. Generation of event IDs will only be applied to source event records with a null value in the Event ID field. Checked—Event IDs for the source event records being appended will be generated. Unchecked—Event IDs for the source event records being appended will not be generated. This is the default. | Boolean |
| Generate Shapes (Optional) | Note: This parameter is no longer supported. | Boolean |
| Append events to dominant routes (Optional) | Specifies whether the source event records will be appended to the dominant routes if route concurrency exists. Checked—The source event records will be appended to the dominant routes. Unchecked—The source event records will be appended to the routes specified in the input dataset, regardless of route dominance. This is the default. This parameter works with all Load Type options: Add , Retire overlaps , Retire by event ID , and Replace by event ID . | Boolean |
| Append even if there are conflict prevention locks (Optional) | Specifies whether existing locks on the routes to which the events are being appended will be ignored. Checked — The route locks will be ignored. Unchecked — The route locks will not be ignored. This is the default. This parameter is only available when conflict prevention is enabled on the LRS dataset. | Boolean |
...
| field_mapping | Controls how the attribute information in the fields of the input event is transferred to the target event. Because the source event records are appended to an existing target event that has a predefined schema (field definitions), fields cannot be added or removed from the target event. While you can set merge rules for each output field, the tool ignores those rules. The FieldMappings class can be used to define this parameter. | Field Mappings |
| load_type (Optional) | Specifies how appended events will be loaded into the target event. ADD— The source event records will be appended to the specified target event. RETIRE_OVERLAPS—The source event records will be appended to the specified target event and any records that have the same measure or temporality overlaps as the appended events will be retired. If the appended event eclipses the specified target event record, the target event record will be deleted. Use this option for line events only. RETIRE_BY_EVENT_ID—The source event records will be appended to the specified target event and any records that have the same event ID and temporality overlaps as the appended events will be retired. If the appended event eclipses a target event record that has the same event ID, the target event record will be deleted. REPLACE_BY_EVENT_ID—The source event records will be appended to the specified target event, and any records that have the same event ID as the appended events will be replaced. | String |
| generate_event_ids (Optional) | Specifies whether event IDs will be generated for source event records being appended. Generation of event IDs will only be applied to source event records with a null value in the Event ID field. GENERATE_EVENT_IDS—Event IDs for the source event records being appended will be generated. NO_GENERATE_EVENT_IDS—Event IDs for the source event records being appended will not be generated. This is the default. | Boolean |
| generate_shapes (Optional) | Note: This parameter is no longer supported. | Boolean |
| append_to_dominant_route (Optional) | Specifies whether the in_dataset records will be appended to the dominant routes if route concurrency exists. APPEND_TO_DOMINANT_ROUTE—The source event records will be appended to the dominant routes. NO_APPEND_TO_DOMINANT_ROUTE—The source event records will be appended to the routes specified in the input dataset, regardless of route dominance. This is the default. This parameter works with all load_type options: ADD , RETIRE_OVERLAPS , RETIRE_BY_EVENT_ID , and REPLACE_BY_EVENT_ID . | Boolean |
| bypass _conflict_prevention (Optional) |  | Boolean |
