...
| **Issue** | [ArcGISPro/ps-location-referencing#4246](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/4246) |
...
<!-- metadata
```yaml
title: "Caltrans Roads and Highways Migration Project"
source_file: "4246_6811_762003001618777852.pdf"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/4246_6811_762003001618777852.pdf"
doc_id: 718
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
issues: ["ArcGISPro/ps-location-referencing#4246"]
related: [{"doc":885,"file":"arcgis-pipeline-referencing-an-introduction__doc885.md","s":2.395},{"doc":569,"file":"migrate-lrs-to-new-gdb-tool__doc569.md","s":2.381},{"doc":613,"file":"deployment-guide-ready-to-use-lrs-checks-attribute-rules__doc613.md","s":2.178},{"doc":43,"file":"linear-referencing-gp-toolbox-consolidation__doc43.md","s":2.028},{"doc":720,"file":"adots-multi-prong-approach-to-safeguard-lrs-data-quality__doc720.md","s":1.937}]
```
-->
...
<!-- related:begin -->
- [ArcGIS Pipeline Referencing: An Introduction](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/arcgis-pipeline-referencing-an-introduction__doc885.md>) — similar text 0.09 · same kind/surface/folder <!-- rel:885 -->
- [Migrate LRS to New GDB Tool](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/migrate-lrs-to-new-gdb-tool__doc569.md>) — similar text 0.05 · same surface/folder <!-- rel:569 -->
- [Deployment Guide: Ready-to-Use LRS Checks Attribute Rules](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/deployment-guide-ready-to-use-lrs-checks-attribute-rules__doc613.md>) — similar text 0.06 · same kind/surface/folder <!-- rel:613 -->
- [Linear Referencing GP Toolbox Consolidation](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/linear-referencing-gp-toolbox-consolidation__doc43.md>) — similar text 0.06 · same surface/folder <!-- rel:43 -->
- [ADOT’s Multi-prong Approach to SafeGuard LRS Data Quality](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adots-multi-prong-approach-to-safeguard-lrs-data-quality__doc720.md>) — similar text 0.04 · same kind/folder <!-- rel:720 -->
<!-- related:end -->
...
Highways Migration
Project
 ANDY RICHARDSON                             ANDRÉA COMPTON
 andy.richardson@dot.ca.gov                  andrea.compton@rizing.com
...
Overview
 ...
    Caltrans
     ...
      Roads and Highways Proof of Concept and Statewide Migration
        projects
...
   Transportation System Network (TSN)               Introduced SOAP Postmile Web Service
    database (Oracle)                                 ArcMap Add-In geocoding tool
...
   Business Case                                Roadmap
      GeoMedia was a stopgap solution              System Development Plan
         to meet FHWA All Roads Network of               Guiding plan for implementation
         Linear Referenced Data (ARNOLD)
         requirement                                Vendor demonstrations

                                                         Esri & Hexagon (GeoMedia)
      Allowed time to evaluate, plan and
         implement a “permanent” solution           Roads and Highways selection

                                                         Vote by Geospatial Governance
                                                          Board
                                                         Informed by Department geospatial
                                                          professionals
...
Implementation
    Proof of Concept Project (Transcend Spatial Solutions, July 2017 – April
     ...
        Two counties (of 58)
        Main purpose was to figure out how to model the Caltrans Postmile System
         and business data in Roads and Highways
...
Caltrans Postmile System
    Centerline-based system, with some Independent Alignments (of
     different lengths)
 ...
    Temporality (Realignments, realignments of realignments, route
     adoptions) handled using Postmile Prefixes
                                                                             CO RT   PM
                                                                            ALA 580  45.9
                                                                            ALA 880 R33.8
                                                                            ALA 880 R34.8R
...
0                                                            (10.502 – 0) + (1.949 – 0) + (31.727 – 2.224) =          41.954
    ...
        REST API “measureToGeometry”                       "toMeasure" : 15.678 },         Route       880
         function supports RouteId and                                                                 Route Suffix       .
    ...
        Status                                                          Remaining work & challenges
           ...
            LRS staff has updated all SHS updates                             Properly managing event behavior
              accumulated from 10/2019 to 10/2020
...
   Challenges                                           Wins
    ...
     Rollout of ArcGIS Pro version of R&H (with            production with Roads and
      significantly different functionality) as the         Highways
      Statewide Migration project was starting
     Maturity of ArcGIS Pro version of R&H
      (waiting for releases/complete
      functionality)
...
Iterative Approach
 ...
    Iteration 2: Statewide Migration
     ...
      Preformed full statewide routes migration and developed a migration process for
        all events
...
   Used Data Reviewer for validating the networks
     Focusing on checks that would/could cause issues
       with calibrating the routes in R&H
   Performed mileage comparison on events to
    ensure mileage wasn’t lost and identified a reason
    if it was
   Created a gaps and overlaps event checks in
    ModelBuilder and python scripts
   Reviewed Location Errors across each step of the
    migration
