...
<!-- metadata
```yaml
title: "Configure Utility Network Feature Class (Location Referencing)"
source_file: "Configure Utility Network Feature Class.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro37_Ent121/7079_ConfigureUNFC_GP/Configure%20Utility%20Network%20Feature%20Class.docx"
doc_id: 84
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: ""
last_edited_by: ""
last_edited: "2026-01-08T21:59:19.1566871Z"
...
issues: []
related: [{"doc":74,"file":"manage-pipeline-referencing-and-a-utility-network-together__doc74.md","s":4.991},{"doc":85,"file":"configureutilitynetworkfeatureclass-python-example__doc85.md","s":4.834},{"doc":67,"file":"view-utility-network-feature-class-properties__doc67.md","s":4.722},{"doc":88,"file":"configureutilitynetworkfeatureclass-example-2-stand-alone-script__doc88.md","s":4.65},{"doc":249,"file":"configure-address-feature-classes-location-referencing__doc249.md","s":4.442}]
```
-->
...
<!-- related:begin -->
- [Manage Pipeline Referencing and a Utility Network Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/manage-pipeline-referencing-and-a-utility-network-together__doc74.md>) — similar text 0.20 · 2 title words · 2 filename words · same kind/surface <!-- rel:74 -->
- [ConfigureUtilityNetworkFeatureClass Python Example](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/configureutilitynetworkfeatureclass-python-example__doc85.md>) — similar text 0.48 · same kind/surface/folder <!-- rel:85 -->
- [View Utility Network Feature Class Properties](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/view-utility-network-feature-class-properties__doc67.md>) — similar text 0.28 · 4 title words · same kind/surface <!-- rel:67 -->
- [ConfigureUtilityNetworkFeatureClass example 2 (stand-alone script)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/configureutilitynetworkfeatureclass-example-2-stand-alone-script__doc88.md>) — similar text 0.57 · same kind/surface/folder <!-- rel:88 -->
- [Configure Address Feature Classes (Location Referencing)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configure-address-feature-classes-location-referencing__doc249.md>) — similar text 0.38 · 2 title words · 2 filename words · same kind/surface <!-- rel:249 -->
<!-- related:end -->
...
| Line Route ID Field | The field in the Pipeline Line feature class that will be mapped as the route ID field in the LRS Network Route ID . The data type and length of the field must match those of the corresponding field in the LRS centerline sequence table . | Field |
...
| Devices Route ID Field | The field in the Pipeline Device feature class that contains the route ID attribute. The data type and length of the field must match those of the corresponding field in the LRS centerline sequence table . | Fie ld |
...
| Junct i ons Route ID Field | The field in the Pipeline Junction feature class that contains the route ID attribute. The data type and length of the field must match those of the corresponding field in the LRS centerline sequence table . | Field |
