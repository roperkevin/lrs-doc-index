...
| **Product** | — |
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#5747](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/5747) |
...
<!-- related:begin -->
- [Pro 3.4 and 11.4 User Acceptance Issues and Documentation Updates](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Schedules/504-pro-3-4-and-11-4-user-acceptance-issues-and-documentation.md>) — shared issue ArcGISPro/ps-location-referencing#5747 · similar text 0.06 · same surface/folder <!-- rel:194 s=1001.232 -->
- [Prepare Data for Sharing Web Layers with Linear Referencing and Version Management](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/7018-prepare-data-for-sharing-web-layers-with-lr-and-version.md>) — similar text 0.37 · 2 title words · 3 filename words · same kind/surface <!-- rel:116 s=6.041 -->
- [Esri Roads and Highways Tutorial](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/esri-rh-tutorial.md>) — similar text 0.29 · same kind/surface <!-- rel:875 s=3.071 -->
- [Location Referencing GP Error Messages](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/3147-lr-gp-error-messages.md>) — similar text 0.21 · same kind/surface/folder <!-- rel:39 s=3.004 -->
- [Manage Address and Roadway Characteristic Data Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5930-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.23 · same kind/surface/folder <!-- rel:327 s=2.864 -->
<!-- related:end -->
...
1. Depending on the data, do one of the following:
...
1. Right-click the geodatabase in the Catalog pane and click Geodatabase Connection Properties.

- The geodatabase connection must be explicitly set to the branch versioning connection type.

1. Ensure that all of the data layers in the database have the following:
...
1. Register the following items in the LRS geodatabase as branch versioned:
...
1. Enable time on the LRS data layers on a layer-by-layer basis or enable time for all the LRS layers in a map at once.
...
1. Create a map in an ArcGIS Pro project, and add the appropriate routes, event layers, calibration points, centerline, and optionally, a redline layer.

1.

1. Right-click the map in the Contents pane and click Properties.

1. On the Map Properties dialog box, check Allow assignment of unique numeric IDs for sharing web layers under the General tab and click OK.
...
1. Provide a name for the web layer.

1. Optionally, complete the Summary and Tags fields.
...
1. Specify how the web layer is shared:
...
1. On the Configuration tab, in the Capabilities section, check the Linear Referencing and Version Management check boxes.

1. Click Analyze to check for errors and issues. You must resolve all errors before you can complete the publishing process.
...
1. Once validated, click Publish to share the web layer.
...
![Figure 1 — Publish data](../media/5747-share-as-web-layers/fig-01-publish-data.png)
![Figure 2 — Publish data](../media/5747-share-as-web-layers/fig-02-publish-data.png)
![Figure 3 — Publish data](../media/5747-share-as-web-layers/fig-03-publish-data.png)
