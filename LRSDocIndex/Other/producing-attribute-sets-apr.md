...
<!-- related:begin -->
- [Producing Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/producing-attribute-sets-rh.md>) — similar text 0.87 · 3 title words · 2 filename words · same kind/folder <!-- rel:551 s=7.53 -->
- [Configuring Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configuring-attribute-sets-apr.md>) — similar text 0.61 · 2 title words · 2 filename words · same kind/folder <!-- rel:554 s=5.228 -->
- [Configuring Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configuring-attribute-sets-rh.md>) — similar text 0.59 · 2 title words · 1 filename word · same kind/folder <!-- rel:553 s=4.674 -->
- [Configure Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/configure-attribute-sets-apr.md>) — similar text 0.36 · 2 title words · 1 filename word · same kind/folder <!-- rel:556 s=4.159 -->
- [Configure Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configure-attribute-sets-rh.md>) — similar text 0.36 · 2 title words · same kind/folder <!-- rel:555 s=3.671 -->
<!-- related:end -->
...
![Figure 1 — About Esri](../media/producing-attribute-sets-apr/fig-01-about-esri.png)
![Figure 2 — About Esri](../media/producing-attribute-sets-apr/fig-02-about-esri.png)
![Figure 3 — About Esri](../media/producing-attribute-sets-apr/fig-03-about-esri.png)
![Figure 4 — About Esri](../media/producing-attribute-sets-apr/fig-04-about-esri.png)
![Figure 5 — About Esri](../media/producing-attribute-sets-apr/fig-05-about-esri.png)
![Figure 6 — About Esri](../media/producing-attribute-sets-apr/fig-06-about-esri.png)
![Figure 7 — About Esri](../media/producing-attribute-sets-apr/fig-07-about-esri.png)
![Figure 8 — About Esri](../media/producing-attribute-sets-apr/fig-08-about-esri.png)
![Figure 9 — About Esri](../media/producing-attribute-sets-apr/fig-09-about-esri.png)
![Figure 10 — About Esri](../media/producing-attribute-sets-apr/fig-10-about-esri.png)
![Figure 11 — About Esri](../media/producing-attribute-sets-apr/fig-11-about-esri.png)
![Figure 12 — About Esri](../media/producing-attribute-sets-apr/fig-12-about-esri.png)
