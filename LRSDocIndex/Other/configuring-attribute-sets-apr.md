...
| Field | Value |
| --- | --- |
| **Doc** | 554 · Other · Experience Builder |
...
<!-- related:begin -->
- [Configuring Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configuring-attribute-sets-rh.md>) — similar text 0.81 · 3 title words · 2 filename words · same kind/surface/folder <!-- rel:553 s=7.007 -->
- [Producing Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/producing-attribute-sets-apr.md>) — similar text 0.61 · 2 title words · 2 filename words · same kind/folder <!-- rel:552 s=5.228 -->
- [Producing Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/producing-attribute-sets-rh.md>) — similar text 0.60 · 2 title words · 1 filename word · same kind/surface/folder <!-- rel:551 s=5.207 -->
- [Configure Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/configure-attribute-sets-apr.md>) — similar text 0.39 · 2 title words · 1 filename word · same kind/folder <!-- rel:556 s=3.818 -->
- [Configure Attribute Sets](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/configure-attribute-sets-rh.md>) — similar text 0.38 · 2 title words · same kind/folder <!-- rel:555 s=3.294 -->
<!-- related:end -->
...
1. Click Import and browse to the location of your ArcGIS Pipeline Referencing attribute set .rhas file.
...
![Figure 1 — About Esri](../media/configuring-attribute-sets-apr/fig-01-about-esri.png)
![Figure 2 — About Esri](../media/configuring-attribute-sets-apr/fig-02-about-esri.png)
![Figure 3 — About Esri](../media/configuring-attribute-sets-apr/fig-03-about-esri.png)
![Figure 4 — About Esri](../media/configuring-attribute-sets-apr/fig-04-about-esri.png)
![Figure 5 — About Esri](../media/configuring-attribute-sets-apr/fig-05-about-esri.png)
![Figure 6 — About Esri](../media/configuring-attribute-sets-apr/fig-06-about-esri.png)
![Figure 7 — About Esri](../media/configuring-attribute-sets-apr/fig-07-about-esri.png)
![Figure 8 — About Esri](../media/configuring-attribute-sets-apr/fig-08-about-esri.png)
![Figure 9 — About Esri](../media/configuring-attribute-sets-apr/fig-09-about-esri.png)
![Figure 10 — About Esri](../media/configuring-attribute-sets-apr/fig-10-about-esri.png)
![Figure 11 — About Esri](../media/configuring-attribute-sets-apr/fig-11-about-esri.png)
![Figure 12 — About Esri](../media/configuring-attribute-sets-apr/fig-12-about-esri.png)
