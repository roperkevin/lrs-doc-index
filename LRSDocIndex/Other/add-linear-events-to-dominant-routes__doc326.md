...
<!-- metadata
```yaml
title: "Add Linear Events to Dominant Routes"
source_file: "AddLinearEvents_DominantRoute_RH.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5858_line-event-dominant-route/AddLinearEvents_DominantRoute_RH.docx"
doc_id: 326
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: ""
last_edited_by: ""
last_edited: "2024-08-29T22:36:33.1332212Z"
...
issues: []
related: [{"doc":301,"file":"adding-linear-events-to-dominant-routes__doc301.md","s":9.11},{"doc":310,"file":"adding-point-events-to-dominant-routes__doc310.md","s":5.435},{"doc":309,"file":"adding-point-events-to-dominant-routes__doc309.md","s":5.146},{"doc":120,"file":"add-multiple-line-events-by-route-and-measure__doc120.md","s":4.915},{"doc":370,"file":"add-line-event-to-dominant-route-in-arcgis-pro__doc370.md","s":4.176}]
```
-->
...
<!-- related:begin -->
- [Adding Linear Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-linear-events-to-dominant-routes__doc301.md>) — similar text 0.57 · 4 title words · 5 filename words · same kind/surface/folder <!-- rel:301 -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes__doc310.md>) — similar text 0.46 · 3 title words · 1 filename word · same kind/surface <!-- rel:310 -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes__doc309.md>) — similar text 0.45 · 3 title words · 1 filename word · same kind/surface <!-- rel:309 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-multiple-line-events-by-route-and-measure__doc120.md>) — similar text 0.39 · 2 title words · 2 filename words · same kind/surface <!-- rel:120 -->
- [Add Line Event to Dominant Route in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-event-to-dominant-route-in-arcgis-pro__doc370.md>) — similar text 0.17 · 2 title words · 2 filename words · same surface <!-- rel:370 -->
<!-- related:end -->
...
- Click Choose route from map  and select the route on the map to populate the Route ID value.
- Note:
...
- Click the Edit tab.
- In the Edit Events group, click Line Events .
...
- Provide the route ID on which the event's From Measure will be located.
- Tip:
- You can also click Select a Route on the Map  to select the route on the map.
- In the From section, choose the first option (with the suffix Network) in the Method drop-down list.
...
- For the To Measure value, repeat steps 4 through 6 for the To section.
...
- Check the Save events to dominant routes check box.
...
- To access more information about the attribute set, do any of the following:
...
![image1.png](../media/doc639_image1.png) ![image2.png](../media/doc639_image2.png) ![image3.png](../media/doc639_image3.png) ![image4.png](../media/doc639_image4.png) ![image5.png](../media/doc639_image5.png) ![image16.png](../media/doc639_image16.png) ![image28.png](../media/doc639_image28.png) ![image29.png](../media/doc639_image29.png) ![image30.png](../media/doc639_image30.png) ![image31.png](../media/doc639_image31.png) ![image33.png](../media/doc639_image33.png) ![image34.png](../media/doc639_image34.png)
