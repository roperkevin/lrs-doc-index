...
<!-- related:begin -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes-apr.md>) — similar text 0.76 · 5 title words · 2 filename words · same kind/surface/folder <!-- rel:309 s=8.362 -->
- [Adding Linear Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-linear-events-to-dominant-routes.md>) — similar text 0.45 · 4 title words · 1 filename word · same kind/surface <!-- rel:301 s=5.475 -->
- [Add Linear Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-linear-events-to-dominant-routes.md>) — similar text 0.46 · 3 title words · 1 filename word · same kind/surface <!-- rel:326 s=5.435 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset-rh.md>) — similar text 0.33 · 2 title words · 1 filename word · same kind/surface <!-- rel:234 s=4.013 -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset-apr.md>) — similar text 0.33 · 2 title words · 1 filename word · same kind/surface <!-- rel:235 s=4.001 -->
<!-- related:end -->
...
1. Specify a route by doing either of the following:
...
1. The start date default value is today's date, but you can change the date by doing one of the following:
...
![Figure 1 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-01-add-point-events-to-dominant-routes.png)
![Figure 2 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-02-add-point-events-to-dominant-routes.png)
![Figure 3 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-03-add-point-events-to-dominant-routes.png)
![Figure 4 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-04-add-point-events-to-dominant-routes.png)
![Figure 5 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-05-add-point-events-to-dominant-routes.png)
![Figure 6 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-06-add-point-events-to-dominant-routes.png)
![Figure 7 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-07-add-point-events-to-dominant-routes.png)
![Figure 8 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-08-add-point-events-to-dominant-routes.png)
![Figure 9 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-09-add-point-events-to-dominant-routes.png)
![Figure 10 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-10-add-point-events-to-dominant-routes.png)
![Figure 11 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-11-add-point-events-to-dominant-routes.png)
![Figure 12 — Add point events to dominant routes](../media/adding-point-events-to-dominant-routes-rh/fig-12-add-point-events-to-dominant-routes.png)
