...
| **Release** | — |
| **Issues** | — |
| **Source** | [EB.retire.APR.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5515_retirement_behavior/EB.retire.APR.docx>) |
| **People** | author — · PE — · dev — |
| **Edited** | 2024-01-05 19:33 by Ignacia Galvan |
| **Extracted** | 2026-09-04 · lane xmlstrip · format 3.0 · prompt v2.0.2 |
| **Keywords** | route retirement · event behavior · event retirement · gapped route · line network · event splitting · event relocation |
| **Tools** | Apply Event Behaviors |

## Summary

This document explains how events are affected when routes are retired in a linear referencing system. It details the impact of different configured event behaviors—Stay Put, Move, and Retire—on events upstream, intersecting, and downstream of the retired route sections. Examples illustrate route and event states before and after retirement, including scenarios with routes spanning multiple segments in a line network.

## Related documents

<!-- related:begin -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-rh-2024-01.md>) — similar text 0.90 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:440 s=7.944 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02-2.md>) — similar text 0.75 · 4 title words · 2 filename words · same kind/surface <!-- rel:425 s=7.763 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-apr-2024-01-2.md>) — similar text 0.72 · 4 title words · 2 filename words · same kind/surface/folder <!-- rel:443 s=7.685 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02.md>) — similar text 0.74 · 4 title words · 2 filename words · same kind/surface <!-- rel:420 s=7.458 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-rh-2024-01-2.md>) — similar text 0.72 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:442 s=7.454 -->
<!-- related:end -->
...
In this example, the route Route1 is active from 1/1/2000. The retirement is set to occur in the middle of the route on 1/1/2005. The Recalibrate route downstream option is not chosen. The graphics and tables below demonstrate the route information before and after the retirement.
...
There are three events on Route1 and all of them have a startFrom dDate (From Date) of 1/1/2000. The following image shows the route and events before the retirement: (Please use updated svg and use the title as hover text
...
| --- | --- | --- | --- | --- | --- | --- |
| Event1 | Route1 | 1/1/2000 | 1/1/2005 | 0 | 20 | No Error |
| Event1 | Route1 | 1/1/2005 | <Null> | 0 | 20 | Partial match for the to end ing measure |
| Event 2 | Route1 | 1/1/2000 | 1/1/2005 | 20 | 3 0 | No Error |
| Event 2 | Route1 | 1/1/2005 | <Null> | 20 | 3 0 | Route Location Not Found |
| Event3 | Route1 | 1/1/2000 | 1/1/2005 | 30 | 45 | No Error |
| Event3 | Route1 | 1/1/2005 | <Null> | 30 | 45 | Partial match for the from starting measure |
...
- Event2 retires on the date of the retirement since because it is completely inside the retired region.
- Event3 retires on the date of the retirement since because it intersects the retired region.
The following image shows the route and events after the retirement: (Please use updated svg and use the title as hover text
...
- Event1 is retired on the date of the retirement since because part of it is in the edit section. A new event is created on the post-retirement route with the retirement date as the From start Ddate. The From start and endTo Mmeasure values are changed to measure 0 on Route1 and to 22 on Route2, respectively, since because Route3 is no longer present in the line.
- Event2 is retired on the date of the retirement since because part of it is in the edit section. A new event is created on the post-retirement route with the retirement date as the From start Ddate. The From start and To end mMeasure values are changed to measure 38 on Route4 andto 48 on Route4, respectively, since because Route3 is no longer present in the line.
...
![Figure 1 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-01-retire-event-behavior.png)
![Figure 2 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-02-retire-event-behavior.png)
![Figure 3 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-03-retire-event-behavior.png)
![Figure 4 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-04-retire-event-behavior.png)
![Figure 5 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-05-retire-event-behavior.png)
![Figure 6 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-06-retire-event-behavior.png)
![Figure 7 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-07-retire-event-behavior.png)
![Figure 8 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-08-retire-event-behavior.png)
![Figure 9 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-09-retire-event-behavior.png)
![Figure 10 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-10-retire-event-behavior.png)
![Figure 11 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-11-retire-event-behavior.png)
![Figure 12 — Retire event behavior](../media/eb-for-route-retirement-apr-2024-01/fig-12-retire-event-behavior.png)
