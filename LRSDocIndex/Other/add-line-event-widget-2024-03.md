...
| Field | Value |
| --- | --- |
| **Doc** | 410 · Other · Experience Builder |
| **Product** | — |
| **Release** | — |
| **Issues** | — |
| **Source** | [Doc_AddSingleLineAPR_fixed.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/LR%20Product%20Engineers/Doc_AddSingleLineAPR_fixed.docx>) |
| **People** | author Mac Christmas · PE — · dev — |
| **Edited** | 2024-03-06 22:56 by Claire Wang |
| **Extracted** | 2026-09-04 · lane xmlstrip · format 3.0 · prompt v2.0.2 |
| **Keywords** | line event · route · measure · linear referencing system · experience builder · event layer · merge coincident events · retire overlapping events |
| **Tools** | Add Line Event |

## Summary

Describes the Add Line Event widget used to create new line events along routes in a Linear Referencing System (LRS). Covers widget parameters, configuration settings, usage examples, and detailed steps for adding line events by route and measure in an Experience Builder application.

## Related documents

<!-- related:begin -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/add-line-event-widget-2024-03-2.md>) — similar text 0.85 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:411 s=9.358 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03-3.md>) — similar text 0.89 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:412 s=9.251 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03-4.md>) — similar text 0.83 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:413 s=8.939 -->
- [Add Line Event widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24791-add-line-event-widget.md>) — similar text 0.53 · 4 title words · 2 filename words · same kind/surface <!-- rel:138 s=5.809 -->
- [Experience Builder: Add Single Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/16340-exb-add-single-line-event-widget.md>) — similar text 0.26 · 4 title words · 3 filename words · same surface <!-- rel:455 s=5.222 -->
<!-- related:end -->
...
## Add Line Event
The Add Line Event widget allows you to create new line events along routes in an LRS (Linear Referencing System). Characteristics of a route, such as DOT class and Inspection Range, can be represented as line events with measure information along the route.
...
- From Route Name-Provide a route name and the start location for the line events to be added on this route.
...
- To Route Name-Provide a route name and the end location for the line events to be added on this route.
...
- Layer Configuration-Select the event layer to add events. For each layer, specify the following settings:
...
1. Use the default line event layer or click the Event Layer drop-down arrow and choose another line event layer.

The selected Network value is based on the selected event layer.

1. Specify the start location for the line event by doing either of the following:
...
![Figure 1 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03/fig-01-adding-line-event-by-route-and-measure.png)
![Figure 2 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03/fig-02-adding-line-event-by-route-and-measure.png)
![Figure 3 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03/fig-03-adding-line-event-by-route-and-measure.png)
![Figure 4 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03/fig-04-adding-line-event-by-route-and-measure.png)
![Figure 5 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03/fig-05-adding-line-event-by-route-and-measure.png)
