...
| Field | Value |
| --- | --- |
| **Doc** | 151 · Other · Experience Builder |
| **Product** | Roads & Highways · Pipeline Referencing |
| **Release** | — |
| **Issues** | [Beijing-R-D-Center/ExperienceBuilder-Web-Extensions#26266](https://devtopia.esri.com/Beijing-R-D-Center/ExperienceBuilder-Web-Extensions/issues/26266) |
| **Source** | [26266_SLDInteractwithMap_V1.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro36_Ent12/26266_SLDInteractwithMap_V1.docx>) · rev V1 |
...
<!-- related:begin -->
- [Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24838-dynseg-widget.md>) — similar text 0.92 · 3 title words · same kind/surface/folder <!-- rel:118 s=7.517 -->
- [Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/26160-dynseg-widget.md>) — similar text 0.89 · 3 title words · same kind/surface <!-- rel:60 s=6.919 -->
- [Dynamic Segmentation widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/29871-dynseg-widget.md>) — similar text 0.81 · 3 title words · same kind/surface <!-- rel:57 s=6.747 -->
- [Add Point Event widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24791-add-point-event-widget.md>) — similar text 0.42 · 1 title word · same kind/surface <!-- rel:139 s=3.594 -->
- [Add Line Event widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24791-add-line-event-widget.md>) — similar text 0.39 · 1 title word · same kind/surface <!-- rel:138 s=3.507 -->
<!-- related:end -->
...
1. Select events to be dynamically segmented with either the LRS Identify widget, Search By Route widget, or Table widget.
