...
<!-- related:begin -->
- [Manage Roads and Highways with Address Data Management](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5646-manage-rh-with-address-data-management.md>) — shared issue ArcGISPro/ps-location-referencing#5646 · similar text 0.76 · 2 title words · same kind/surface/folder <!-- rel:403 s=1007.202 -->
- [Pro 3.3 and 11.3 Iteration Issue Tracking](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Schedules/504-pro-3-3-and-11-3-iteration-issue-tracking.md>) — shared issue ArcGISPro/ps-location-referencing#5646 · similar text 0.02 · same surface/folder <!-- rel:366 s=1001.4 -->
- [Manage Address and Roadway Characteristic Data Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5930-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.92 · 5 title words · same kind/surface/folder <!-- rel:327 s=10.537 -->
- [Manage Address and Roadway Characteristic Data Together with Roads and Highways and Address Data Management Solution](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5783-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.84 · 5 title words · same kind/surface <!-- rel:276 s=9.113 -->
- [Manage address and roadway characteristic data together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.77 · 5 title words · same kind/surface <!-- rel:96 s=7.567 -->
<!-- related:end -->
...
1. Create an LRS line event using either the Create LRS Event or Create LRS Event From Existing Dataset tool.

- Note:
- Add the FromLeft, ToLeft, FromRight, and ToRight fields to the LRS line event.

1. Run the Configure Address Feature Classes tool to associate the Centerline or line event and the Site Address feature classes as part of the Address Data Management solution and LRS.

1. Create one or more LRS Network using either the Create LRS Network or Create LRS Network From Existing Dataset tool.
...
1. https://prodev.arcgis.com/en/pro-app/3.3/help/production/roads-highways/share-as-web-layers.htm \hPublish an LRS in a service.
...
1. Provide address values into the FromLeft, ToLeft, FromRight, and ToRight fields.
...
1. To create or edit LRS events, use the event editing tools on the Location Referencing tab in ArcGIS Pro, the ArcGIS Event Editor web app, or ArcGIS Experience Builder Location Referencing widgets.
...
![Figure 1 — Analysis capabilities in a combined LRS and address management dataset](../media/5646-manage-address-and-roadway-characteristic-data-together/fig-01-analysis-capabilities-in-a-combined-lrs.png)
