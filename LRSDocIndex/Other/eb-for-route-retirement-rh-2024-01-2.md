...
| **Release** | — |
| **Issues** | — |
| **Source** | [TrackChange.EB.retire.RH.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/5515_retirement_behavior/TrackChange.EB.retire.RH.docx>) |
| **People** | author Claire Wang · PE — · dev — |
| **Edited** | 2024-01-05 03:24 by Ignacia Galvan |
| **Extracted** | 2026-09-04 · lane xmlstrip · format 3.0 · prompt v2.0.2 |
| **Keywords** | route retirement · event behavior · stay put · move · retire · line network · time slice · event splitting · event retirement |
| **Tools** | Apply Event Behaviors |

## Summary

This document explains how events are affected when routes are retired in a linear referencing system. It details the impact of different configured event behaviors—Stay Put, Move, and Retire—on events upstream, intersecting, and downstream of the retired route. The document also covers scenarios involving routes in a line network with events spanning multiple routes and describes the application of event behaviors after running the Apply Event Behaviors tool.

## Related documents

<!-- related:begin -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-apr-2024-01-2.md>) — similar text 0.92 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:443 s=8.967 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-apr-2024-01.md>) — similar text 0.72 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:441 s=7.454 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-rh-2024-01.md>) — similar text 0.73 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:440 s=7.215 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02-2.md>) — similar text 0.70 · 4 title words · 1 filename word · same kind/surface <!-- rel:425 s=6.9 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02.md>) — similar text 0.69 · 4 title words · 1 filename word · same kind/surface <!-- rel:420 s=6.601 -->
<!-- related:end -->
...
Note:
For any LRS route edit in whichWhen Recalibrate route downstream is chosen for an LRS route edit, the configured calibrate event behavior https://prodev.arcgis.com/en/pro-app/3.2/help/production/location-referencing-pipelines/event-behavior-for-route-calibration.htm \h configured calibrate event behavior is applied to downstream sections. You can review configured event behaviors by  https://prodev.arcgis.com/en/pro-app/3.2/help/production/roads-highwayslocation-referencing-pipelines/view-lrs-event-properties.htm \h viewing LRS event properties.
...
If the option to  https://prodev.arcgis.com/en/pro-app/3.2/help/production/roads-highways/reassign-routes.htm  \h recalibrate route downstream is selected,  https://prodev.arcgis.com/en/pro-app/3.2/help/production/roads-highways/event-behavior-for-route-calibration.htm \h calibrate route event behaviors are applied to the events downstream of the edited portion of the route.
...
The following sections detail how event behavior rules are enforced when a In this example, the route is retired.

#### Stay Put event behavior
The routeRoute1 is active from 1/1/2000, and if the. The retirement is set to occur in the middle of the route on 1/1/2005 and. Recalibrate route downstream option is not chosen, this has the following effects:

- Event1 is represented by two time slices. There is a time slice from . The graphics and tables below demonstrate the route information before and after1/1/2000 to 1/1/2005, with the original measures from 0 to 20, and a time slice from 1/1/2005 to <Null>, with measures from 0 to 15, that stay the same location geographically.
- Event2 retires to maintain geographic location.
- Event3 is represented by two time slices. There is a time slice from 1/1/2000 to 1/1/2005, with the original measures from 30 to 45, and a time slice from 1/1/2005 to <Null>, with measures from 35 to 45, that stay the same geographicallyretirement.
...
The following table provides details about the eventsroute before retirement:
...
- 1/1/2000 to 1/1/2005 and a time slice from 1/1/2005 to <Null>, both with the original measures 30 to 45. This new time slice only partially locates since the event time slice has measures from 30 to 45, but the underlying route time slice only has measures from 0 to 15 and 35 to 55, with a physical gap created due to retirement.
...
| Route4 Event2 |  | 1/1/2000 LineA |  | <null> 4 00 |  | Route3 1/1/2000 |  | Route4 <Null> |  | 30 38 |  | 48 |  |  |
...
![Figure 1 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-01-after-retire-event-behavior.png)
![Figure 2 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-02-after-retire-event-behavior.png)
![Figure 3 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-03-after-retire-event-behavior.png)
![Figure 4 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-04-after-retire-event-behavior.png)
![Figure 5 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-05-after-retire-event-behavior.png)
![Figure 6 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-06-after-retire-event-behavior.png)
![Figure 7 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-07-after-retire-event-behavior.png)
![Figure 8 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-08-after-retire-event-behavior.png)
![Figure 9 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-09-after-retire-event-behavior.png)
![Figure 10 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-10-after-retire-event-behavior.png)
![Figure 11 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-11-after-retire-event-behavior.png)
![Figure 12 — After Retire event behavior](../media/eb-for-route-retirement-rh-2024-01-2/fig-12-after-retire-event-behavior.png)
