...
| Field | Value |
| --- | --- |
| **Doc** | 138 · Other · Experience Builder |
...
| **Source** | [24791-AddLineEvent_CoordinatesMethod_V1.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro36_Ent12/24791_AddPointLineWidgets_Coordinates/24791-AddLineEvent_CoordinatesMethod_V1.docx>) · rev V1 |
...
<!-- related:begin -->
- [Add Point Event widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24791-add-point-event-widget.md>) — shared issue Beijing-R-D-Center/ExperienceBuilder-Web-Extensions#24791 · similar text 0.80 · 3 title words · 4 filename words · same kind/surface/folder <!-- rel:139 s=1009.42 -->
- [Coordinates Method in Add Point and Add Line Widgets Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/24791-coordinates-method-in-add-point-and-add-line-widgets.md>) — shared issue Beijing-R-D-Center/ExperienceBuilder-Web-Extensions#24791 · similar text 0.12 · 2 title words · 3 filename words · same surface <!-- rel:49 s=1004.299 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/add-line-event-widget-2024-03-2.md>) — similar text 0.54 · 4 title words · 2 filename words · same kind/surface <!-- rel:411 s=5.821 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03.md>) — similar text 0.53 · 4 title words · 2 filename words · same kind/surface <!-- rel:410 s=5.809 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03-4.md>) — similar text 0.53 · 4 title words · 2 filename words · same kind/surface <!-- rel:413 s=5.791 -->
<!-- related:end -->
...
1. Add an Add Line Event widget. Connect it to the Map widget, then load LRS layers from the Map widget.

1. Publish the app.

1. Launch the app. If prompted, sign in to your ArcGIS Enterprise portal.

1. Zoom to the location where you want to add a line event.
...
1. Open the Add Line Event widget.
...
1. If Type is set to Single Line, use the default line event layer or click the Event drop-down arrow and choose another line event layer.
...
1. Specify the starting location for the line event by doing one of the following:
...
1. Optionally, change the starting measure value by doing one of the following:
...
1. Specify the ending location for the line event by doing one of the following:
...
1. Optionally, specify a new ending measure by doing one of the following:
...
1. Specify the starting date of the event by doing one of the following:
...
1. Optionally, specify the ending date for the line event by doing one of the following:
...
1. If Type is set to Single Line, use the default point event layer or click the Event drop-down arrow and choose another point event layer.
The value that appears under Network is based on the selectedchosen event layer.

1. If Type is set to Multiple Line, use the default attribute set or choose another attribute set.

1. If there are multiple methods configured in the widget settings, choose Coordinate from the From Method drop-down menu.

1. Specify a route by doing one of the following:

  1. Provide a route ID in the From RouteID text box.

  1. Click the route picker [INSERT ROUTE PICKER ICON HERE], and click a route on the map.

  1. Leave the From RouteID text box blank and proceed to the next step. Once valid values are input into the X Coordinate, Y Coordinate, and optionally Z Coordinate text boxes, the nearest route’s route ID will populate the RouteID text box.

1. Specify a location for the starting measure of the line event by providing values in the X Coordinate and Y Coordinate text boxes. Optionally, provide a value in the Z Coordinate text box.

1. If there are multiple methods configured in the widget settings, choose Coordinate from the To Method drop-down menu.

1. Specify the ending routeID for the line event by doing one of the following:
...
1. Specify a location for the ending measure of the line event by providing values in the X Coordinate and Y Coordinate text boxes. Optionally, provide a value in the Z Coordinate text box.

1. Specify the starting edate of the event by doing one of the following:
...
1. Add a line event by doing one of the following:
...
1. For a non-line network, select a route.
...
1.  For a line network, select one or two routes on the same line.
...
![Figure 1 — Run data actions with the LRS Identify widget](../media/24791-add-line-event-widget/fig-01-run-data-actions-with-the-lrs-identify.png)
![Figure 2 — Run data actions with the LRS Identify widget](../media/24791-add-line-event-widget/fig-02-run-data-actions-with-the-lrs-identify.png)
![Figure 3 — Run data actions with the LRS Identify widget](../media/24791-add-line-event-widget/fig-03-run-data-actions-with-the-lrs-identify.png)
![Figure 4 — Run data actions with the LRS Identify widget](../media/24791-add-line-event-widget/fig-04-run-data-actions-with-the-lrs-identify.png)
![Figure 5 — Run data actions with the LRS Identify widget](../media/24791-add-line-event-widget/fig-05-run-data-actions-with-the-lrs-identify.png)
![Figure 6 — Run data actions with the LRS Identify widget](../media/24791-add-line-event-widget/fig-06-run-data-actions-with-the-lrs-identify.png)
