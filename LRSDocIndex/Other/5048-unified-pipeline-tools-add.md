...
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#5048](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/5048) |
...
<!-- related:begin -->
- [Manage Pipeline Referencing and a Utility Network Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5048-manage-apr-and-a-un-together.md>) — shared issue ArcGISPro/ps-location-referencing#5048 · similar text 0.17 · 1 title word · same kind/surface/folder <!-- rel:565 s=1003.603 -->
- [Regression Testing Task List V1](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Test%20Plans/regression-testing-task-list-v1.md>) — similar text 0.18 · same surface <!-- rel:115 s=4.591 -->
- [Combined APR-UN Ribbon User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/4958-combined-apr-un-ribbon.md>) — similar text 0.19 · same surface <!-- rel:606 s=4.484 -->
- [Esri Roads and Highways Tutorial](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/esri-rh-tutorial.md>) — similar text 0.16 · same kind/surface <!-- rel:875 s=4.386 -->
- [Help ID Mapping for LRS Tools and UI Elements](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/help-id-mapping-for-lrs-tools-and-ui-elements.md>) — similar text 0.04 · 1 title word · same kind/surface <!-- rel:867 s=4.083 -->
<!-- related:end -->
...
1. Download the contents from https://github.com/ArcGIS/UN-APR-Ribbon \hthis location.

1. Close any ArcGIS Pro projects that are open.

1. Browse to the downloaded UnifiedPipelineTools folder and extract its contents.

1. Browse to and double-click UnifiedPipelineTools.esriAddInX to run the installer.

1. Click Install Add-In on the Esri ArcGIS Add-In Installation Utility dialog box.
...
| Bookmarks | Open the gallery of existing bookmarks and the options to manage them or create more.<br>B ookmark s are navigation shortcut s to a position on a map or perspective in a scene that you can quickly return to or share with others. |
...
| Identify Routes | Identify routes, their measures, and locking information .<br>Click the Identify Routes tool and then a route. |
...
| Release Locks | R elease any lock whose releasable state value is Yes .<br>Learn more about releasable states |
| Add Events | Add events of the following type:<br>Point<br>Line<br>Multiple points<br>Multiple lines |
...
![Figure 1 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-01-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 2 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-02-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 3 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-03-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 4 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-04-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 5 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-05-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 6 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-06-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 7 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-07-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 8 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-08-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 9 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-09-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 10 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-10-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 11 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-11-tools-in-the-unified-pipeline-tools-tab.png)
![Figure 12 — Tools in the Unified Pipeline Tools tab](../media/5048-unified-pipeline-tools-add/fig-12-tools-in-the-unified-pipeline-tools-tab.png)
