...
| Field | Value |
| --- | --- |
| **Doc** | 411 · Other · Experience Builder |
| **Product** | — |
| **Release** | — |
| **Issues** | — |
...
<!-- related:begin -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03.md>) — similar text 0.85 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:410 s=10.088 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03-4.md>) — similar text 0.90 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:413 s=9.501 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget-2024-03-3.md>) — similar text 0.83 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:412 s=9.282 -->
- [Add Line Event widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/24791-add-line-event-widget.md>) — similar text 0.54 · 4 title words · 2 filename words · same kind/surface <!-- rel:138 s=6.006 -->
- [Experience Builder: Add Single Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/16340-exb-add-single-line-event-widget.md>) — similar text 0.26 · 4 title words · 3 filename words · same surface <!-- rel:455 s=5.274 -->
<!-- related:end -->
...
![Figure 1 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-2/fig-01-adding-line-event-by-route-and-measure.png)
![Figure 2 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-2/fig-02-adding-line-event-by-route-and-measure.png)
![Figure 3 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-2/fig-03-adding-line-event-by-route-and-measure.png)
![Figure 4 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-2/fig-04-adding-line-event-by-route-and-measure.png)
![Figure 5 — Adding Line Event by Route and Measure](../media/add-line-event-widget-2024-03-2/fig-05-adding-line-event-by-route-and-measure.png)
