...
<!-- related:begin -->
- [Add Point Events by Location Offset](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-point-events-by-location-offset-rh.md>) — similar text 0.81 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:234 s=9.375 -->
- [Add multiple line events by route and measure](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6134-add-multiple-line-events-by-route-and-measure.md>) — similar text 0.43 · 2 title words · 3 filename words · same kind/surface <!-- rel:120 s=5.351 -->
- [Add Line Events Point Offset Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/add-line-events-point-offset-method.md>) — similar text 0.19 · 4 title words · 3 filename words · same surface <!-- rel:268 s=5.145 -->
- [Adding Point Events to Dominant Routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/adding-point-events-to-dominant-routes-apr.md>) — similar text 0.32 · 2 title words · 2 filename words · same kind/surface <!-- rel:309 s=4.471 -->
- [Replace Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/replace-events-apr.md>) — similar text 0.36 · 1 title word · 2 filename words · same kind/surface <!-- rel:122 s=4.337 -->
<!-- related:end -->
...
1. Open the map in ArcGIS Pro and zoom to the location where you want to add the point event.
...
1. Click the Event Layer drop-down arrow and choose the event layer where the event will be created.

- The parent LRS Network value is populated based on the Event Layer value.

1. Specify the route name by doing one of the following:

1. -Type the route name in the Route Name text box.
- Click Choose route from map and click a route on the map.

1. Click the LocationPoint Layer drop-down arrow and choose the intersection layer, LRS point event, or non-LRS point layer name.
...
1. For the text box below the Point Layer drop-down menu, sSpecify the intersectionpoint feature’s name by doing one of the following:
...
1. Provide attribute information for the events in the attribute set layer.
...
1. Click the LocationPoint Layer drop-down arrow and choose the intersection, LRS point event, or non-LRS point layer name.
...
1. Optionally, sSpecify the Offset value direction for the location by doing one of the following:
...
1. Optionally, sSpecify the date that defines the end date of the events by doing one of the following:
...
![Figure 1 — Elevation](../media/add-point-events-by-location-offset-apr/fig-01-elevation.png)
![Figure 2 — Elevation](../media/add-point-events-by-location-offset-apr/fig-02-elevation.png)
![Figure 3 — Elevation](../media/add-point-events-by-location-offset-apr/fig-03-elevation.png)
![Figure 4 — Elevation](../media/add-point-events-by-location-offset-apr/fig-04-elevation.png)
![Figure 5 — Elevation](../media/add-point-events-by-location-offset-apr/fig-05-elevation.png)
![Figure 6 — Elevation](../media/add-point-events-by-location-offset-apr/fig-06-elevation.png)
![Figure 7 — Elevation](../media/add-point-events-by-location-offset-apr/fig-07-elevation.png)
![Figure 8 — Elevation](../media/add-point-events-by-location-offset-apr/fig-08-elevation.png)
![Figure 9 — Elevation](../media/add-point-events-by-location-offset-apr/fig-09-elevation.png)
![Figure 10 — Elevation](../media/add-point-events-by-location-offset-apr/fig-10-elevation.png)
![Figure 11 — Elevation](../media/add-point-events-by-location-offset-apr/fig-11-elevation.png)
![Figure 12 — Elevation](../media/add-point-events-by-location-offset-apr/fig-12-elevation.png)
