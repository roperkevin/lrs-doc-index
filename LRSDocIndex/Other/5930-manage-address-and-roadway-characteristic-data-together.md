...
| **Release** | — |
| **Issues** | [ArcGISPro/ps-location-referencing#5930](https://devtopia.esri.com/ArcGISPro/ps-location-referencing/issues/5930) |
...
<!-- related:begin -->
- [Pro 3.4 and 11.4 User Acceptance Issues and Documentation Updates](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Schedules/504-pro-3-4-and-11-4-user-acceptance-issues-and-documentation.md>) — shared issue ArcGISPro/ps-location-referencing#5930 · gantt link (2 shared) · similar text 0.04 · same surface/folder <!-- rel:194 s=1121.258 -->
- [Manage Address and Roadway Characteristic Data Together with Roads and Highways and Address Data Management Solution](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5783-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.84 · 5 title words · same kind/surface <!-- rel:276 s=10.548 -->
- [Manage Address and Roadway Characteristic Data Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5646-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.92 · 5 title words · same kind/surface/folder <!-- rel:400 s=10.537 -->
- [Manage Address and Roadway Characteristic Data Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/6267-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.76 · 5 title words · same kind/surface <!-- rel:250 s=7.736 -->
- [Manage address and roadway characteristic data together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.75 · 5 title words · same kind/surface <!-- rel:96 s=7.558 -->
<!-- related:end -->
...
1. Create the LRS using the Create LRS or Create LRS From Existing Dataset tool.

1. Run the Configure Address Feature Classes tool to associate the Centerline and the Site Address feature classes as part of the Address Data Management solution and LRS.

1. Load data into the Centerline and Site Address feature classes using the Append tool.
...
1. Run the Configure Address Feature Classes tool to associate the newly created line event and as the Site Address feature class classes as part of the Address Data Management solution and LRS..
...
1. Load data into the Centerline and Site Address feature classe s using the Append%20Events Append%20EventsAppend tool.
...
1. To create or edit LRS events, use the event editing tools on the Location Referencing tab in ArcGIS Pro, the https://enterprise.arcgis.com/en/roads-highways/latest/event-editor/what-is-event-editor.htm Event Editor web app, or ArcGIS Experience Builder Location Referencing widgets.
...
![Figure 1 — Analysis capabilities in a combined LRS and address management dataset](../media/5930-manage-address-and-roadway-characteristic-data-together/fig-01-analysis-capabilities-in-a-combined-lrs.png)
