...
| **Kind** | Other · Pro |
| **Release** | — |
| **Source** | [AI_assistant_LRS_route_editing.docx](<https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro37_Ent121/7069_7064_7081_7067_RouteEditing_AI_Assistant/AI_assistant_LRS_route_editing.docx>) |
| **Edited** | 2026-03-07 00:23 by unknown |
| **Extracted** | 2026-09-04 · lane `xmlstrip` |

<!-- metadata
```yaml
title: "Perform an action with the ArcGIS Pro Assistant (Beta)"
source_file: "AI_assistant_LRS_route_editing.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/Pro37_Ent121/7069_7064_7081_7067_RouteEditing_AI_Assistant/AI_assistant_LRS_route_editing.docx"
doc_id: 62
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
author: "Kyle Chin"
last_edited_by: ""
last_edited: "2026-03-07T00:23:54.5594675Z"
extracted: 2026-09-04
extraction_lane: xmlstrip
prompt_version: "v2.0.2"
keywords: ["lrs route editing", "route creation", "route reversal", "route realignment", "arcgis pro", "assistant", "feature service"]
tools: ["ArcGIS Pro Assistant"]
products: []
issues: []
related: [{"doc":55,"file":"perform-an-action-with-the-arcgis-pro-assistant-beta__doc55.md","s":11.319},{"doc":907,"file":"perform-an-action-with-the-arcgis-pro-assistant-beta__doc907.md","s":9.637},{"doc":82,"file":"arcgis-pro-assistant-beta-documentation__doc82.md","s":6.013},{"doc":109,"file":"pro-ai-assistant-reverse-route-user-story__doc109.md","s":3.758},{"doc":72,"file":"reverse-routes__doc72.md","s":3.653}]
```
-->

## Summary

Describes the capabilities and usage of the ArcGIS Pro Assistant (Beta) for performing various actions within an ArcGIS Pro session, including LRS route editing operations such as route creation, reversal, and realignment. Provides sample prompts, results, synonyms for commands, and usage tips for interacting with the assistant.

## Related documents

<!-- related:begin -->
- [Perform an action with the ArcGIS Pro Assistant (Beta)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/perform-an-action-with-the-arcgis-pro-assistant-beta__doc55.md>) — similar text 0.96 · 5 title words · 3 filename words · same kind/surface/folder <!-- rel:55 -->
- [Perform an action with the ArcGIS Pro Assistant (Beta)](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/perform-an-action-with-the-arcgis-pro-assistant-beta__doc907.md>) — similar text 0.93 · 5 title words · 3 filename words · same kind/surface <!-- rel:907 -->
- [ArcGIS Pro Assistant (Beta) Documentation](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/arcgis-pro-assistant-beta-documentation__doc82.md>) — similar text 0.63 · 3 title words · 1 filename word · same kind/surface/folder <!-- rel:82 -->
- [Pro AI Assistant Reverse Route User Story](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/User%20Stories/pro-ai-assistant-reverse-route-user-story__doc109.md>) — similar text 0.14 · 2 title words · 2 filename words · same surface <!-- rel:109 -->
- [Reverse routes](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/reverse-routes__doc72.md>) — similar text 0.16 · 1 filename word · same kind/surface/folder <!-- rel:72 -->
<!-- related:end -->
...
| Data management | Manage data, including modifying data in databases and geodatabase workspaces. |
...
| Data validation | Enhance data quality and integrity for accurate spatial analysis and visualization by automating data validation workflows, identifying attribute and geometry errors, and validating spatial relationships. |
...
| Feature visualization | Update the appearance of a feature layer by setting layer symbology (simple, single symbol, graduated color, graduated symbol, unique value, proportional, dot density, heat map) and adjusting symbology and visual variable properties. |
| Raster visualization | Set, update, or create renderers for raster or imagery layers. Create and update colorizer types rgb , stretch, colormap, classify, unique value, vector field, discrete color, shaded relief. Update the properties of existing colorizers including raster band, classes, classification method , normalization, fields, color ramps, and color schemes. |
...
| Knowledge graph | Work with knowledge graphs or knowledge graph services by querying and selecting data in the investigation view of a knowledge graph service. |
| Portal management | Managing current portals. |
...
| --- | --- | --- |
| Route creation | Create a route. | If only one LRS Network is found on the map, you are asked to provide a route ID or route name. If multiple LRS Networks are found on the map, you are asked to specify an LRS Network. If the LRS Network is configured with a multifield route ID , you are asked to provide a field name and the attributes for each field that is part of the multifield route ID. |
...
| Route realignment | Realign a route in the engineering network. The source from measure is 949.46 and the source to measure is 3847.665. The target from measure is also 949.46, and the target to measure is 9079.625. Use centerline 2902 valid on 01/01/2010. For the abandoned line name, use ‘L7_Abandon’, and for the abandoned route name, use ‘R34_Abandon’. Do not recalibrate downstream, and use ‘NewRouteR1000’ as the name for the new realigned route. Realign a r oute in the Engineering Network . The source from measure is 949.46 and the source to measure is 3847.665. The target from measure is 949.46 and target to measure is 9079.625. U se centerline 2902 valid on 01 / 01 / 2010. U se ‘L7_Abandon’ as abandoned line name and use ‘R34_Abandon’ for abandoned route name. Do not recalibrate downstream, and use ‘NewRouteR1000’ as the name for the new realigned route . | You are presented with the populated first page of the Realign Route pane. After you click Run , the subsequent pages of the Realign Route pane are also populated. |
