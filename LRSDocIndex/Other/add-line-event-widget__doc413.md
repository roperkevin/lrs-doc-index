...
source_file: "Doc_AddSingleLineRH_praveenfeedback.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/LR%20Product%20Engineers/Doc_AddSingleLineRH_praveenfeedback.docx"
doc_id: 413
doc_kind: "Other"
...
products: []
issues: []
related: [{"doc":412,"file":"add-line-event-widget__doc412.md","s":9.074},{"doc":410,"file":"add-line-event-widget__doc410.md","s":8.939},{"doc":411,"file":"add-line-event-widget__doc411.md","s":8.79},{"doc":138,"file":"add-line-event-widget__doc138.md","s":5.791},{"doc":455,"file":"experience-builder-add-single-line-event-widget__doc455.md","s":5.237}]
```
-->
...
<!-- related:begin -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget__doc412.md>) — similar text 0.83 · 4 title words · 4 filename words · same kind/surface/folder <!-- rel:412 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/add-line-event-widget__doc410.md>) — similar text 0.83 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:410 -->
- [Add Line Event Widget](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/add-line-event-widget__doc411.md>) — similar text 0.90 · 4 title words · 3 filename words · same kind/surface/folder <!-- rel:411 -->
...
- Specify the start location for the line event Specify a route for the line event to start from by doing either of the following:
...
![image1.png](../media/doc551_image1.png) ![image2.png](../media/doc551_image2.png) ![image3.png](../media/doc551_image3.png) ![image4.png](../media/doc551_image4.png) ![image5.png](../media/doc551_image5.png) ![image6.png](../media/doc551_image6.png) ![image7.png](../media/doc551_image7.png)
