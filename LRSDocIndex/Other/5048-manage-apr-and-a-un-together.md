...
<!-- related:begin -->
- [Unified Pipeline Tools add-in](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5048-unified-pipeline-tools-add.md>) — shared issue ArcGISPro/ps-location-referencing#5048 · similar text 0.17 · 1 title word · same kind/surface/folder <!-- rel:566 s=1003.603 -->
- [Manage Pipeline Referencing and a Utility Network Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/manage-apr-and-a-un-together.md>) — similar text 0.89 · 5 title words · 1 filename word · same kind/surface <!-- rel:74 s=11.68 -->
- [Manage Address and Roadway Characteristic Data Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5930-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.40 · 2 title words · same kind/surface/folder <!-- rel:327 s=4.99 -->
- [Manage Address and Roadway Characteristic Data Together](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5646-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.39 · 2 title words · same kind/surface/folder <!-- rel:400 s=4.803 -->
- [Manage Address and Roadway Characteristic Data Together with Roads and Highways and Address Data Management Solution](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/5783-manage-address-and-roadway-characteristic-data-together.md>) — similar text 0.38 · 2 title words · same kind/surface <!-- rel:276 s=4.451 -->
<!-- related:end -->
...
1.  https://solutions.arcgis.com/utilities/help/utility-network-automation/tool-reference/stage-utility-network.htm \h Stage a utility network.

1.  https://solutions.arcgis.com/utilities/help/utility-network-automation/tool-reference/apply-asset-package.htm \h Apply an asset package (such as the gas configuration).

1. Create the LRS using either the Create LRS or Create LRS from Existing Dataset tool.

1. Run the Configure Utility Network Feature Class tool to associate the Centerline and Pipeline feature classes as part of a utility network and LRS.

1. Create each of the LRS Networks using either the Create LRS Network or Create LRS Network from Existing Dataset tool.

1. Create each of the LRS Events using either the Create LRS Event or Create LRS Event from Existing Dataset tool.
...
1. Load data into your utility network using the Append tool and into the LRS using the Append Routes and Append Events tools.
...
1. Ensure that the required fields to branch version your data are present (Global IDs and editor tracking are enabled) and change the connection file versioning type to Branch, then register your data as versioned.

1. Follow the steps to publish a utility network and an LRS in a service.
...
1. Create and update any pipelines or centerlines intended for use in LRS editing activities (create, extend, or realign route).
...
1. Optionally, provide a from measure and a to measure for centerlines in the Centerline feature class.

1. Optionally, validate the utility network topology to ensure that newly created or updated pipes are valid.
...
1. Run Apply Event Behaviors and any other tools necessary to update associated LRS data, such as the derived network and events.

1. If other utility network features have route and measure fields modeled, update them using the Update Measures from LRS tool.

1. Validate your utility network topology to ensure all edits are valid.

1. To create or edit LRS Events, use the Location Referencing tab event editing tools in ArcGIS Pro or use the ArcGIS Event Editor web app.
...
![Figure 1 — Analysis capabilities in a combined LRS and Utility Network](../media/5048-manage-apr-and-a-un-together/fig-01-analysis-capabilities-in-a-combined-lrs.png)
