...
<!-- metadata
```yaml
title: "Event Behavior for Route Reassignment – Merge to Adjacent Route Method"
source_file: "ReassignEB-MergeToAdjacentRoute_doc.docx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/Doc%20Reviews/ReassignEventBehavior_3docs/ReassignEB-MergeToAdjacentRoute_doc.docx"
doc_id: 522
doc_kind: "Other"
surface: "Pro"
doc_revision: ""
...
products: []
issues: []
related: [{"doc":523,"file":"event-behavior-for-route-reassignment-form-a-new-route-method__doc523.md","s":7.96},{"doc":36,"file":"event-behavior-for-route-reassignment-transfer-to-another-line-method__doc36.md","s":7.861},{"doc":425,"file":"event-behavior-for-route-retirement__doc425.md","s":5.806},{"doc":442,"file":"event-behavior-for-route-retirement__doc442.md","s":5.663},{"doc":441,"file":"event-behavior-for-route-retirement__doc441.md","s":5.63}]
```
-->
...
<!-- related:begin -->
- [Event Behavior for Route Reassignment – Form a New Route Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/event-behavior-for-route-reassignment-form-a-new-route-method__doc523.md>) — similar text 0.80 · 5 title words · 2 filename words · same kind/surface/folder <!-- rel:523 -->
- [Event Behavior for Route Reassignment – Transfer to Another Line Method](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/event-behavior-for-route-reassignment-transfer-to-another-line-method__doc36.md>) — similar text 0.73 · 5 title words · 1 filename word · same kind/surface/folder <!-- rel:36 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/event-behavior-for-route-retirement__doc425.md>) — similar text 0.59 · 3 title words · same kind/surface <!-- rel:425 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/event-behavior-for-route-retirement__doc442.md>) — similar text 0.59 · 3 title words · same kind/surface <!-- rel:442 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/event-behavior-for-route-retirement__doc441.md>) — similar text 0.58 · 3 title words · same kind/surface <!-- rel:441 -->
<!-- related:end -->
...
![image1.png](../media/doc421_image1.png) ![image2.png](../media/doc421_image2.png) ![image3.png](../media/doc421_image3.png) ![image4.png](../media/doc421_image4.png) ![image5.png](../media/doc421_image5.png) ![image6.png](../media/doc421_image6.png) ![image7.png](../media/doc421_image7.png) ![image8.png](../media/doc421_image8.png) ![image9.png](../media/doc421_image9.png) ![image10.png](../media/doc421_image10.png) ![image11.png](../media/doc421_image11.png) ![image12.png](../media/doc421_image12.png)
