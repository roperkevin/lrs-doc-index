...
<!-- related:begin -->
- [What's New in ArcGIS Roads and Highways and ArcGIS Pipeline Referencing: May 2026](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/whats-new-in-arcgis-rh-and-arcgis-apr-may-2026.md>) — similar text 0.08 · 4 title words · 2 filename words · same kind/surface <!-- rel:33 s=5.833 -->
- [APR/RH Integration and Location Referencing Toolbox Updates](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/apr-rh-integration-and-lr-toolbox-updates.md>) — similar text 0.36 · same kind/surface <!-- rel:121 s=5.572 -->
- [What's new in ArcGIS Roads and Highways 12.0](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/whats-new-in-arcgis-rh-12-0.md>) — similar text 0.28 · 3 title words · same kind <!-- rel:117 s=4.645 -->
- [Roads and Highways and Pipeline Referencing Enhancements in ArcGIS Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/rh-and-apr-enhancements-in-pro.md>) — similar text 0.20 · 3 title words · same kind/surface <!-- rel:304 s=3.868 -->
- [Pipeline Referencing and Roads and Highways Enhancements in Location Referencing](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Other/apr-and-rh-enhancements-in-lr.md>) — similar text 0.20 · 3 title words · same kind/surface <!-- rel:58 s=3.837 -->
<!-- related:end -->
...
![Figure 1 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-01-add-line-event-and-add-point-event.png)
![Figure 2 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-02-add-line-event-and-add-point-event.png)
![Figure 3 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-03-add-line-event-and-add-point-event.png)
![Figure 4 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-04-add-line-event-and-add-point-event.png)
![Figure 5 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-05-add-line-event-and-add-point-event.png)
![Figure 6 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-06-add-line-event-and-add-point-event.png)
![Figure 7 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-07-add-line-event-and-add-point-event.png)
![Figure 8 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-08-add-line-event-and-add-point-event.png)
![Figure 9 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-09-add-line-event-and-add-point-event.png)
![Figure 10 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-10-add-line-event-and-add-point-event.png)
![Figure 11 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-11-add-line-event-and-add-point-event.png)
![Figure 12 — Add Line Event and Add Point Event widgets – append to primary route](../media/whats-new-in-arcgis-rh-and-arcgis-apr-november-2025/fig-12-add-line-event-and-add-point-event.png)
