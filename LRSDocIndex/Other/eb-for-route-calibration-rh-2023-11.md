...
<!-- related:begin -->
- [Event Behavior for Route Calibration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-calibration-apr-2023-11-2.md>) — similar text 0.93 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:448 s=8.93 -->
- [Event Behavior for Route Calibration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-calibration-rh-2023-11-2.md>) — similar text 0.82 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:449 s=7.615 -->
- [Event Behavior for Route Calibration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-calibration-apr-2023-11.md>) — similar text 0.80 · 4 title words · 1 filename word · same kind/surface/folder <!-- rel:446 s=7.486 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02-2.md>) — similar text 0.55 · 3 title words · same kind/surface <!-- rel:425 s=5.391 -->
- [Event Behavior for Route Retirement](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/eb-for-route-retirement-2024-02.md>) — similar text 0.56 · 3 title words · same kind/surface <!-- rel:420 s=5.259 -->
<!-- related:end -->
...
![Figure 1 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-01-retire-event-behavior.png)
![Figure 2 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-02-retire-event-behavior.png)
![Figure 3 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-03-retire-event-behavior.png)
![Figure 4 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-04-retire-event-behavior.png)
![Figure 5 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-05-retire-event-behavior.png)
![Figure 6 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-06-retire-event-behavior.png)
![Figure 7 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-07-retire-event-behavior.png)
![Figure 8 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-08-retire-event-behavior.png)
![Figure 9 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-09-retire-event-behavior.png)
![Figure 10 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-10-retire-event-behavior.png)
![Figure 11 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-11-retire-event-behavior.png)
![Figure 12 — Retire event behavior](../media/eb-for-route-calibration-rh-2023-11/fig-12-retire-event-behavior.png)
