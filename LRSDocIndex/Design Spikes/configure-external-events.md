...
<!-- related:begin -->
- [Support External Event Configuration Without Connection File – Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/6159-support-external-event-configuration-without-connection-file.md>) — similar text 0.25 · 1 title word · 3 filename words · same surface <!-- rel:275 s=5.166 -->
- [Support updating External Event configuration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-updating-external-event-configuration.md>) — similar text 0.37 · 1 title word · 1 filename word · same surface/folder <!-- rel:744 s=4.692 -->
- [Create External Event with No Connection File](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-external-event-with-no-connection-file.md>) — similar text 0.24 · 1 title word · 1 filename word · same surface/folder <!-- rel:288 s=4.091 -->
- [Relocate Events in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Design Spikes/relocate-events-in-pro.md>) — similar text 0.22 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:812 s=3.618 -->
- [External system integration with ArcGIS Roads and Highways](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Other/external-system-integration-with-arcgis-rh.md>) — similar text 0.22 · 1 title word · 1 filename word · same surface <!-- rel:246 s=3.172 -->
<!-- related:end -->
...
![Figure 1 — Configure External Event with LRS](../media/configure-external-events/fig-01-slide-03-configure-external-event-with-lrs.png)
