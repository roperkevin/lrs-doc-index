...
<!-- metadata
```yaml
title: "Relocate Event Support for External Event with No Connection File"
source_file: "RelocateEventsviaJSON&NoConnectionFile.pptx"
source_url: "https://esriis.sharepoint.com/sites/LocationReferencing/Shared%20Documents/General/RelocateEventsviaJSON%26NoConnectionFile.pptx"
doc_id: 287
...
last_edited: "2024-11-18T23:33:04Z"
...
issues: []
related: [{"doc":288,"file":"create-external-event-with-no-connection-file__doc288.md","s":4.752},{"doc":812,"file":"relocate-events-in-pro__doc812.md","s":3.764},{"doc":298,"file":"prototype-json-requests-and-returns-in-rest-for-relocate-events__doc298.md","s":3.76},{"doc":264,"file":"relocate-events-support-for-external-event-with-no-connection-file-test-plan__doc264.md","s":3.61},{"doc":744,"file":"support-updating-external-event-configuration__doc744.md","s":3.383}]
```
-->
...
<!-- related:begin -->
- [Create External Event with No Connection File](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/create-external-event-with-no-connection-file__doc288.md>) — similar text 0.47 · 3 title words · 1 filename word · same surface/folder <!-- rel:288 -->
- [Relocate Events in Pro](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Design Spikes/relocate-events-in-pro__doc812.md>) — similar text 0.21 · 1 title word · 1 filename word · same kind/surface/folder <!-- rel:812 -->
- [Prototype: JSON requests and returns in REST for Relocate Events](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS%20Doc%20Index/Design%20Spikes/prototype-json-requests-and-returns-in-rest-for-relocate-events__doc298.md>) — similar text 0.19 · 1 title word · 3 filename words · same kind/folder <!-- rel:298 -->
- [Relocate Events Support for External Event with No Connection File - Test Plan](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/Test Plans/relocate-events-support-for-external-event-with-no-connection-file-test-plan__doc264.md>) — similar text 0.16 · 5 title words · 1 filename word <!-- rel:264 -->
- [Support updating External Event configuration](<https://esriis.sharepoint.com/sites/lrsworkspace/LRS Doc Index/User Stories/support-updating-external-event-configuration__doc744.md>) — similar text 0.21 · 3 title words · same surface/folder <!-- rel:744 -->
<!-- related:end -->
