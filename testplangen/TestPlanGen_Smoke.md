...
| 7 | Ask the Q&A agent about content unique to a draft sitting in the drafts folder | "Not in the catalog" | The agent never cites or paraphrases a draft — the non-ingestion guarantee (drafts live outside its knowledge source). Give the tenant index a day before trusting a pass |
