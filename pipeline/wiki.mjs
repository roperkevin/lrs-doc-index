 ...
 * (`FIELD_BARE`), and the stylesheet draws the group as an eyebrow
...
/* v2.3: Group is a category — an eyebrow over the card's content, in
   the label vocabulary; Steps ARE the case — the procedure, flush
   with the card, no label */
